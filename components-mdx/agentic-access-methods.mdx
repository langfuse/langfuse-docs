...
| ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Can install tools and run shell commands   | Install the [Langfuse Agent Skill](/skills). It teaches the agent Langfuse workflows and uses the [Langfuse CLI](/docs/api-and-data-platform/features/cli) to query and update project data. |

GA. Requires Langfuse v4. See the [Observations API v2](/docs/api-and-data-platform/features/public-api#v2) and [Metrics API v2](/docs/metrics/features/metrics-api#v2) docs.

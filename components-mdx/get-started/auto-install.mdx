...
> **What is a Langfuse Skill?**
> A reusable instruction package for AI coding agents. It gives your agent Langfuse-specific workflows and best practices out of the box.

Install the [Langfuse Skill](https://github.com/langfuse/skills) in your coding tool:

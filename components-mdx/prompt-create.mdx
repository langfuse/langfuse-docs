...
**Using the Prompt Migration Skill**

Use the [Langfuse Prompt Migration Skill](https://skills.sh/langfuse/skills/langfuse-prompt-migration) to automatically migrate hardcoded prompts to Langfuse for version control, A/B testing, and deployment-free iteration:

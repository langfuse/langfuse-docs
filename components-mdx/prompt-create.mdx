...
Use the [Langfuse Skill](https://skills.sh/langfuse/skills/langfuse) to automatically migrate hardcoded prompts to Langfuse for version control, A/B testing, and deployment-free iteration:

...
<LangTabs items={["Python SDK", "JS/TS SDK", "API", "OpenAI SDK (Python)", "OpenAI SDK (JS/TS)", "Langchain (Python)", "Langchain (JS)", "Vercel AI SDK", "✨ AI Skill"]}>
<Tab>
...
Use the agent mode of your editor to fetch and use Langfuse prompts in your application.
...
```
Fetch the "movie-critic" prompt, production version, from Langfuse in line 100 as "movie-critic-prompt".
```

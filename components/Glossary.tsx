...
const glossaryTerms: GlossaryTerm[] = [
  {
    term: "Agent",
    id: "agent",
    definition: "An observation type that represents an AI agent workflow, including multi-step reasoning processes, tool orchestration, and autonomous decision-making. Used to track agent behavior and interactions.",
  ...
  },
  {
    term: "Billable Unit",
    id: "billable-unit",
    definition: "The unit of measurement for Langfuse Cloud pricing. Units are the sum of traces, observations, and scores ingested per billing period.",
  ...
  },
  {
    ...
    definition: "A webhook-based trigger that allows running SDK experiments from the Langfuse UI. Configure a webhook URL and default config, then trigger experiments that fetch the dataset, run your application, and ingest scores back into Langfuse.",
  ...
  },
  {
    ...
    definition: "A function that scores traces, observations, sessions, or dataset runs. Methods include LLM-as-a-Judge for subjective assessments, Annotation Queues for human review, Scores via UI for spot checks, and Scores via API/SDK for programmatic evaluation.",
    link: "/docs/evaluation/core-concepts#evaluation-methods",
    categories: ["EVALUATION"],
    relatedTerms: ["Score", "LLM-as-a-Judge", "Annotation Queue", "Dataset Experiment"],
  },
  {
    term: "Evaluator",
    id: "evaluator",
    ...
    link: "/docs/observability/features/observation-types",
    categories: ["OBSERVABILITY"],
    relatedTerms: ["Score", "LLM-as-a-Judge", "Observation", "Evaluation Method"],
    synonyms: ["Observation Type"],
  },
  {
    term: "Event",
  ...
  },
  {
    term: "Log View",
    id: "log-view",
    definition: "Shows all observations concatenated. Great for quickly scanning through them.",
  ...
  },
  {
    term: "Metrics API",
    id: "metrics-api",
    definition: "An API endpoint for retrieving customized analytics from Langfuse data. Allows specifying dimensions, metrics, filters, and time granularity to build custom reports and dashboards for LLM applications.",
  ...
  },
  {
    ...
    id: "model-definition",
    definition: "A configuration that stores pricing information for an LLM model. Model definitions specify the cost per input and output token, enabling Langfuse to automatically calculate the price of generations based on token usage.",
  ...
  },
  {
    ...
    categories: ["PROMPTS"],
    relatedTerms: ["Chat Prompt", "Text Prompt", "Prompt Variables", "Playground"],
  },
  {
    term: "Prompt Label",
    id: "prompt-label",
    definition: "A label that can be assigned to a prompt version. Used to mark prompt versions as production or staging to fetch them via the SDK or API.",
  ...
  },
  {
    ...
    definition: "Restricts the ability to modify certain prompt labels (e.g. production) from being added to new prompt versions to admins and owners. This prevents accidental or unauthorized changes to production prompts.",
    link: "/docs/prompt-management/features/prompt-version-control",
    categories: ["PROMPTS"],
  ...
  },
  {
    term: "Score",
    id: "score",
    definition: "The output of an annotation or automated evaluation. Scores can be numeric, categorical, boolean, or text and are assigned to traces, observations, sessions, or dataset runs.",
  ...
  },
  {
    term: "Token",
    id: "token",
    definition: "The basic unit of text that LLMs process. Tokens can be words, parts of words, or characters depending on the model's tokenizer. Token counts determine API costs and context window limits. Langfuse tracks input and output tokens for cost monitoring and optimization.",
    link: "/docs/observability/features/token-and-cost-tracking",
    categories: ["OBSERVABILITY"],

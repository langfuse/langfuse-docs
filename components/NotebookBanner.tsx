                ...
                >
                  ...
                  >
                    ...
                    <path
                      ...
                      strokeWidth="4.8342"
                      strokeMiterlimit="10"
                      d="M20.196,36.836c0.759-1.031,1.74-1.927,2.921-2.607c4.566-2.63,10.401-1.06,13.031,3.507"
                    />
                    <path
                      fill="none"
                      stroke="#F5A252"
                      strokeWidth="4.8342"
                      strokeMiterlimit="10"
                      d="M19.61,28.701c-2.63-4.566-1.061-10.401,3.507-13.032c4.567-2.63,10.401-1.059,13.031,3.508"
                    />
                  </svg>
                  Open in Binder
                </Button>
            ...
            {!isDenoNotebook && (
              ...
              >
                <Button
                  size="xs"
                  variant="primary"
                  className="inline-flex items-center gap-1.5 not-prose"
                  icon={
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"

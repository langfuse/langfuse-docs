...
const ROWS: { id: string; name: string; segments: Segment[] }[] = [
  {
    ...
    segments: [
      ...
      },
      {
        ...
        href: "/docs/v4",
        title:
          "On November 15, 2026, Langfuse Cloud switches to v4 as the only experience and legacy APIs, features, and ingestion are removed",
...
const MARKERS: { at: Month; label: string }[] = [
  {
    ...
    label: "Nov 15: Legacy APIs, features, and ingestion removed",
  },
];

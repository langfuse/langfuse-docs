...
const STATIONS = [
  { id: "trace", label: "オンライン", title: "トレース" },
  { id: "monitor", label: "オンライン", title: "モニタリング" },
  { id: "dataset", label: "オフライン", title: "データセット\n構築" },
  { id: "change", label: "オフライン", title: "実験" },
  { id: "eval", label: "オフライン", title: "評価" },
] as const;
...
export function AnnotatedLoop({
  stations = {},
  subloop = false,
  ariaLabel = "このフェーズに注釈を付けた AI エンジニアリング・ループ",
}: {

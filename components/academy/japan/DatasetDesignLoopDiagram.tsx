    ...
    >
      ...
      <span
        className={`dataset-design-loop__title ${
          step.num === "02" || step.num === "04" || step.num === "06"
...
export function DatasetDesignLoopDiagram() {
  ...
  return (
    <figure
      ...
      aria-label="目的の定義から、情報源の調査、入力分布の決定、評価方式の設計、スキーマ設計、データセット構築、実験の実行、そして反復までをたどるデータセット設計のループ"
    >
      <div
        ref={wrapRef}
      ...
      >
        ...
        >
          ...
          <div className="dataset-design-loop__loop-label">反復して広げる</div>

...
const SCREENS_HTML = `<div style="display:flex;flex-wrap:wrap;gap:44px;justify-content:center;">
    ...
    <div style="display:flex;flex-direction:column;gap:16px;">
      <div class="lf-corners" style="width:362px;height:796px;border-radius:2px;display:flex;flex-direction:column;">
        <!-- status bar -->
        ...
        <div style="padding:14px 22px 0;display:flex;flex-direction:column;flex:1;">
          ...
          <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:22px;">
            <div>
              <div class="lf-eyebrow" style="margin-bottom:4px;">こんばんは</div>
              <div class="lf-h3">山田 太郎</div>
            </div>
          ...
          <div class="lf-corners" style="background:var(--surface-cta-primary);border-radius:2px;padding:18px 18px 16px;margin-bottom:26px;">
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:12px;">
              ...
              <span class="lf-eyebrow" style="color:var(--text-secondary);">あなたの DJ</span>
            </div>
            <div style="font-family:var(--font-analog);font-weight:500;font-size:23px;line-height:1.1;color:var(--text-primary);margin-bottom:8px;">今夜のための<br>選曲中</div>
            <p style="font-size:13px;color:var(--text-secondary);margin:0 0 16px;">曲を選び、その理由を語りかけ、<br>こちらの声にも耳を傾けます。</p>
          ...
          <!-- recently played -->
          <div class="lf-h4" style="font-size:18px;margin-bottom:14px;">最近再生した曲</div>
          <div style="display:flex;gap:12px;margin-bottom:26px;">
            <div style="flex:1;">
              ...
              <div style="font-size:12px;color:var(--text-primary);font-weight:500;line-height:1.3;">曲名1</div>
              <div class="lf-mono-xs">アーティストA</div>
            </div>
            <div style="flex:1;">
              ...
              <div style="font-size:12px;color:var(--text-primary);font-weight:500;line-height:1.3;">曲名2</div>
              <div class="lf-mono-xs">アーティストB</div>
            </div>
            <div style="flex:1;">
              <div class="lf-corners" style="aspect-ratio:1;border-radius:2px;background:var(--surface-1);display:flex;align-items:center;justify-content:center;margin-bottom:8px;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="var(--text-disabled)" stroke-width="1.4"><rect x="3" y="3" width="18" height="18" rx="1"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><path d="m21 15-5-5L5 21"></path></svg></div>
              <div style="font-size:12px;color:var(--text-primary);font-weight:500;line-height:1.3;">曲名3</div>
              <div class="lf-mono-xs">アーティストC</div>
            </div>
          </div>

          <!-- made for you -->
          <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:14px;">
            <div class="lf-h4" style="font-size:18px;">あなたへのおすすめ</div>
            <span class="lf-mono-xs" style="text-transform:none;">すべて見る</span>
          </div>
          <div style="display:flex;gap:12px;">
            <div class="lf-corners" style="flex:1;border-radius:2px;background:var(--surface-1);padding:12px;display:flex;flex-direction:column;justify-content:flex-end;height:74px;">
              <div class="lf-mono-xs" style="margin-bottom:3px;">デイリーミックス</div>
              <div style="font-size:13px;color:var(--text-primary);font-weight:500;">プレイリスト1</div>
            </div>
            <div class="lf-corners" style="flex:1;border-radius:2px;background:var(--surface-beige-accent);padding:12px;display:flex;flex-direction:column;justify-content:flex-end;height:74px;">
              <div class="lf-mono-xs" style="margin-bottom:3px;">デイリーミックス</div>
              <div style="font-size:13px;color:var(--text-primary);font-weight:500;">プレイリスト2</div>
            </div>
          </div>
          ...
          <div style="margin-top:auto;display:flex;border-top:1px solid var(--line-structure);padding-top:12px;margin-left:-22px;margin-right:-22px;padding-left:22px;padding-right:22px;">
            <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:5px;color:var(--text-primary);"><svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><path d="M9 22V12h6v10"></path></svg><span class="lf-mono-xs" style="text-transform:none;color:var(--text-primary);">ホーム</span></div>
            <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:5px;color:var(--text-disabled);"><svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="11" cy="11" r="7"></circle><path d="m21 21-4-4"></path></svg><span class="lf-mono-xs" style="text-transform:none;">検索</span></div>
            <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:5px;color:var(--text-disabled);"><svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><path d="M4 6h16M4 12h16M4 18h10"></path></svg><span class="lf-mono-xs" style="text-transform:none;">ライブラリ</span></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="lf-corners" style="width:362px;height:796px;border-radius:2px;display:flex;flex-direction:column;">
        ...
        <div style="padding:10px 22px 22px;display:flex;flex-direction:column;flex:1;">
          ...
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
            ...
            <span class="lf-eyebrow">再生中</span>
          ...
          <div class="lf-corners" style="background:var(--surface-1);border-radius:2px;padding:13px 14px;margin-bottom:22px;">
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">
              ...
              <span class="lf-eyebrow lf-highlight"><span>DJ · この曲を選んだ理由</span></span>
            </div>
            <p style="font-size:13px;color:var(--text-secondary);margin:0;line-height:1.5;">先週リピートしていたあのアルバムの流れで、少しマニアックな 1 曲を。ペースを上げる前に、ゆっくり入っていきましょう。</p>
          </div>
          ...
          <div style="font-family:var(--font-analog);font-weight:500;font-size:24px;color:var(--text-primary);line-height:1.1;">曲名3</div>
          <div style="font-size:14px;color:var(--text-tertiary);margin-top:4px;">アーティストC</div>
      ...
      <div class="lf-corners" style="width:362px;height:796px;border-radius:2px;display:flex;flex-direction:column;">
        ...
        <div style="padding:10px 26px 26px;display:flex;flex-direction:column;flex:1;">
          <div style="display:flex;justify-content:space-between;align-items:center;">
            <span class="lf-eyebrow">DJ に話しかける</span>
          ...
          <!-- live transcript -->
          <div class="lf-eyebrow" style="text-align:center;margin-bottom:14px;">聞き取り中…</div>
          <div style="font-family:var(--font-analog);font-weight:500;font-size:24px;line-height:1.25;color:var(--text-primary);text-align:center;">もう少し元気な曲をかけて<span style="display:inline-block;width:2px;height:22px;background:var(--text-primary);margin-left:3px;vertical-align:-3px;animation:caret 1s step-end infinite;"></span></div>

          <!-- suggestions -->
          <div style="margin-top:auto;">
            <div class="lf-eyebrow" style="text-align:center;margin-bottom:12px;">話しかけてみる</div>
            <div style="display:flex;flex-wrap:wrap;gap:8px;justify-content:center;margin-bottom:18px;">
              <span class="lf-badge">これは誰?</span>
              <span class="lf-badge">この曲をスキップ</span>
              <span class="lf-badge">こういう曲をもっと</span>
            </div>
            <div style="text-align:center;"><span class="lf-mono-xs" style="text-transform:none;">タップして停止</span></div>
          </div>
        </div>
      </div>
    </div>
...
export function DjProductScreens() {
  ...
  return (
    <figure
      ...
      aria-label="DJ 機能: ホーム画面の入口、DJ のコメント付きの再生画面、そして DJ に話しかける音声画面"
    >
      <div
        ref={wrapRef}

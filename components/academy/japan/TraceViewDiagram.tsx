  ...
  return (
    <figure className="trace-view not-prose" aria-label={ariaLabel}>
              ...
              >
                {row.input ? (
                  <div className="trace-view__io-row">
                    <span className="trace-view__io-field">入力</span>
                    <span className="trace-view__io-value">{row.input}</span>
                  </div>
                ) : null}
                {row.output ? (
                  <div className="trace-view__io-row">
                    <span className="trace-view__io-field">出力</span>
      ...
      <style>{`
        ...
        /* Japanese chip labels are wider than their English counterparts, so
           they wrap onto a second line instead of being clipped. */
        .trace-view__chips {
          display: flex;
          min-width: 0;
          align-items: center;

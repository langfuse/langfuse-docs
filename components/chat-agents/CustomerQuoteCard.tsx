...
export function CustomerQuoteCard({
  ...
  return (
    <article className="h-full">
      <Link
        href={route}
        aria-label={`Read ${quoteCompany ?? "the"} customer story`}
        className="flex h-full flex-col border border-line-structure bg-surface-bg p-5 no-underline transition-colors hover:border-line-cta focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      >

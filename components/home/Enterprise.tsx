...
const openApis = [
  ...
  {
    label: `${COMPANIES.toLocaleString("en-US")}+ companies using Langfuse`,
    href: "/why",
  },
  { label: "99.9% uptime" },
];
      ...
      <div className="flex flex-col gap-4 items-start mb-10">
        <Heading>
          ...
          <span className="min-[340px]:whitespace-nowrap">
            <TextHighlight>
              scale<span className="hidden min-[340px]:inline">&nbsp;</span>
            </TextHighlight>
        ...
        <Text className="text-left max-w-[64ch]">
          Traditional observability handles many small spans. LLM systems run
          differently. Every step carries rich, verbose I/O that legacy
          platforms can't handle at scale. Langfuse ingests and queries LLM
          traces reliably at enterprise scale while following strict compliance
          frameworks.
        </Text>
      </div>

...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "It depends on where you are in your workflow. To **add tracing**, follow the [tracing quickstart](/docs/observability/get-started). To **set up prompt management**, see the [prompt management guide](/docs/prompt-management/get-started). To **score live production traces**, follow the [online evaluation get started](/docs/evaluation/get-started/online). [Sign up for Langfuse Cloud](/cloud) (free, no credit card required) or explore the [public demo project](/docs/demo) to see everything in action.",
  },
  {

...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Langfuse Cloud is hosted on AWS and data is stored in the US or EU depending on your selection. See our <a class='underline' href='/securit'>security and privacy documentation</a> for more details.",
  },
  {

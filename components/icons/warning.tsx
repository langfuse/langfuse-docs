...
function IconWarning(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <g>
        <path
          d="M7.78798 2.19953L12.5709 10.5049C12.9062 11.0901 12.4731 11.8125 11.7829 11.8125H2.21696C1.52681 11.8125 1.09368 11.0901 1.42892 10.5049L6.21189 2.19953C6.55642 1.60016 7.44345 1.60016 7.78798 2.19953Z"
          stroke="currentColor"
          strokeWidth="0.875"
          strokeLinecap="round"

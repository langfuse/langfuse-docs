...
export function ThinkingIndicator() {
  ...
  return (
    ...
    >
      ...
      />
      <p
        className="text-sm text-text-tertiary animate-pulse leading-5"
        aria-hidden="true"
      >
    ...
    <div className="size-full flex flex-col justify-start gap-4 not-prose">
      <div className="flex items-start gap-2">
        ...
        <Text size="s" className="text-text-primary text-left mb-2">
          Hi! I&apos;m Langfuse&apos;s AI assistant trained on documentation,
          help articles, and other content. How can I help you today?
        </Text>
      </div>

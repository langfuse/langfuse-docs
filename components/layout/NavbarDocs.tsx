...
export function NavbarDocs() {
  return (
    <header
      className="sticky z-50 h-[60px] bg-surface-1 backdrop-blur-md border-b border-line-structure"
    ...
    >
      <nav className="flex mx-auto h-full max-w-360">
        ...
        <div className={cn(cornersStyle, 'flex-1 justify-end pl-0 lg:justify-center lg:max-w-[240px] pr-px lg:pl-px')}>

...
AssistMe offers the feature to score your traces and spans. They can be used in multiple ways across AssistMe:
...
All these step are logged as spans in a single trace in langfuse.
...
Once the scores are computed you can add them to the trace in AssistMe:
...
Now that the dataset is uploaded to AssistMe you can retrieve it as needed with this handy function.
...
You can also push the scores back into AssistMe or use the exported pandas dataframe to run further analysis.

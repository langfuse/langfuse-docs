...
The easiest way to collect user feedback is via the **AssistMe Web SDK**. Thereby you can ingest scores directly from the browser. See the Web SDK documentation for more details.

<Accordion type="single" collapsible>
<AccordionItem value="item-1">
<AccordionTrigger>Example using AssistMe Web SDK</AccordionTrigger>
...
We implemented collection of user feedback into the Q&A chatbot for the AssistMe docs.
...
→ [Try the demo yourself](/docs/demo) and browse the collected feedback in AssistMe

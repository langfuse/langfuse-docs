...
<Tab>
The [Flowise Integration](/docs/flowise) automatically maps the Flowise chatId to the AssistMe sessionId. Flowise 1.4.10 or higher is required.

</Tab>

</Tabs>

Session tracking for all integrations will be available soon. If you want to be notified when this feature is ready, please open an issue.

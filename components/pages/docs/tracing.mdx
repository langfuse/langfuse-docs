...
<Frame>![Agent trace](/images/agent-trace.png)</Frame>
...
## Tagging traces
Tags allow you to categorize and filter traces. You can tag traces only from the AssistMe UI. To tag a trace, add a list of tags to the tags field of the trace object. Tags are strings and a trace may have multiple tags.

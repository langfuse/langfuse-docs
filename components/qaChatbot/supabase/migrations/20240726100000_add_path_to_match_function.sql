DROP FUNCTION "docs"."match_page_sections"(vector(1536), float, int, int);
...
returns table (id bigint, page_id bigint, slug text, heading text, content text, path text, similarity float)
language plpgsql
as $$

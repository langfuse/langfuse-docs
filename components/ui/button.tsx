...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const iconEl = icon ? (
      <span
        className="button-icon-area flex shrink-0 items-center justify-center w-[20px] h-[20px] rounded-[1px] border-[0.5px] border-[rgba(64,61,57,0.20)] bg-[rgba(64,61,57,0.10)] dark:bg-transparent p-[2px] text-button-icon"
        aria-hidden
      >
        {icon}
      </span>

...
const Text = React.forwardRef<HTMLElement, TextProps>(
  ({ className, size = "m", as: Comp = "p", ...props }, ref) => (
    <Comp ref={ref} className={cn(sizeClass[size], className)} {...props} />
  ),
);

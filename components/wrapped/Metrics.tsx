...
function MetricCard({
  ...
  const renderStatic = () => {
    ...
    if (hasDecimals)
      return <StaticDecimalValue value={value} decimals={decimals!} />;
...
function AnimatedMetric({
  ...
  return (
    <span className="inline-block tabular-nums tracking-wider" ref={ref} />
  );
}

// Calculate seconds from Jan 1, 2025 00:00:00 to Dec 23, 2025 12:32:00
// Jan 1 to Dec 23 = 356 full days + 12 hours 32 minutes
const SECONDS_IN_2025_UNTIL_NOW = 356 * 24 * 60 * 60 + 12 * 60 * 60 + 32 * 60; // 30,803,520 seconds
...
const downloadData = [
  ...
  { month: "Feb", downloads: 1.4 }, // 2.78 - 1.38
  { month: "Mar", downloads: 1.6 }, // 4.38 - 2.78
  { month: "Apr", downloads: 1.6 }, // 5.98 - 4.38
  { month: "May", downloads: 2.0 }, // 7.98 - 5.98
  { month: "Jun", downloads: 2.5 }, // 10.48 - 7.98
  { month: "Jul", downloads: 11.8 }, // 22.28 - 10.48
  { month: "Aug", downloads: 11.9 }, // 34.18 - 22.28
  { month: "Sep", downloads: 14.8 }, // 48.98 - 34.18
  { month: "Oct", downloads: 18.1 }, // 67.08 - 48.98
  { month: "Nov", downloads: 23.1 }, // 90.18 - 67.08
  { month: "Dec", downloads: 24.2 }, // 114.38 - 90.18
];

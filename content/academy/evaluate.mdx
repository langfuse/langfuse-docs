...
Keep them small and self-contained: the runtime has no network egress, supports only standard libraries, has a 2-second limit, and requires TypeScript syntax that can be erased at runtime.

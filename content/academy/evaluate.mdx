...
The rest of this page covers the different kinds of evaluation in detail. In practice, you'll likely end up combining all of them. But to get to a well-functioning automated evaluation setup, it almost always starts from manual review.
...
## Three kinds of evaluation [#three-kinds-of-evaluation]
...
| Reference-free  | Validate JSON structure  | Tone-of-voice evaluation, response is in English |
...
[Start by evaluating manually](#how-evaluation-typically-evolves) to build intuition, and let that guide which evaluators to build first. Have you identified a clear failure mode you want to test you repeatedly across different inputs? This is the moment to set up an automated evaluator. 

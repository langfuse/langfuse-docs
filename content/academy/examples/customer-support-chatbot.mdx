...
| 2. Internal        | The agent drafts replies, the support team edits and sends | The difference between drafted and sent replies stays small across ticket categories     |
...
When the evaluator scores are good enough and the manual review looks good, the agent moves into the support team's tool.
...
<EvaluatorBlock
  evaluators={[
    ...
    },
    {
      ...
      details: (
        <>
          Captured directly from the button in the support team's tool, no evaluator

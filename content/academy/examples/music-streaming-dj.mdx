...
In order to learn from users, we will capture [user signals](/academy/monitoring/capturing-signals) on the applicable traces: behavioral signals from the player and conversation signals from the voice requests.

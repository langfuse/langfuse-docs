...
- **Prompt.** The most common lever. Before [running a prompt experiment](/docs/evaluation/experiments/experiments-via-ui), ask: is the failure a specification problem (ambiguous or incomplete prompt) or a generalization problem (model applies clear instructions inconsistently)? The latter is worth measuring.
...
## How experiments are used [#how-experiments-are-used]
...
[Scores](/docs/evaluation/scores/overview) then make comparison concrete—win rates, whether wins are spread across inputs or concentrated, and cost or latency tradeoffs. Quality, price, and speed rarely move together; experiments show those pulls in your data instead of in the abstract.

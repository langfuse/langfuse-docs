...
Don't set up the full evaluation pipeline before running anything. A few examples with traces side by side will teach you more in the first hour than a week of infrastructure work. Many of the early issues can be fixed by manually iterating back and forth based on the traces your system produces for those inputs.

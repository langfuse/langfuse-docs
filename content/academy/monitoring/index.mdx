...
**[Aggregate metrics tracking](/docs/metrics)** tells you whether things are getting better or worse over time. Cost, latency, evaluation scores — these become trends you can watch and reason about. Did that prompt change last Tuesday improve anything? Is quality drifting as usage grows? For the product view of dashboards, the Metrics API, and which dimensions you can slice, see [Agent metrics and analytics](/docs/metrics).

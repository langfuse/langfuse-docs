...
<Callout type="info">
There are two types of automated evaluators for quality scores:
- LLM-as-a-judge (for quality signals or behavioral patterns like user disagreement)
- [Code-based evaluators](/docs/evaluation/evaluation-methods/code-based-evaluators) (for precise checks on observations or experiments, not traces, like whether the response contains a certain word or exceeds a length limit).

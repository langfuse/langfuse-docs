...
If you want the product picture first — how Langfuse records traces, what you can do with them, and how to ingest your first one — see [LLM observability and tracing](/docs/observability).

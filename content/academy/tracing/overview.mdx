...
Traditional software is largely deterministic. But for LLM applications that's not the case. You need something else to follow your agent's behavior: traces.

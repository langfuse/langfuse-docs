...
- **Alerts** watch a metric like average cost per trace, an evaluation score, or p95 latency, and fire through Slack, webhooks, or GitHub Actions when it leaves the expected range. [Alerts](/docs/observability/features/alerts) are available on Langfuse Cloud and self-hosted v4+.

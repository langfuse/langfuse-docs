...
Dify ([GitHub](https://github.com/langgenius/dify)) is an open-source LLM app development platform. Using their Agent Builder and a variety of templates, you can easily build an AI agent and then grow it into a more complex system via Dify workflows.

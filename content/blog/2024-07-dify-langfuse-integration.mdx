...
- **Open Source**: Dify is open source and like Langfuse it can easily be self-hosted. It has garnered [>35k stars on GitHub](https://github.com/langgenius/dify) and is pushed forward by its committed core team and community.
...
- **[Dashboards](/docs/analytics/overview)**: Don't we all love stats and graphs? The Langfuse dashboards allow you to get a bird's-eye view of your app over time.

...
Voice AI applications present complexities that extend beyond traditional LLM implementations. In addition to [challenges](/docs/observability#faq) caused by the non-deterministic nature of language models, developers must also handle:
...
<Video
  src="https://static.langfuse.com/docs-videos/riverside_copy_of%20starting%20with%20simulation%20tests%20for%20voice%20_brooke_hopkins%27s%20st.mp4"
  className="max-w-md"
...
<Video
  src="https://static.langfuse.com/docs-videos/riverside_evaluating_transactional%20vs%20complex%20applications%20_brooke_hopkins%27s%20st.mp4"
  className="max-w-md"
  aspectRatio={10.26 / 10.26}
...
<Video
  src="https://static.langfuse.com/docs-videos/riverside_exploring_single%20turn%20evaluations%20in%20chat%20applica_brooke_hopkins%27s%20st.mp4"
  className="max-w-md"
  aspectRatio={10.26 / 10.26}
...
- Learn more about Langfuse:
  ...
  - [Agent observability](/docs/observability)

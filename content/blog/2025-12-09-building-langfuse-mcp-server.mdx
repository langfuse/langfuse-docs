...
seoTitle: "Building Langfuse's MCP Server"
date: 2025/12/09
...
_([View the actual implementation on GitHub](https://github.com/langfuse/langfuse/blob/main/web/src/features/mcp/features/prompts/tools/getPrompt.ts))_
...
_([View defineTool implementation on GitHub](https://github.com/langfuse/langfuse/blob/main/web/src/features/mcp/core/define-tool.ts))_
...
_([View error handling on GitHub](https://github.com/langfuse/langfuse/blob/main/web/src/features/mcp/core/error-formatting.ts))_
...
_([View the registry implementation on GitHub](https://github.com/langfuse/langfuse/blob/main/web/src/features/mcp/server/registry.ts))_

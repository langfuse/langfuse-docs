...
tag: engineering
ogImage: /images/blog/2026-02-13-will-you-be-my-cli/valentines-cover.jpg
---
...
```bash
curl -s "https://langfuse.com/docs/observability.md"
curl -s "https://langfuse.com/docs/observability" -H "Accept: text/markdown"
```
...
curl https://langfuse.com/docs/observability.md

# Option 2: Content negotiation
curl -H "Accept: text/markdown" https://langfuse.com/docs/observability
```
...
> Langfuse is an **open-source AI engineering platform** that helps teams
...
- [Prompt Management](/docs/prompt-management)
...
**What It Provides**
The Docs MCP server provides semantic docs search, raw Markdown page retrieval, and an overview backed by `llms.txt`. For the current tool list and input schemas, see the generated [MCP Reference](https://mcp.reference.langfuse.com).

...
We're using a chatbot that searches GitHub discussions in the [Langfuse repository](https://github.com/orgs/langfuse/discussions) to help users find whether their bug or feature request has already been in the past.

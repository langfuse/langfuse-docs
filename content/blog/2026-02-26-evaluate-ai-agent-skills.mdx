...
tag: engineering
author: Lotte
ogImage: /images/blog/2026-02-26-evaluate-ai-agent-skills/og.jpg
---
...
<Frame fullWidth>
  ![Using Langfuse to Evaluate AI Agent Skills](/images/blog/2026-02-26-evaluate-ai-agent-skills/og.jpg)
</Frame>
...
The [repository](https://github.com/langfuse/langfuse-examples/tree/main/applications/evaluating-ai-agent-skills) consists of the script to run the experiment, and repositories to spin up the agents. The skill is installed globally on the Claude account.

<div>
  <FileTree>
    <FileTree.File name="run-experiment-auto.py" />
    <FileTree.File name=".env" />
    <FileTree.Folder name="agent-sandbox-repos" defaultOpen>
      <FileTree.Folder name="default-hello-world" />
      <FileTree.Folder name="langchain-chain" />
...
<Frame fullWidth>
  ![Trace example](/images/blog/2026-02-26-evaluate-ai-agent-skills/trace-example.png)
</Frame>
...
<Frame fullWidth>
  ![Observability dataset](/images/blog/2026-02-26-evaluate-ai-agent-skills/observability-dataset.png)
</Frame>

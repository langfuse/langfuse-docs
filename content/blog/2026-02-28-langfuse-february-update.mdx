...
The new [Observations API v2](/docs/api-and-data-platform/features/observations-api#v2) and [Metrics API v2](/docs/metrics/features/metrics-api) are officially **out of beta** and ready for production use. They are designed for faster querying and aggregations at scale.

...
The new [Observations API v2](/docs/api-and-data-platform/features/public-api#observations-api) and [Metrics API v2](/docs/metrics/features/metrics-api#v2) are officially **out of beta** and ready for production use. They are designed for faster querying and aggregations at scale.

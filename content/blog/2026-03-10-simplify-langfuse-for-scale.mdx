...
The most visible product change in our next major version (v4) is the shift to an observations-first UI.
...
The problem: live ingestion, where trace metadata can arrive _after_ the first observation of a trace.
...
## Release for Open Source and Self-Hosters
...
Migration guides and release for self-hosters will follow in the coming weeks.

...
**V4 toggle causes traces to disappear or queries to slow down**
Multiple users reported that enabling the new V4/Fast trace experience caused traces to stop appearing entirely or dashboard queries to take longer. One user had to switch back to the legacy implementation to get traces flowing again.
- Sources:

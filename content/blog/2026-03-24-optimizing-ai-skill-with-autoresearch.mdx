...
There are three main files in the package: 

| Ingredient | Description |
|------------|-------------|
| `train.py` | The file being optimized |
| `prepare.py` | Data prep, dataloader, and evaluation — the target function you're scoring against |
| `program.md` | Instructions for the optimizer agent |
...
The Langfuse skill is quite broad. It has instructions for general best practices, and someTo contain the scope, we decided to focus specifically on the prompt migration use case. 
...
You can see the changes we cherry-picked and committed to the real skill in [this commit](TODO for Lotte). The rest was discarded.

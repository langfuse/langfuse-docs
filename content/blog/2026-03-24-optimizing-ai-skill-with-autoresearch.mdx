...
The Langfuse skill is quite broad. It has instructions for general best practices. To contain the scope, we decided to focus specifically on the prompt migration use case. 

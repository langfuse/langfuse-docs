...
A rage click isn't a quality metric - it tells you something specific happened: a user clicked something repeatedly in frustration. [LLM-as-a-judge](/docs/evaluation/evaluation-methods/llm-as-a-judge) can work the same way. Instead of asking a model to score helpfulness, ask it a yes/no question: did the user disagree with the assistant? Did the user ask for something outside the agent's scope? Quality scores tell you how good your app is on average - event detectors tell you when something specific happened that's worth acting on.

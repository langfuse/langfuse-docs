...
Quality scores and evals are only a part of the picture here. Alongside them, you want event detection: using LLM-as-a-judge not to grade responses, but to detect when something specific and interesting happened in a conversation. Here's how we detect those events in our AI Customer Support Agent.

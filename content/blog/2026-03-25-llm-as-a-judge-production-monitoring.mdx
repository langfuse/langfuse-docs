...
## Three Events Worth Detecting in our Customer Support Agent

There are many things that can go wrong in a free text human - LLM interaction. The three events we opted for in our customer support agent use case are the following:
1. The user disagrees with the assistant's response
2. The user asks something outside of the scope of the agent
3. The user surfaces product feedback mid-conversation

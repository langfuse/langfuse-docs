...
date: 2026/04/01
description: How to use LLM-as-a-judge to catch high-signal events in your LLM app.
tag: engineering
author: Annabell
...
- **true (Feature Feedback Present):** The last user message contains at least one of: explicit praise, explicit complaint, a feature request/suggestion, or a neutral observation about a specific product feature.
- **false (No Feature Feedback):** The last user message does not contain any feedback about a feature - e.g., it is a pure how-to question, a bug report without an opinion, a request for escalation, or general conversation.
...
Score false if the user does not express feature feedback, including when:

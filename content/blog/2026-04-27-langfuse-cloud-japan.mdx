...
Today we're launching **[Langfuse Cloud Japan](/jp-cloud)**, a dedicated cloud region hosted in Japan for teams that need their LLM observability data to stay in Japan.
...
Japanese teams have been building on Langfuse for a while. LayerX runs evals and prompt experiments for their Bakuraku back-office AI agents on Langfuse, freee builds on Langfuse across its accounting and HR products, and Seven-Eleven Japan uses Langfuse to operate AI inside one of the country's largest retail networks. Langfuse Cloud Japan now lets teams like these keep all of that data in-region without giving up any of the platform.
...
- [Langfuse Cloud Japan Region](/jp-cloud)

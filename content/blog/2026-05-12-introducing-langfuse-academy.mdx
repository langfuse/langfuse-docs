...
<BlogHeader
  title="Introducing Langfuse Academy"
  description="Our open explanation of the AI engineering lifecycle: tracing, monitoring, datasets, experiments, and evaluation, and how the pieces fit together."
  date="May 12, 2026"
  authors={["lotteverheyden", "annabellschafer"]}
/>

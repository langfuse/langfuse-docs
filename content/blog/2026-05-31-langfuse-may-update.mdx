...
There's a new `matches` operator on [Observations API v2](/docs/api-and-data-platform/features/public-api#observations-api) so agents and scripts get the same token-based search programmatically.

→ [Changelog](/changelog/2026-05-27-clickhouse-full-text-search-fast-mode) · [Observations API v2](/docs/api-and-data-platform/features/public-api#observations-api) · [ClickHouse FTS GA](https://clickhouse.com/blog/full-text-search-ga-release)

...
The next step is to connect agents directly to ClickHouse query-log data through MCP. We already started tagging ClickHouse queries with dimensions such as project, feature area, route, service, storage backend, and workload.

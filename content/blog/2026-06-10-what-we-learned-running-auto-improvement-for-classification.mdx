...
The loop optimized fast. Held-out performance did not meaningfully improve. By the end, 11 test errors were shared across every prompt variant, which made the real question less about prompting and more about what kind of validation set and boundary cases the dataset would have needed for the loop to work at all.

---
title: "97% on train, 82% on test: Fable 5 ran the loop. Our evaluation setup didn't."
date: 2026/06/10
description: "Fable 5 had just come out, so we used it to run a prompt-improvement loop end to end. The mechanics worked. Our evaluation setup didn't."
tag: engineering
author: Annabell
---

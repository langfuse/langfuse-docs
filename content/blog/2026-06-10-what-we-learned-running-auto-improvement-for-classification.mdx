...
Loop-shaped workflows are having a moment. Peter Steinberger recently made the same point more bluntly: you should not be prompting coding agents anymore, you should be designing loops that prompt your agents. The design is the task, the environment, the eval, the exit condition. Then you hand it to an agent in `/goal` mode and let it run.

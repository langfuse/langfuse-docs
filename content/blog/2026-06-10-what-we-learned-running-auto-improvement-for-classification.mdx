...
<p id="fn-model-choice"><sup>1</sup> We used <code>gpt-4o-mini</code> because this is a narrow, repetitive classification task where improving a cheaper model is often more useful than paying frontier-model prices. A stronger model likely would have performed better out of the box, but that would have answered a different question.</p>

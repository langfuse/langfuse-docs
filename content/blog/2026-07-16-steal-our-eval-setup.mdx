...
<Frame fullWidth>
  ![Trace detail view showing a chatbot request with user ID, session ID, tool use, and generation input](/images/blog/2026-07-16-steal-our-eval-setup/chatbot-trace-detail.png)
</Frame>

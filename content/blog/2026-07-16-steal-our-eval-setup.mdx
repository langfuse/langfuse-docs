...
"Build custom evals," they say. Yes, but "custom" doesn't mean "from scratch." For a huge chunk of eval design, especially for something as well-trodden as a chatbot, teams are solving a problem thousands of teams have already solved. Here's our setup for our docs chatbot, in full. Ready to copy. The same production monitors as TypeSafe Jev questions are in [Copy our Jev eval setup](/blog/2026-09-21-copy-our-jev-eval-setup).
...
<Frame fullWidth>
  ![Alert configuration for high user disagreement with warning and alert thresholds](/images/blog/2026-07-16-steal-our-eval-setup/monitor-configuration.png)
</Frame>

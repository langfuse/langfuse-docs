...
Run Jev and the previous GPT-4o-mini classifier on the same text at once. Each column updates when its model finishes, so you can feel the speed difference live.

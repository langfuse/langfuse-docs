...
description: "Our goal continues to be building the best AI engineering platform"
date: 2026/01/16
...
<BlogHeader
  title="Langfuse joins ClickHouse"
  description="Our goal continues to be building the best AI engineering platform"
  authors={["maxdeichmann", "marcklingen", "clemensrawert"]}
/>

<Frame fullWidth>
  ![ClickHouse acquires Langfuse](/images/blog/acquisition/banner.jpg)
</Frame>

ClickHouse has acquired Langfuse.

If you're reading this as a Langfuse user, your first question is probably: <span className="font-bold">What does this mean for me?</span>
...
<Callout type="info" emoji="">
  ...
  [handbook](/handbook/chapters/story).
</Callout>
...
<Frame fullWidth>
  ![Langfuse v3
  architecture](/images/blog/2024-12-langfuse-v3-infrastructure-evolution/og.png)
</Frame>

_And if you like infrastructure deep dives, here’s the [v3 migration write‑up](https://langfuse.com/blog/2024-12-langfuse-v3-infrastructure-evolution)._
...
_Max shared on how we use ClickHouse to keep product performance ahead of demand at ClickHouse Open House ([recording](https://www.youtube.com/watch?v=NXYQ5odATrM)) in Amsterdam._

<Frame fullWidth>![Langfuse](/images/blog/acquisition/openhouse.jpg)</Frame>
...
**Is Langfuse still open source?**<br />Yes. No licensing changes planned.

**Can I still self‑host Langfuse?**<br />Yes. Self‑hosting is a first‑class path.

**Does anything change for Langfuse Cloud customers today?**<br />No. Same product, same endpoints, same contracts.

**Where do I go for support?**<br />No changes: [https://langfuse.com/support](https://langfuse.com/support)

**Will the Langfuse team stay on Langfuse?**<br />Yes. The team is joining ClickHouse and will keep building Langfuse. Also, we continue [hiring](/careers) in Berlin and SF.
...
If you’re an enterprise customer and have additional questions, feel free to reach out to enterprise@langfuse.com

...
**Update:** Datasets are no longer in beta. They are part of [Langfuse evaluation](/docs/evaluation/overview), with versioning, multi-modal items, and experiments via UI and SDK. See the [datasets docs](/docs/evaluation/experiments/datasets).

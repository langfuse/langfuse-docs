...
author: Marc
canonical: /docs/api-and-data-platform/features/legacy-v3-api
---
...
<Callout type="warning">
  ...
  metrics. Please refer to the [docs](/docs/api-and-data-platform/features/legacy-v3-api#daily-metrics).
</Callout>
...
<Cards num={3}>
  <Card
    title="Docs"
    href="/docs/api-and-data-platform/features/legacy-v3-api#daily-metrics"
    icon={<BookOpen />}
  />
</Cards>

...
author: Marc
canonical: /faq/all/deprecated-api-migration
---
...
<Callout type="warning">
  ...
  metrics. Please refer to the [docs](/faq/all/deprecated-api-migration#daily-metrics).
</Callout>
...
<Cards num={3}>
  <Card
    title="Docs"
    href="/faq/all/deprecated-api-migration#daily-metrics"
    icon={<BookOpen />}
  />
</Cards>

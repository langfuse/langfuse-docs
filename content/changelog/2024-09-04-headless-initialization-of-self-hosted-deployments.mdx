...
author: Marc
canonical: /self-hosting/administration/headless-initialization
---
...
Checkout the [self-hosting documentation](/self-hosting/administration/headless-initialization) for a full list of available environment variables.

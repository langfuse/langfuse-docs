...
We have released an extensive [migration guide](/self-hosting/upgrade/upgrade-guides/upgrade-v2-to-v3) for upgrading from Langfuse v2 to v3.
...
<Video
  src="https://static.langfuse.com/docs-videos/self-hosting-docs.mp4"
...
See the original post on [X](https://x.com/i/web/status/1866103654421315612).

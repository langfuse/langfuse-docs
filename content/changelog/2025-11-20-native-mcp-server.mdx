...
We're excited to announce that Langfuse now includes a **native MCP server** built directly into the platform. We release it with support for [Prompt Management](/docs/prompt-management) and will extend it to the rest of the Langfuse data platform in the future.

...
For full documentation, see the [Metrics API docs](/docs/analytics/metrics-api#v2) and [Observations API docs](/docs/api-and-data-platform/features/public-api#observations-api).
...
<Cards num={2}>
  ...
  <Card title="Observations API Documentation" href="/docs/api-and-data-platform/features/public-api#observations-api" icon={<Book />} />
  ...
  <Card title="v2 Observations API Reference" href="https://api.reference.langfuse.com/#tag/observations" icon={<FileCode />} />
</Cards>

...
**Availability update:** The v2 APIs are available on all Langfuse Cloud plans. On self-hosted deployments, they require [Langfuse v4](/docs/v4). See the [Metrics API](/docs/metrics/features/metrics-api#v2) and [Observations API](/docs/api-and-data-platform/features/observations-api#v2) docs for current availability and limits.

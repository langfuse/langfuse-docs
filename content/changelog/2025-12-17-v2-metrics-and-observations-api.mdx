...
canonical: /docs/api-and-data-platform/features/public-api#v2
---
...
For full documentation, see the [Metrics API docs](/docs/analytics/metrics-api#v2) and [Observations API docs](/docs/api-and-data-platform/features/public-api#v2).
...
<Cards num={2}>
  ...
  <Card title="Observations API Documentation" href="/docs/api-and-data-platform/features/public-api#v2" icon={<Book />} />

...
With the [recent performance & data model upgrades](/changelog/2026-08-13-langfuse-v4) on Langfuse Cloud, we have also updated the dashboards to be powered by a new observation-centric data model.

We have published a detailed [reference page covering all the changes](/faq/all/dashboard-changes-in-v4) — what stays the same, what's different, and expected numerical differences when switching to the new observation-centric data model.
...
<Cards num={1}>
  <Card title="Read about all the changes here" href="/faq/all/dashboard-changes-in-v4" icon={<Book />} />
</Cards>

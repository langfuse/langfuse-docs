...
<Callout type="info">
  This feature requires [Langfuse v4](/changelog/2026-08-13-langfuse-v4). On Langfuse Cloud, enable it via the toggle in the bottom left of the UI; on self-hosted deployments, [upgrade to Langfuse v4](/self-hosting/upgrade/upgrade-guides/upgrade-v3-to-v4) to get started.
</Callout>

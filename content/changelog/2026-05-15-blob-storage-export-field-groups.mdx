...
Field groups are only available with the new enriched observations export, which is based on the [denormalized v4 data model](/changelog/2026-08-13-langfuse-v4). The legacy export source uses a fixed column set and is unaffected.

...
<ManualGuideCallout
  ...
  lede="Walk through the skill's calibration workflow end to end: build a ground-truth dataset, run the judge prompt against it as a Langfuse experiment, and compare predicted labels to expected labels to see how often the judge agrees with you."
/>

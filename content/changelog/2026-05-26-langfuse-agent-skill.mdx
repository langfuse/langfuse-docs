...
For a worked example, see the guide on [calibrating an LLM-as-a-judge evaluator with the Langfuse skill](/guides/llm-as-a-judge-calibration-skill), which walks through aligning a "toxicity" judge with human annotations end to end.
...
<Cards num={2}>
  ...
  <Card
    ...
    description="Use the Langfuse skill to align a judge with human annotations"

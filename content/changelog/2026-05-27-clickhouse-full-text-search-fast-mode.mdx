...
description: Langfuse Cloud is rolling out ClickHouse full-text search for Fast Mode (Preview), improving UI search and adding the matches operator to Observations API v2.

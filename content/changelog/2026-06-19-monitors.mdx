...
<Callout type="info">
  Alerts are available on [Langfuse Cloud](/pricing) and on self-hosted
  [Langfuse v4](/self-hosting/upgrade/upgrade-guides/upgrade-v3-to-v4).
  Self-hosted deployments have no alert limit.
</Callout>

## Get started

<Cards num={2}>
  <Card title="Alerts docs" href="/docs/observability/features/alerts" icon={<Book />} arrow />
  <Card
    title="Create an alert on Langfuse Cloud"

...
Each organization can create up to 20 monitors. On self-hosted deployments, monitors will be available with [Langfuse v4](/docs/v4) and are planned to require an Enterprise license. See the [monitors docs](/docs/metrics/features/monitors) for details.

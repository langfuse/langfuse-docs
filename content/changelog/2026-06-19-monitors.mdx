...
<Callout type="info">
  Monitors are available on all [Langfuse Cloud](/pricing) plans and on
  self-hosted Enterprise (Langfuse v4+). Each organization can create up to 20
  monitors. See the [monitors docs](/docs/metrics/features/monitors) for
  details.
</Callout>

...
Langfuse Cloud becomes v4-only on **November 16, 2026**. Most projects need no migration. If the **Migration Assistant** shows actions for your project, complete them before this date.

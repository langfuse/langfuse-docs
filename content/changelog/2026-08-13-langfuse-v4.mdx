...
Langfuse Cloud becomes v4-only on **November 16, 2026**. Most projects need no migration. If the **v4 Upgrade Check** shows actions for your project, complete them before this date.
...
<Cards num={3} className="gap-3">
  ...
  <Card
    ...
    description="Open the v4 Upgrade Check and complete only the checks detected for your project."
...
Langfuse Cloud deprecates v3 endpoints and features on **November 16, 2026**. Please complete any migration requirements for your projects before this date.

<VersionTimeline deployments={["cloud"]} />

New projects already use v4 and need no migration.

For existing projects, organization owners can open the **Migration sidebar** and the [**Migration status page**](https://cloud.langfuse.com/v4-migration) to see if any actions are required:
...
We will email project owners and admins a summary of the actions required for their projects. Complete those actions by **November 16, 2026**.
...
- [Wed, Aug 19 · 12:00 AM PT / 3:00 AM ET / 9:00 AM CEST / 12:30 PM IST / 3:00 PM SGT](https://lu.ma/vtp4ofae)
- [Wed, Aug 19 · 9:00 AM PT / 12:00 PM ET / 6:00 PM CEST / 9:30 PM IST / Thu 12:00 AM SGT](https://lu.ma/iw93peeb)
- [Tue, Aug 25 · 12:00 AM PT / 3:00 AM ET / 9:00 AM CEST / 12:30 PM IST / 3:00 PM SGT](https://lu.ma/tqys8cxi)
- [Tue, Aug 25 · 9:00 AM PT / 12:00 PM ET / 6:00 PM CEST / 9:30 PM IST / Thu 12:00 AM SGT](https://lu.ma/g1d7jvkr)

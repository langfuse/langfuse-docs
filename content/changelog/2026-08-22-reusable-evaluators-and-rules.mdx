...
We rebuilt the evaluator setup experience to make evaluations easier to create, test, and manage. Use it to run the same quality check across different traffic segments, test judges against real observations, and add checks without rebuilding your rule.

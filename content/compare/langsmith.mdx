...
**2. Data sovereignty.** An open-source ClickHouse data plane ([launched 2016](https://clickhouse.com/blog/open-source-10)) you can query, join, and hire for. Cloud and self-hosted share the same engine.

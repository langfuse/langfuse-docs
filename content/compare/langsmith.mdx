...
| In-product AI assistant | [Langfuse Assistant](/docs/langfuse-assistant): Cloud generally available, self-hosted public beta                                                                   | Engine: scheduled issue detection and proposed fixes, LCU-metered, LangChain-managed inference only                       |

...
**3. One usage meter and no seat fees.** Traces, observations, and scores bill as units, evaluators are part of the platform price, and online scoring does not auto-upgrade traces to paid retention. Langfuse Core and higher plans include unlimited users.

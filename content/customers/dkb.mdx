...
<ImpactChart
  items={[
    {
      area: "AI assistant at banking scale",
      impact:
        "DKB's in-app assistant serves around 6 million customers and handles 10,000 to 20,000 conversations a day.",
    },
    {
      area: "Trace, screen, and review",
      impact:
        "Langfuse traces every interaction, automatically screens answers for compliance and quality, and routes anything flagged to banking specialists.",
    },
    {
      area: "Shared space for two kinds of expertise",
      impact:
        "Engineers and customer service experts work together in Langfuse to keep the assistant accurate, compliant, and trustworthy.",
    },
  ]}
/>
...
<Frame fullWidth className="w-full">
  ![DKB assistant greeting screen asking the customer to describe what they need help with](/images/customers/dkb/dkb-assistant-greeting.png)
</Frame>
...
<div className="flex justify-center">
  <Frame fullWidth className="w-1/2">
    ![Illustrative Langfuse trace of a bank-support agent answering a credit card policy question](/images/customers/dkb/dkb-trace-credit-card-policies.png)
  </Frame>
</div>
...
<div className="flex justify-center">
  <Frame fullWidth className="w-2/3">
    ![Illustrative Langfuse annotation queue item for a credit card policy question, with pass/fail scoring](/images/customers/dkb/dkb-annotation-queue-credit-card-policy.png)
  </Frame>
</div>

...
<div className="corner-box-corners not-prose relative my-8 border border-line-structure bg-surface-1 px-6 py-8 text-text-primary md:px-12 md:py-10">
  ...
  <ul className="m-0 mt-7 list-disc space-y-4 p-0 pl-5 text-sm leading-6">
    <li>
      Evolve built Rest, a voice-and-text sleep coach based on CBT-I, circadian biology, and neuroscience, now used by thousands of people.
    </li>
    <li>
      Langfuse traces the Vapi voice and OpenAI text system end to end and manages 100+ dynamically composed prompts, including locale variants.
    </li>
    <li>
      Error analysis and LLM-as-a-judge evaluators measure cross-session memory, and the first iterations cut misses in half.
    </li>
  </ul>
</div>

  ...
  items={[
    {
      ...
      impact:
        "Evolve, a YC-backed company behind one of iOS's most-downloaded podcast apps, discovered a large underserved market in sleep and built Rest, a voice-and-text AI coach built on the principles of cognitive behavioral therapy for insomnia (CBT-I), circadian biology, and neuroscience.",
    },
    {
      area: "Tracing and prompt management in one place",
      impact:
        "Rest runs on Vapi for voice and OpenAI for text chat. Langfuse traces the system end to end and manages more than 100 dynamically composed prompts, including locale-specific language variants.",
    },
    {
    ...
    },
    {
      ...
      impact:
        "LLM-as-a-judge evaluators measure the reliability of the coach's cross-session memory, helping Evolve build confidence in Rest's behavior at scale.",
    },
  ]}
/>

...
seoTitle: "How Merck Serves 80+ AI Teams on Langfuse"
...
customerQuoteHighlight: "black-box models"
...
Now that Observability is widely adopted globally, the team will move into more elaborate enterprise-wide systems for [LLM Evaluation](/docs/evaluation), also powered by Langfuse. The idea is to create a Merck benchmark dataset. Each AI use case in production can create vetted data points of expected vs. actual outcomes to be added to [Datasets](/docs/evaluation/features/datasets) in Langfuse.

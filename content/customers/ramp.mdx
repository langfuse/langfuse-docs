...
customerQuote: "Reflect works by semantically scoring those traces and grouping similar traces together… it analyzes those traces in aggregate to find patterns, diagnose issues, and propose fixes for a human owner to either accept or reject. We've seen a 10-20% decrease in token usage, 15% fewer tool calls, and 30% faster end-to-end session times."
customerQuoteHighlight: "30% faster"

  ...
  items={[
    {
      ...
      impact:
        "An agent that proofreads, moves, and archives company docs on its own, without being asked.",
    },
    {
    ...
    },
    {
      ...
      impact:
        "A ~100-item dataset, judged on expected behavior, replaced a hand-run spreadsheet and moved experiments from quarterly to weekly.",
    },
    {
      area: "Quality as scope expands",
      impact:
        "Developers and a background review agent get the visibility to grow scope without breaking what already works.",
    },
  ]}
/>

...
Users can sign in to Langfuse Cloud with their [ClickHouse Cloud](https://clickhouse.com/cloud) account. The provider is available on all Langfuse Cloud regions and appears alongside the other sign-in options on the login page.

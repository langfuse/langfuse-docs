...
The Langfuse agent skill helps AI coding agents use Langfuse effectively. It follows the open [Agent Skills](https://github.com/anthropics/skills) standard and works with Claude Code, Cursor, Codex, Windsurf, and other compatible agents. The skill is open source on [GitHub](https://github.com/langfuse/skills).

Browse the playbooks below, then [install the skill](#install) and ask your agent to do the work — instrument an app, query production traces, migrate prompts, or set up evals.
...
See the [skill landing page](/skills) for a visual tour of every playbook.
...
- [Skill landing page](/skills) — browse playbooks and preview `SKILL.md`

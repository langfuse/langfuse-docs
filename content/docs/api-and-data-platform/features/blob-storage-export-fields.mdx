...
description: Complete reference of all fields exported by the Langfuse blob storage integration, organized by export table (traces, observations, enriched observations, scores).

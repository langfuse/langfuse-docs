...
It supports all API endpoints: observations, prompts, datasets, scores, metrics, and more is available. See the full [API Reference](https://api.reference.langfuse.com) for details.
...
With machine-readable exit codes, agents without parsing stderr can understand errors quicker: usage (2), configuration (3), network (4), HTTP failure (5), and local errors (6) to iterate faster.

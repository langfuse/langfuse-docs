...
Schedule exports to Amazon S3, S3-compatible storage, Google Cloud Storage, or Azure Blob Storage every 20 minutes, hourly, daily, or weekly. To load exported Parquet files into ClickHouse Cloud, see [ClickHouse Data Warehouse](/integrations/clickhouse/data-warehouse).

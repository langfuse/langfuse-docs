...
{/* Backward-compatibility anchor for bookmarks from when this content was a standalone page. */}

<span id="blob-storage-export-field-reference" />

## Export field reference [#export-field-reference]

Field names and types for each exported file. Types match JSON and JSONL output. Timestamps use `YYYY-MM-DD HH:MM:SS.ffffff` in UTC. Each schema is collapsed on its own below—open the file you need.
...
<details>
<summary>**Enriched observations** — `observations_v2/`</summary>
...
<details>
<summary>**Legacy exports** — `traces/` and `observations/`</summary>
...
<details>
<summary>**Parquet differences**</summary>
...
For paths, filenames, and the manifest workflow, see [process exports](#consume-exports).

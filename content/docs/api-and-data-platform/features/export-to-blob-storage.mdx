...
You can create schedule exports to a Blob Storage, e.g. S3, GCS, or Azure Blob Storage, for `traces`, `observations`, enriched observations, and `scores`. This is also the recommended path to [export Langfuse data to ClickHouse](/docs/api-and-data-platform/features/export-to-warehouse).

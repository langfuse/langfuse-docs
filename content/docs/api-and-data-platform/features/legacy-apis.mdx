---
title: Legacy APIs
sidebarTitle: Legacy APIs
description: Reference for the legacy read APIs — traces, observations, sessions, scores, and metrics — for deployments that have not yet migrated to the v4 API.
---

...
description: Reference for Langfuse's legacy APIs — traces, observations, sessions, scores, metrics, and ingestion — for deployments that have not yet migrated to the v4 API.
---
...
This page documents Langfuse's legacy APIs and is frozen — it receives critical fixes only; new functionality ships in the v4 API. Migrating? See [Transitioning to the v4 API](/docs/api-migration).

</Callout>

<LegacyApiAvailability />

For authentication and base URLs, see the [Public API documentation](/docs/api-and-data-platform/features/public-api).

...
On self-hosted Langfuse v3, use the [v1 Observations API](/docs/api-and-data-platform/features/public-api) instead; see [Versions & Compatibility](/docs/compatibility#sdk-server).

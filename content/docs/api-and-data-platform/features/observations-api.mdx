...
**Migration:** If you are migrating from v1 to v2, see the [v2 migration notes](/changelog/2025-12-17-v2-metrics-and-observations-api#migration-notes) for a detailed guide on the breaking changes and how to update your integration.

...
Using the deprecated APIs (`GET /api/public/traces` or `GET /api/public/observations`)? See the [Deprecated APIs reference](/docs/api-and-data-platform/features/deprecated-apis). Migrating? See [Migration of deprecated APIs](/docs/deprecated-api-migration).

...
**Self-hosted:** The v2 Observations API requires [Langfuse v4](/docs/v4). Self-hosted v4 support is in progress — until it ships, use the older trace and observation read endpoints.

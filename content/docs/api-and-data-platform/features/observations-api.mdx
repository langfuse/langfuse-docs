...
Using the legacy APIs (`GET /api/public/traces` or `GET /api/public/observations`)? See the [Legacy APIs reference](/docs/api-and-data-platform/features/legacy-apis). Migrating to v4? See [Transitioning to the v4 API](/docs/api-migration).

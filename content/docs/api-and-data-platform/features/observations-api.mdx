...
On self-hosted Langfuse v3, use the [v1 Observations API](https://api.reference.langfuse.com/#tag/observations/GET/api/public/observations) instead; see [Versions & Compatibility](/docs/compatibility#sdk-server).

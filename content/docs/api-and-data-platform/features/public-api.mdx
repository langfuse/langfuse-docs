...
defaults: `api.observations`, `api.scores`, and `api.metrics`. The deprecated
v1 resources moved under `api.legacy.*` (Python: `*_v1`, JS/TS: `*V1`). See
...
The deprecated trace, observation, and metrics read APIs are documented in the [Deprecated APIs reference](/docs/api-and-data-platform/features/deprecated-apis); to migrate, see [Migration of deprecated APIs](/docs/deprecated-api-migration).

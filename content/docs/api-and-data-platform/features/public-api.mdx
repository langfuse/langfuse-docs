...
deprecated; see the [Scores API migration guide](/docs/api-and-data-platform/features/scores-api#upgrade-from-v2)). Deprecated v1
...
The deprecated trace, observation, score, and metrics read APIs are documented in the [Deprecated APIs reference](/docs/api-and-data-platform/features/deprecated-apis); to migrate, see [Migration of deprecated APIs](/docs/deprecated-api-migration) and the [Scores API migration guide](/docs/api-and-data-platform/features/scores-api#upgrade-from-v2).

...
<Callout type="info">
  ...
  legacy Ingestion API is deprecated and is removed on Langfuse Cloud at the v4
  cutover on November 16, 2026; on self-hosted v4 it is unavailable once you run
...
- (Deprecated as of Nov 16, 2026) [Ingestion API](https://api.reference.langfuse.com/#tag/ingestion/POST/api/public/ingestion) allows trace ingestion using an API.

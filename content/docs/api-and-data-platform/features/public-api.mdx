...
<Callout type="info">
  ...
  legacy Ingestion API is deprecated and is sunset on Langfuse Cloud at the v4
  cutover on <V4CutoverDate />; on self-hosted v4 it is unavailable once you run
...
- (Deprecated as of {V4_CUTOVER_DATE_SHORT}) [Ingestion API](https://api.reference.langfuse.com/#tag/ingestion/POST/api/public/ingestion) allows trace ingestion using an API.

...
- [Observations API v2](/docs/api-and-data-platform/features/observations-api#v2) - Retrieve observation data from Langfuse for custom workflows, evaluation pipelines, and analytics.
...
- [Observations API v2](/docs/api-and-data-platform/features/observations-api#v2) — retrieve row-level observations

...
<Callout type="info">
  ...
  cutover (date will follow); on self-hosted v4 it is unavailable once you run
...
- [Metrics API v2](/docs/metrics/features/metrics-api) - Retrieve aggregated analytics and metrics from your Langfuse data.

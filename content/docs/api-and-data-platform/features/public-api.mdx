...
Still using the older trace, observation, or metrics read APIs? They are documented in the [Legacy APIs reference](/docs/api-and-data-platform/features/legacy-apis). To move existing calls to the v4 endpoints, see [Transitioning to the v4 API](/docs/api-migration).

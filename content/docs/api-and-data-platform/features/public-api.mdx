...
<Callout type="info">
  ...
  legacy Ingestion API is deprecated and is removed on Langfuse Cloud on
  the v4 cutover date (to be announced); on self-hosted v4 it is unavailable once you run

...
The deprecated trace, observation, score, and metrics read APIs are documented, with migration steps, in [Migration of deprecated APIs](/faq/all/deprecated-api-migration); for score reads, see the [Scores API migration guide](/docs/api-and-data-platform/features/scores-api#upgrade-from-v2).

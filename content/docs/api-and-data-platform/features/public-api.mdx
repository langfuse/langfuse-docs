...
- [Observations API v2](/docs/api-and-data-platform/features/observations-api#v2) - Retrieve [observation](/docs/observability/data-model#observations-traces-and-sessions) data (spans, generations, events) from Langfuse for custom workflows, evaluation pipelines, and analytics.
...
- [Observations API v2](/docs/api-and-data-platform/features/observations-api#v2) — retrieve row-level [observations](/docs/observability/data-model#observations-traces-and-sessions)

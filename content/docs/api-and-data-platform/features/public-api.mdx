...
Observations API v2 and Metrics API v2 are available on all Langfuse Cloud
plans. On self-hosted deployments, they require [Langfuse v4](/docs/v4) —
self-hosted v4 support is in progress; until it ships, use the legacy v1
endpoints.

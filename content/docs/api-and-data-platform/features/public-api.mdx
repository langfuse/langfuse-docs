...
Still using the older trace, observation, or metrics read APIs? They are documented in the [Legacy v3 API reference](/docs/api-and-data-platform/features/legacy-v3-api). To move existing calls to the v4 endpoints, see [Transitioning to the v4 API](/docs/api-migration).

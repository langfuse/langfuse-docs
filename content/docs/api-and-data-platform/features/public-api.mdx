...
Still using the deprecated trace, observation, or metrics read APIs? They are documented in the [Deprecated APIs reference](/docs/api-and-data-platform/features/deprecated-apis). To migrate these calls, see [Migration of deprecated APIs](/docs/deprecated-api-migration).

...
they are less performant at scale. See [Upgrade to v2 data APIs](/docs/api-and-data-platform/features/migrate-to-v2-data-apis)
...
- To move existing trace, observation, or metrics read calls to v2, see [Upgrade to v2 data APIs](/docs/api-and-data-platform/features/migrate-to-v2-data-apis).

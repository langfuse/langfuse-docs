...
Still using the older trace, observation, or metrics read APIs via
`api.legacy.*`? The underlying endpoints are documented in the
[Deprecated APIs reference](/docs/api-and-data-platform/features/deprecated-apis).
Migrating? See [Migration of deprecated APIs](/docs/deprecated-api-migration).

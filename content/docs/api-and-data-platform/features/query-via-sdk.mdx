...
For row-level observation filters, field selection, and cursor pagination, see the [Observations API v2 documentation](/docs/api-and-data-platform/features/public-api#v2).
...
- To move existing trace or observation reads to v2, see [Observations API v2](/docs/api-and-data-platform/features/public-api#v2).

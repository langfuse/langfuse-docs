...
For the full query schema, supported dimensions, filters, and examples, see the [Metrics API v2 documentation](/docs/metrics/features/metrics-api).
...
- To move existing metrics queries to v2, see [Metrics API v2](/docs/metrics/features/metrics-api).

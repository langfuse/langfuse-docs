...
The legacy trace, observation, and metrics read APIs are deprecated for data
extraction workflows. See [Upgrade to v2 data APIs](/docs/api-and-data-platform/features/migrate-to-v2-data-apis)
...
- To migrate deprecated trace, observation, or metrics read calls, see [Upgrade to v2 data APIs](/docs/api-and-data-platform/features/migrate-to-v2-data-apis).

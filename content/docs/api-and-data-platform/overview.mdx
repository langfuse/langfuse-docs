...
| Generate a client or inspect the schema from the machine-readable spec                             | [OpenAPI spec](https://cloud.langfuse.com/generated/api/openapi.yml) (self-hosted: `/api/openapi.yaml`, interactive reference at `/api/docs`) |

...
| -------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| Query aggregate cost, usage, latency, volume, or score metrics | [Metrics API v2](/docs/metrics/features/metrics-api#v2) (Cloud-only)                         |
| Retrieve row-level spans, generations, or events               | [Observations API v2](/docs/api-and-data-platform/features/observations-api#v2) (Cloud-only) |

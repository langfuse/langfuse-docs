...
| Retrieve row-level [observations](/docs/observability/data-model#observations-traces-and-sessions) | [Observations API v2](/docs/api-and-data-platform/features/observations-api#v2)    |

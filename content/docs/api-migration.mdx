...
description: Per-endpoint mapping from the legacy REST API to the Langfuse v4 API, with parameter mappings, semantic differences, and before/after examples.
---

import LegacyApiAvailability from "@/components-mdx/legacy-api-availability.mdx";

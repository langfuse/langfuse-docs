...
| Capability                       | Langfuse Cloud v3                                 | Langfuse Cloud v4                                                                             |
| -------------------------------- | ------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Tracing (legacy batch ingestion) | Supported                                         | Removed at the v4 cutover on <V4CutoverDate />; trace ingestion then stops working            |
...
| Public API & querying (`api.*`) | Supported                                        | Supported until the v4 cutover on <V4CutoverDate />; then the deprecated read APIs are removed |
...
Python SDK v2 and JS/TS SDK v3 (and older) send traces via the legacy batch ingestion API, which is removed on Langfuse Cloud at the v4 cutover on <V4CutoverDate />. Upgrade to the GA SDK majors now; see the [SDK upgrade paths](/docs/observability/sdk/upgrade-path).

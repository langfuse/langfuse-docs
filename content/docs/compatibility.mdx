...
| v1 read APIs<br />`/api/public/...`                                                                     | <CompatBadge variant="full">Full</CompatBadge>                  | <CompatBadge variant="deprecated">Deprecated</CompatBadge>      |
...
Deprecated. Tracing keeps working, but on the v4 data model data appears with up to a 10-minute delay. Upgrade to [Python SDK v4](/docs/observability/sdk/upgrade-path/python-v3-to-v4) (≥ 4.7.0) for real-time data.

</CompatDetail>
<CompatDetail name="Python SDK v2">

Deprecated. Sends traces via the legacy batch ingestion API, which is removed at the v4 cutover (date will follow); trace ingestion then stops working. Score ingestion is unaffected. Upgrade via the [SDK upgrade paths](/docs/observability/sdk/upgrade-path).

</CompatDetail>
<CompatDetail name="JS/TS SDK v4">

Deprecated. Tracing keeps working, but on the v4 data model data appears with up to a 10-minute delay. Upgrade to [JS/TS SDK v5](/docs/observability/sdk/upgrade-path/js-v4-to-v5) (≥ 5.4.0) for real-time data.

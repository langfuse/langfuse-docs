...
| Public API & querying (`api.*`) | Use the [legacy APIs](/docs/api-and-data-platform/features/public-api#access-via-sdks) `api.legacy.observations_v1` / `api.legacy.metrics_v1` | Supported (v1 APIs are deprecated until Oct 31, 2026) |
...
| Public API & querying (`api.*`) | Use the [legacy APIs](/docs/api-and-data-platform/features/public-api#access-via-sdks) `api.legacy.observationsV1` / `api.legacy.metricsV1` | Supported (v1 APIs are deprecated until Oct 31, 2026) |

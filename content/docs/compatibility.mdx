...
<Details id="faq-cloud">
<Summary>I'm on Langfuse Cloud, which versions do I need to care about?</Summary>
...
<Details id="faq-new-sdk-old-server">
<Summary>I self-host Langfuse v3 and upgraded to Python SDK v4 / JS SDK v5, what works?</Summary>
...
<Details id="faq-delay">
<Summary>My data takes minutes to show up in the UI, why?</Summary>
...
<Details id="faq-cloud-cutover">
<Summary>When do old SDKs stop working on Langfuse Cloud?</Summary>
...
<Details id="faq-server-upgrade">
<Summary>Does upgrading my self-hosted server break my SDKs?</Summary>

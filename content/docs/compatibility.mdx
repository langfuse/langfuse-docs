...
<MatrixTable
  personas={[
    {
      id: "cloud-older-python",
      label: "Cloud · Python v2",
      sections: ["Python"],
      rows: [
    ...
    {
      id: "cloud-current-python",
      label: "Cloud · Python v3/v4",
      sections: ["Read APIs", "Evaluations", "Integrations & exports"],
      rows: ["Python SDK v4", "Python SDK v3"],
    },
    {
      id: "cloud-current-js",
      label: "Cloud · JS v4/v5",
      sections: ["Read APIs", "Evaluations", "Integrations & exports"],
      rows: ["JS/TS SDK v5", "JS/TS SDK v4"],
    },
    { id: "self-hosted", label: "Self-hosted" },
    {
      id: "api-otel",
      label: "API & OpenTelemetry",
      sections: [
...
Deprecated. Migrate to [observation-level evaluators](/faq/all/llm-as-a-judge-migration). Trace-level evaluators are not supported on the v4 data model; on Langfuse Cloud they keep running until **November 30, 2026**.
...
Python SDK v2 and JS/TS SDK v3 (and older) send traces via the legacy batch ingestion API, which is removed on Langfuse Cloud on **November 30, 2026**. Upgrade to the GA SDK majors before then; see the [SDK upgrade paths](/docs/observability/sdk/upgrade-path).

...
Prefer video? [**Watch the end-to-end walkthrough**](/watch-demo) of all Langfuse features.
...
_Interested in copying the eval setup of our sample project? Check out our [writeup on how we use Langfuse for the docs chatbot](/blog/2026-07-16-steal-our-eval-setup). The same monitors as TypeSafe Jev questions are in [Copy our Jev eval setup](/blog/2026-09-21-copy-our-jev-eval-setup)._

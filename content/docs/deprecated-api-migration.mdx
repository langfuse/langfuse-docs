---
title: Migration of deprecated APIs
sidebarTitle: Deprecated API migration
description: Per-endpoint mapping from Langfuse's deprecated REST endpoints to their supported replacements, with parameter mappings, semantic differences, and before/after examples.
---

# Migration of deprecated APIs

This page maps every deprecated Langfuse REST endpoint to its supported replacement — with parameter mappings, semantic differences, and before/after examples. Many of these changes follow from the [observations-first data model](/docs/v4): traces and observations are no longer separate entities, and reads are consolidated onto fewer, faster endpoints.
...
Still need the deprecated endpoints? They are documented in the [Deprecated APIs reference](/docs/api-and-data-platform/features/deprecated-apis).

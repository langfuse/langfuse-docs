...
For application testing, start with [Evaluate an existing application](/docs/evaluation/get-started/existing-application), then [compare experiments](/docs/evaluation/experiments/compare-experiments) and [add a CI gate](/docs/evaluation/experiments/experiments-ci-cd). These examples reuse application functions and graders in Python or TypeScript.

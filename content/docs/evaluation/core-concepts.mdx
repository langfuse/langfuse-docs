...
- [Score live production traces](/docs/evaluation/get-started) with an evaluator and a rule
...
Follow the [online evaluation get started](/docs/evaluation/get-started) to create an evaluator and attach a rule in the UI.

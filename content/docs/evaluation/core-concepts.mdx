...
This page digs into the different concepts of evaluations, and what's available in Langfuse. If you want the product picture first, see [Agent evals and experiments](/docs/evaluation).

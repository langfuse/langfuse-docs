...
| [Jev as a judge](/docs/evaluation/evaluation-methods/jev-as-a-judge)       | Ask TypeSafe's Jev System One model typed questions and get calibrated answers | Typed verdicts at volume (classification, rubric levels, yes/no flags) at low cost and latency |

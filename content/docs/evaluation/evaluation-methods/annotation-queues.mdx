...
For an end-to-end setup, from designing score configs to calibrating automated evaluators against reviewer labels, see [how to set up human annotation workflows for LLM outputs](/resources/engineering/human-annotation-workflows-llm-outputs).

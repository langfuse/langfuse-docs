...
Go to the Evaluators page and create a new evaluator. Choose Code evaluator, then select Python or TypeScript.

<Frame fullWidth>
  ![Placeholder for the new code evaluator flow screenshot](/images/docs/evaluation/screenshot-placeholder.svg)
</Frame>
...
<Frame fullWidth>
  ![Placeholder for the code evaluator and sample test-result screenshot](/images/docs/evaluation/screenshot-placeholder.svg)
</Frame>

### Save and run online

After saving, attach the evaluator to a [rule](/docs/evaluation/core-concepts#evaluators-and-rules) to run it on incoming observations. Configure the rule's filters and sampling rate.

<Frame fullWidth>
  ![Placeholder for the rule configuration screenshot](/images/docs/evaluation/screenshot-placeholder.svg)
</Frame>

### Use the evaluator elsewhere

Saved code evaluators can also evaluate selected historical observations through [batch evaluation](/docs/evaluation/core-concepts#batch-evaluation) or score runs in [prompt experiments](/docs/evaluation/experiments/experiments-via-ui).

...
<Frame fullWidth>
  ![Create a code evaluator in Langfuse](/images/docs/code-evaluators/creation-flow.gif)
</Frame>
...
For self-hosted deployments, configure the code evaluator dispatcher and execution worker in [Code-based evaluators](/self-hosting/configuration/code-based-evaluators).

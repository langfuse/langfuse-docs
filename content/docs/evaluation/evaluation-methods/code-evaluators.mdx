...
Code evaluators currently require [Langfuse Fast Preview](/docs/v4), which is available on Langfuse Cloud. OSS and self-hosted deployments will receive support as soon as Langfuse v4 is supported outside Langfuse Cloud.

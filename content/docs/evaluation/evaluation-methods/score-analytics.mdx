...
<Callout type="info">
[Text scores](/docs/evaluation/core-concepts#score-types) are not supported in Score Analytics because free-form text cannot be meaningfully aggregated or compared.
</Callout>

...
<ManualGuideList
  guides={[
    ...
    },
    {
      ...
      topic: "Per-field scores for structured extraction",
      lede: "Emit one boolean score per output field to evaluate document extraction and catch regressions that pooled accuracy hides.",
    },
    {

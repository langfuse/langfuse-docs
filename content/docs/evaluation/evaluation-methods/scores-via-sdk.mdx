...
If you want Langfuse to run deterministic Python or TypeScript logic for you, use [code-based evaluators](/docs/evaluation/evaluation-methods/code-based-evaluators). Use this page when your application, pipeline, or CI job computes scores and sends them to Langfuse via API or SDK.
...
- **External code execution**: run evaluation code in your own infrastructure, then attach the resulting scores to Langfuse. If you prefer to author the code in Langfuse, use [code-based evaluators](/docs/evaluation/evaluation-methods/code-based-evaluators).

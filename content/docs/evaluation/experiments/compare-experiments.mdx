...
Experiment runs can use Langfuse datasets  or local data. See [Evaluate an existing application](/docs/evaluation/get-started/existing-application) to create two comparable runs in Python or TypeScript, or explore the [example project](/docs/demo).

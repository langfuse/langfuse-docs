...
If you already have an eval suite in Promptfoo, our guide to [migrating a Promptfoo eval suite](/resources/engineering/migrate-from-promptfoo) maps its tests, assertions, and CI gate onto this workflow.

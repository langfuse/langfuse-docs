...
- Use [code-based evaluators](/docs/evaluation/evaluation-methods/code-based-evaluators) when you want to author deterministic Python or TypeScript checks in the Langfuse UI and reuse them across observations and experiments
...
These SDK evaluator functions run in your experiment process. If you want to write deterministic evaluator code in the Langfuse UI and have Langfuse execute it on experiment observations, use [code-based evaluators](/docs/evaluation/evaluation-methods/code-based-evaluators).
...
Alternatively, you can run evals in Langfuse. This is useful if you want to use [LLM-as-a-judge](/docs/evaluation/evaluation-methods/llm-as-a-judge) for semantic criteria or [code-based evaluators](/docs/evaluation/evaluation-methods/code-based-evaluators) for deterministic checks on experiment observations. We have recorded a [10 min walkthrough](/guides/videos/llm-as-a-judge-eval-on-dataset-experiments) on how LLM-as-a-judge works end-to-end.

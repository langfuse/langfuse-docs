...
After each Experiment run, you can check the aggregated score in the Experiments table and compare results side-by-side. See [Interpreting Experiment Results](/docs/evaluation/experiments/interpreting-experiment-results) for details on regression analysis and multi-candidate comparison.

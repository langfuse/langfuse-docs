...
Optionally, you can use [LLM-as-a-Judge Evaluators](/docs/evaluation/evaluation-methods/llm-as-a-judge) or [code-based evaluators](/docs/evaluation/evaluation-methods/code-based-evaluators) to automatically score the responses based on the expected outputs to further analyze the results on an aggregate level.
...
- Optionally use LLM-as-a-Judge or code-based evaluators to score the responses based on the expected outputs from the dataset
...
Create a dataset with the inputs and expected outputs you want to use for your prompt experiments. [How to create a dataset?](/docs/evaluation/experiments/datasets)
...
You can set up an [LLM-as-a-judge evaluator](/docs/evaluation/evaluation-methods/llm-as-a-judge) to score semantic criteria or a [code-based evaluator](/docs/evaluation/evaluation-methods/code-based-evaluators) for deterministic checks. Make sure to target experiments and filter for the dataset you want to use.

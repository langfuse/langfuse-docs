...
- **[Jev as a judge](/docs/evaluation/evaluation-methods/jev-as-a-judge) asks TypeSafe's Jev decision model typed questions.** Use this for labels, rubric levels, or yes/no flags that you want on every observation at low cost. Experimental; you need a TypeSafe connection first.

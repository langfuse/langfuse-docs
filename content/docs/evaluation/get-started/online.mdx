...
This guide walks you through scoring live production traces in Langfuse. If you want the product picture first, see [LLM evaluation and experiments](/docs/evaluation). If you don't yet know what to evaluate, start with [Choosing what to evaluate](/academy/evaluate/choosing-what-to-evaluate). For how evaluators, scores, and rules fit together, see [Core Concepts](/docs/evaluation/core-concepts).

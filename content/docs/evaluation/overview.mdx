...
| Automatically score live production traces          | [Evaluate Production Traffic](/docs/evaluation/get-started/online), [LLM-as-a-Judge](/docs/evaluation/evaluation-methods/llm-as-a-judge), [Scores via API/SDK](/docs/evaluation/evaluation-methods/scores-via-sdk) |

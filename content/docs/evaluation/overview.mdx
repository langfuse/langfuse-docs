...
- [Create a code evaluator](/docs/evaluation/evaluation-methods/code-evaluators) for deterministic checks like exact match, JSON validation, or custom business rules

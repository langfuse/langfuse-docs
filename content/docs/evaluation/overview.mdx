...
- [Create a code-based evaluator](/docs/evaluation/evaluation-methods/code-based-evaluators) for deterministic checks like exact match, JSON validation, or custom business rules

...
Start by [scoring live production traces](/docs/evaluation/get-started/online). That guide walks you through creating an evaluator and a rule in the UI, and notes how to do the same with your coding agent.

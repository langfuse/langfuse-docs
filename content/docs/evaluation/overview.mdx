...
| Check that an LLM judge agrees with human labels    | [Calibrate your LLM-as-a-judge](/guides/llm-as-a-judge-calibration-skill), [Score Analytics](/docs/evaluation/scores/score-analytics#human-vs-ai-annotation-agreement)                                                                      |

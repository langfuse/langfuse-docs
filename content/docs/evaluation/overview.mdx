...
Choose the evaluation workflow that matches what you want to test:

- [Score live production traces](/docs/evaluation/get-started/online) by creating an evaluator and a rule in the UI, or by using your coding agent.
- [Run an offline experiment](/docs/evaluation/get-started/offline) on a dataset to compare prompts or application changes before you ship.

If you want the conceptual map first, read [Core Concepts](/docs/evaluation/core-concepts). It explains how evaluators, scores, datasets, and experiments fit together.
...
| Automatically score live production traces          | [Get started with online evaluation](/docs/evaluation/get-started/online), [LLM-as-a-Judge](/docs/evaluation/evaluation-methods/llm-as-a-judge), [Scores via API/SDK](/docs/evaluation/evaluation-methods/scores-via-sdk) |

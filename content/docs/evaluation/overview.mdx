...
Start by [scoring live production traces](/docs/evaluation/get-started). That guide walks you through creating an evaluator and a rule in the UI, and notes how to do the same with your coding agent.
...
| Automatically score live production traces          | [Get started with online evaluation](/docs/evaluation/get-started), [LLM-as-a-Judge](/docs/evaluation/evaluation-methods/llm-as-a-judge), [Scores via API/SDK](/docs/evaluation/evaluation-methods/scores-via-sdk) |

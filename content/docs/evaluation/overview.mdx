...
Start with [Evaluate with Datasets](/docs/evaluation/get-started/offline): run your application on fixed test cases, reuse deterministic checks, [compare changes](/docs/evaluation/experiments/compare-experiments), and [block regressions in CI](/docs/evaluation/experiments/experiments-ci-cd).

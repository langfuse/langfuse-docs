...
- **Code-based evaluators**: Run [custom Python or TypeScript evaluators](/docs/evaluation/evaluation-methods/code-based-evaluators) in Langfuse for deterministic checks such as exact match, JSON validation, or custom business rules.

...
### Human vs AI Annotation Agreement [#human-vs-ai-annotation-agreement]
...
If agreement is low, [calibrate the judge prompt](/guides/llm-as-a-judge-calibration-skill) against labeled examples, then compare the scores again. Reviewers can add the human scores through [Annotation Queues](/docs/evaluation/evaluation-methods/annotation-queues).
...
- [Calibrate your LLM-as-a-judge](/guides/llm-as-a-judge-calibration-skill) against labeled examples before relying on its scores.

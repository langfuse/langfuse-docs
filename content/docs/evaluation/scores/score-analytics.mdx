...
Score Analytics complements Langfuse's [experiment SDK](/docs/evaluation) and [self-serve dashboards](/docs/metrics/features/custom-dashboards) by offering instant, zero-configuration score analysis:
...
For advanced analyses requiring custom metrics or complex comparisons, use the [experiment SDK](/docs/evaluation) for deeper investigation.
...
Ensure you have [score data](/docs/evaluation) in your Langfuse project from any evaluation method:

...
The Langfuse Assistant is an in-product assistant for exploring your Langfuse project data and taking actions in Langfuse with your approval. You can ask about traces, observations, sessions, and metrics, or ask it to create datasets, dashboards, and other resources. Longer jobs run in the background.

<Video src="https://static.langfuse.com/docs-videos/in-app-agent.mp4" />

## What you can do [#what-you-can-do]

<a id="what-you-can-ask" />

Ask the Assistant to analyze your data or take action in Langfuse.
...
- "Create a dataset from failed generations last week."
...
Longer jobs run in the background, independently of your browser. You can start another conversation while the first one is still working. You get a notification when a run finishes, fails, or needs your approval. For repeating work in one conversation, choose **Always approve** on a tool you are comfortable leaving unattended.

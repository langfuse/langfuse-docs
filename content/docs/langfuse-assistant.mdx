...
<Callout type="info">
  **Self-hosted:** the Assistant is in public beta from version `>=v4.25.0` and
  needs an instance-wide Langfuse AI model and a worker queue consumer. See
  [self-hosted setup](/self-hosting/configuration/langfuse-assistant).
</Callout>

...
## Upgrade from Metrics API v1 [#v1]
...
- Replace `view: "traces"` with `view: "observations"` and trace-level dimensions such as `traceName`, `userId`, `sessionId`, `traceRelease`, or `traceVersion`.

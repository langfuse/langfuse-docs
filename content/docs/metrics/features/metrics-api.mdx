...
**Availability:** The v2 Metrics API is available on Langfuse Cloud and on self-hosted deployments running [Langfuse v4](/docs/v4). On self-hosted Langfuse v3, use the v1 Metrics API instead. See [Versions & Compatibility](/docs/compatibility#sdk-server).

...
Using the deprecated APIs (`GET /api/public/metrics` or `GET /api/public/metrics/daily`)? See the [Deprecated APIs reference](/docs/api-and-data-platform/features/deprecated-apis). Migrating? See [Migration of deprecated APIs](/docs/deprecated-api-migration).

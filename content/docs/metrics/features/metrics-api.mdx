...
The deprecated `GET /api/public/metrics` and `GET /api/public/metrics/daily` endpoints are documented in the [Deprecated APIs reference](/docs/api-and-data-platform/features/deprecated-apis); to move off them, see [Migration of deprecated APIs](/docs/deprecated-api-migration).
...
On self-hosted Langfuse v3, use the [Metrics API v1](/docs/api-and-data-platform/features/deprecated-apis#metrics-v1) instead; see the [self-hosted compatibility matrix](/self-hosting/upgrade/versioning#sdk-server).

...
Using the legacy v3 API (`GET /api/public/metrics` or `GET /api/public/metrics/daily`)? See the [Legacy v3 API reference](/docs/api-and-data-platform/features/legacy-v3-api). Migrating to v4? See [Transitioning to the v4 API](/docs/api-migration).

...
This page digs into the underlying concepts of how Langfuse structures and captures your data. Understanding these will make debugging and working with traces easier. If you want the product picture first, see [LLM observability and tracing](/docs/observability).

...
For a worked debugging session on a supervisor-and-workers graph, see [how to trace and debug a multi-agent system built with LangGraph](/resources/engineering/langgraph-multi-agent-tracing-debugging).

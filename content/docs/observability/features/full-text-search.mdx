...
The [Observations API v2](/docs/api-and-data-platform/features/public-api#v2) supports a `matches` operator for token-based full-text search on `input`, `output`, and string `metadata` filters.

...
Masking gives you control over the [tracing](/docs/observability) data sent to Langfuse. Use masking functions to redact sensitive information before trace data leaves your application, for example to:

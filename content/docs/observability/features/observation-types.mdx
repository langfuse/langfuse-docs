...
Langfuse supports different observation types to provide more context to your observations and allow efficient filtering. (Langfuse calls spans observations; `span` is also a specific observation type.)

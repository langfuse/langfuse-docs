...
Langfuse supports different observation types to provide more context to your [observations](/docs/observability/data-model#observations-traces-and-sessions) and allow efficient filtering. (Langfuse calls spans observations; `span` is also a specific observation type.)

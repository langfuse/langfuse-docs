...
import TagsVsMetadata from "@/components-mdx/tags-vs-metadata.mdx";
...
Alternatively, when using OpenAI without an enclosing [observation](/docs/observability/data-model#observations-traces-and-sessions):

...
{/* TODO: screenshot of tags displayed as labels on a trace/observation in the Langfuse UI. Suggested: <Frame>![Tags on a trace in the Langfuse UI](/images/docs/tags-on-trace.png)</Frame> */}
{/* TODO: screenshot or screen recording of filtering traces/observations by tags. Suggested: <Video src="https://static.langfuse.com/docs-videos/tags-filtering.mp4" aspectRatio={16 / 9} title="Filter traces and observations by tags" /> */}

...
Open **Project Settings** > **Integrations** > **Web Callouts** and create a callout endpoint. You need Admin/Owner (`integrations:CRUD`) permissions to setup new callouts.
...
The request times out after 5 seconds. Calls will not be retried. Calls are rate limited, you can disable rate limiting on self-hosted deployments via env vars, see self-hosting.

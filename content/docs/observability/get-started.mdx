...
Use the [Langfuse Skill](https://github.com/langfuse/skills) in your editor’s agent mode to automatically instrument your application. It will choose the best option to instrument based on your specific application.
...
{<h2>See your trace in Langfuse</h2>}

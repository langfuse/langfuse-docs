...
Read more about [using Langfuse with an existing OpenTelemetry setup](/faq/all/existing-otel-setup).
...
If a trace is not sampled, none of its [observations](/docs/observability/data-model#observations-traces-and-sessions) or associated scores will be sent to Langfuse.

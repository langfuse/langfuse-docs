...
<Details id="authentication-issues">
...
<Details id="no-traces-appearing">
...
<Details id="incorrect-nesting-or-missing-observations">
<Summary>Incorrect nesting or missing observations</Summary>
...
- If using manual [observations](/docs/observability/data-model#observations-traces-and-sessions) (`langfuse.start_observation()`), always call `.end()`.
...
<Details id="langchainopenai-integration-issues">
<Summary>LangChain/OpenAI integration issues</Summary>
...
<Details id="media-not-appearing">
<Summary>Media not appearing</Summary>
...
<Details id="missing-traces-with-vercelotel">
<Summary>Missing traces with `@vercel/otel`</Summary>

...
<Callout type="info">
  A [snapshot of the v2 SDK documentation](https://python-sdk-v2.docs-snapshot.langfuse.com/docs/observability/sdk/python/decorators) remains available.
</Callout>
...
We will continue to support the v2 SDK for the foreseeable future with critical bug fixes and security patches. We will not be adding any new features to the v2 SDK. A [snapshot of the v2 SDK documentation](https://python-sdk-v2.docs-snapshot.langfuse.com/docs/observability/sdk/python/decorators) remains available.

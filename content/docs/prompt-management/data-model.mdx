...
This page discusses prompt management concepts and best practices. If you want the product picture first — why to decouple prompts from code, and how caching works — see [Prompt management](/docs/prompt-management).

...
You can use your favorite model by adding the API key for the model you want to use in the Langfuse project settings. Learn how to [set up an LLM connection](/docs/administration/llm-connection).

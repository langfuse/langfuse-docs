...
<summary>Vision and direction</summary>

Langfuse should become the open data and evaluation layer that helps humans, and
eventually agents, improve agents. We optimize for one product loop above all
...
The Q2 2026 focus is to make the existing foundation excellent and connect the
...
- Fix event-loop and public API reliability issues, improve queue reliability,
  and make SLOs actionable across core product areas.
...
- Improve the self-hosted and Helm chart experience, and explore hybrid or BYOC
...
- Close multimodal gaps so traces, playground, datasets, and evals feel like one
  consistent system.
- Make the playground more stateful and collaborative so teams can invest in
  reusable debugging and experimentation setups.

...
This approach aligns with how modern observability platforms like [Datadog](https://docs.datadoghq.com/tracing/trace_explorer/) and [Honeycomb](https://www.honeycomb.io/blog/structured-events-basis-observability) have evolved: a flat, filterable table of observations with rich attributes as the primary exploration surface, with trace waterfall views available as a drill-down for investigating individual requests.

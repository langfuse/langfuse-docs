...
- **OTEL:** Set the `x-langfuse-ingestion-version: 4` HTTP header on your span exporter and emit v4-ready observations. If you use custom ingestion, follow the [OTEL migration guide](/integrations/native/opentelemetry/migration-to-v4).
...
- **Direct OpenTelemetry ingestion:** follow the [custom ingestion migration guide](/integrations/native/opentelemetry/migration-to-v4) to set the v4 header, propagate context attributes, and move trace input/output to the root observation

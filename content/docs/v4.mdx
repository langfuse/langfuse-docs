...
<Callout type="info">
**Trace input and output no longer exist in v4.** The separate traces and observations tables are replaced by a single unified observations table. See the [guide on working with observations in v4](/faq/all/explore-observations-in-v4) for before/after workflows and saved view setup.
</Callout>

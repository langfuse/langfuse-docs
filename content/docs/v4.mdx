...
**Trace-level input/output is deprecated across the product.** Tables, LLM-as-a-judge evaluators, and exports now read input and output from the relevant observation, usually the root observation or LLM call.

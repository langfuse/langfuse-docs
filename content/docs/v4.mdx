...
The [Observations API v2](/docs/api-and-data-platform/features/public-api#observations-api) and [Metrics API v2](/docs/metrics/features/metrics-api#v2) deliver significant performance improvements through the new data model:
...
The new [Observations API v2](/docs/api-and-data-platform/features/public-api#observations-api) and [Metrics API v2](/docs/metrics/features/metrics-api#v2) are designed for faster querying and aggregations at scale.

...
- Organizations created before that date can switch the **Langfuse v4 preview** toggle (bottom-left in the UI) on and off until Langfuse Cloud becomes v4-only (date will follow).

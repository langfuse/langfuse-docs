...
On Langfuse Cloud, review your project's remaining migration actions in the app's sidebar panel after clicking the 'Action Required' button.
...
- Organizations created before that date can switch the **Langfuse v4 preview** toggle (bottom-left in the UI) on and off until Langfuse Cloud becomes v4-only on **November 16, 2026** (`2026-11-16`).
...
Please note that you must migrate your projects to v4 before the v4 cutover on **November 16, 2026** (`2026-11-16`).

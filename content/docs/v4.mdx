...
description: Langfuse v4 is live on Cloud and self-hosted, with an observations-first data model that makes tables, dashboards, APIs, and evaluations dramatically faster at scale.
---
...
Langfuse v4 is live on Langfuse Cloud and generally available for self-hosted deployments. It makes tables, dashboards, APIs, and evaluations dramatically faster at scale. Dashboard load times for large projects improve by at least 10x.

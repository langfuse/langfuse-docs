...
**Trace-level input/output is deprecated across the product.** Tables, LLM-as-a-judge evaluators, and exports now read input and output from the relevant observation, usually the root [observation](/docs/observability/data-model#observations-traces-and-sessions) or LLM call.
...
- The significantly faster [Observations API v2](/docs/api-and-data-platform/features/public-api#v2) and [Metrics API v2](/docs/metrics/features/metrics-api#v2)

...
On **November 30, 2026**, the v4 migration completes on Langfuse Cloud: legacy API endpoints and legacy trace ingestion are removed, and remaining legacy exports are switched to their replacements automatically. See the [Versions & Compatibility](/docs/compatibility) page for the full schedule.

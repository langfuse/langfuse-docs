...
The older trace read endpoints remain available on Langfuse Cloud (see the [Deprecated APIs reference](/docs/api-and-data-platform/features/deprecated-apis)), but are deprecated and particularly susceptible to 524 errors on large projects.

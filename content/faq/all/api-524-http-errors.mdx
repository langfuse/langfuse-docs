...
1. **Use v2 data APIs for extraction**: Follow the [Observations API v2 upgrade guidance](/docs/api-and-data-platform/features/public-api#observations-api) for row-level data and use [Metrics API v2](/docs/metrics/features/metrics-api#v2) for aggregates.
...
Follow the [Observations API v2 upgrade guidance](/docs/api-and-data-platform/features/public-api#observations-api) to move trace and observation extraction workflows to the v2 API. For aggregate reporting, use [Metrics API v2](/docs/metrics/features/metrics-api#v2).

...
| **[Legacy Metrics API](/docs/api-and-data-platform/features/legacy-v3-api#metrics-v1)**. Legacy `GET /api/public/metrics` endpoint. | 100&nbsp;req/day   | 2,000&nbsp;req/day | 2,000&nbsp;req/day  |

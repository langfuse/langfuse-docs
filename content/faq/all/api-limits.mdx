...
| **[Deprecated Metrics API](/docs/api-and-data-platform/features/deprecated-apis#metrics-v1)**. Deprecated `GET /api/public/metrics` endpoint. | 100&nbsp;req/day   | 2,000&nbsp;req/day | 2,000&nbsp;req/day  |

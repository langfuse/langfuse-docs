...
description: "The rate and size limits that apply to the Langfuse API, why they exist, and what to do when an integration runs into them."
...
| **General API**                                                            | All other public APIs, including [Observations API v2](/docs/api-and-data-platform/features/public-api#v2) (`GET /api/public/v2/observations`). | 30&nbsp;req/min    | 100&nbsp;req/min   | 1,000&nbsp;req/min  |

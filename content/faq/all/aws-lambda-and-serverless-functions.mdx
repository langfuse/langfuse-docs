...
seoTitle: "Langfuse Tracing in Serverless Functions"
description: "How to trace serverless functions with Langfuse on AWS Lambda, Vercel, and Cloudflare Workers, and why you must flush before the runtime freezes."
tags: [observability]
---

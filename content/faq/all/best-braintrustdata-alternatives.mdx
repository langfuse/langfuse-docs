...
<Callout type="info">
  This comparison is out of date? Please [raise a pull request](https://github.com/langfuse/langfuse-docs/tree/main/content/faq/all) with up-to-date information.
</Callout>
...
| **Frameworks** | **[100+ Frameworks](/integrations)**: with popular frameworks like LangChain, LlamaIndex, OpenAI, Anthropic, etc. | Maintains integrations via [OpenInference library](https://github.com/Arize-ai/openinference).                      |
...
| Feature             | Langfuse                                                                                                                  | Arize AX                                     |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| **API Access**      | [API first](/docs/api-and-data-platform/features/public-api) for all data (traces, evals, prompts) and platform features. | API available, to export to data warehouses. |
...
| Feature            | Langfuse                                                                                                                                                                  | Arize AX                                                                                                               |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| **Certifications** | **[SOC 2 Type II, ISO 27001](/security)**, GDPR, HIPAA aligned.                                                                                                           | [SOC 2 Type II, HIPAA, **PCI DSS 4.0**, CSA Star Level 1](https://arize.com/docs/ax/security-and-settings/compliance). |
...
- **[Agentic Visualization](https://arize.com/docs/ax/observe/tracing/sessions-and-users):** Specialized views for multi-agent conversation flows.
- **[Data Fabric](https://arize.com/docs/ax/security-and-settings/data-fabric):** Seamless integration with enterprise data lakes (Snowflake/BigQuery).

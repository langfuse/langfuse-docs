...
Learn how to set up [logging and tracing](/docs/observability) with Langfuse.
...
Explore how to [analyze](/docs/metrics) your chatbot metrics in Langfuse.
...
Learn more about [user behavior tracking](/docs/metrics).

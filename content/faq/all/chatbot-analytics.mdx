...
seoTitle: "Chatbot Analytics: Metrics and Tools"
...
- **LLM Observability and Evaluation Platforms** — Tools like [Langfuse](/), [LangSmith](https://smith.langchain.com/), and [Arize Phoenix](https://phoenix.arize.com/) trace, monitor, and evaluate LLM-powered chatbots, capturing every model call, retrieval step, and tool interaction and scoring them with LLM-as-a-judge, code evaluators, and human annotation.
...
- **Evaluation Frameworks** — Tools like [Ragas](https://docs.ragas.io/) and [Promptfoo](https://www.promptfoo.dev/) help assess response quality through automated evaluation pipelines. Langfuse integrates with [Ragas](/integrations/frameworks/ragas) to store and analyze its scores next to your traces.
...
For most teams, a platform like Langfuse that traces and evaluates the same production conversations covers the core, with additional tools added as specific analytics needs arise.

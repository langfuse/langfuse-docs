...
description: "Two ways to track LLM cost and token usage in Langfuse: usage reported by the model provider, and Langfuse's own model pricing definitions."
tags: [observability]
---

# How to track LLM Cost and Tokens in Langfuse

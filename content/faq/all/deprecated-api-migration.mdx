...
**Deprecated:** `GET /observations`, `GET /observations/{observationId}`. Langfuse Cloud serves this endpoint until **November 16, 2026**; migrate to v4 before this date.
...
**Deprecated:** `GET /traces`, `GET /traces/{traceId}`. Langfuse Cloud serves this endpoint until **November 16, 2026**; migrate to v4 before this date.
...
**Deprecated:** `GET /sessions`, `GET /sessions/{sessionId}`. Langfuse Cloud serves this endpoint until **November 16, 2026**; migrate to v4 before this date. On Langfuse v4, these will return `404`.
...
**Deprecated:** `GET /metrics` (v1) and `GET /metrics/daily`. Langfuse Cloud serves this endpoint until **November 16, 2026**; migrate to v4 before this date.
...
**Deprecated:** `GET /scores` (v1), `GET /scores/{scoreId}`, `GET /v2/scores`, `GET /v2/scores/{scoreId}`. Langfuse Cloud serves these endpoints until **November 16, 2026**; migrate to v4 before this date. On Langfuse v4, these will return `404`.
...
**Deprecated:** Langfuse Cloud serves these endpoints until **November 16, 2026**; migrate to v4 before this date.
...
**Deprecated:** `POST /ingestion` (batched event ingestion) and the older synchronous endpoints `POST /traces`, `POST /spans`, `POST /generations`, `POST /events`. Langfuse Cloud serves these endpoints until **November 16, 2026**; migrate to v4 before this date.
...
These endpoints are deprecated and receive security patches only, no other fixes or new functionality. Langfuse Cloud serves these endpoints until **November 16, 2026**; migrate to v4 before this date.
All paths are relative to `/api/public`.
...
Langfuse Cloud serves this endpoint until **November 16, 2026**; migrate to v4 before this date.

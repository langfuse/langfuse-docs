...
Trace-level input and output are deprecated as part of [Langfuse v4](/changelog/2026-08-13-langfuse-v4). In the observations-first data model, a trace ID groups related observations; the trace is no longer a separate record with its own input and output.

...
|---|---|---|
| One row per trace | Traces table | Filter to the most relevant span(s) per trace, save as a [saved view](/docs/observability/features/saved-views) |

...
- Direct OpenTelemetry ingestion: follow the [custom ingestion migration guide](/integrations/native/opentelemetry/migration-to-v4) to set the v4 header and audit attribute propagation, root input/output, and span immutability.
...
If this happens, upgrade to Python SDK v4.7.0+ or JS/TS SDK v5.4.0+, or follow the [custom ingestion migration guide](/integrations/native/opentelemetry/migration-to-v4) for your OTEL exporter.

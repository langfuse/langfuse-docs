---
title: How do I work with observations in Langfuse Fast Preview (Langfuse v4)?
sidebarTitle: Explore Observations in Langfuse Fast Preview
...
### Ingest with a compatible setup
...
- Direct OpenTelemetry ingestion: follow the [custom ingestion migration guide](/integrations/native/opentelemetry/migration-to-v4) to set the [v4 header](/integrations/native/opentelemetry#real-time-ingestion) and audit attribute propagation, root input/output, and span immutability.
...
If this happens, upgrade to Python SDK v4.7.0+ or JS/TS SDK v5.4.0+, or follow the [custom ingestion migration guide](/integrations/native/opentelemetry/migration-to-v4) for your OTEL exporter, including the [real-time ingestion header](/integrations/native/opentelemetry#real-time-ingestion).
...
Yes. For now, you can switch the Fast Preview experience off in the UI and return to the previous tracing experience.

...
|---|---|---|
| One row per trace | Traces table | Filter for root observations (observations with no parent), save as a [saved view](/changelog/2025-05-20-save-table-views) |
...
| Cost, latency, or errors by user, session, or observation name | Traces table with filters | [Self-serve dashboards](/docs/metrics) |

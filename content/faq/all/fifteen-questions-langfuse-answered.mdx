...
description: "Nineteen common questions about Langfuse answered: open-core licensing, hosting options, data handling, pricing, and how the platform is built."
...
**Yes, Langfuse comes with built-in, powerful [Prompt Management](/docs/prompt-management/get-started) capabilities.** Langfuse allows you to effectively manage and version your prompts.
...
Find out more about how to start using [Langfuse Prompt Management here](/docs/prompt-management/get-started).
...
- **Model-based evaluations**: [Automate evaluations of all incoming traces](/docs/evaluation/evaluation-methods/llm-as-a-judge). Use pre-built templates for common criteria like hallucinations, toxicity, relevance, correctness
...
- **Evaluation Libraries**: You can use Langfuse's Python SDK to run evaluations [using popular eval libraries](/docs/evaluation/evaluation-methods/llm-as-a-judge) such as:
  - OpenAI Evals
...
- [**Collecting user feedback**](/docs/observability/features/user-feedback)
- [**Manually labelling observations within the Langfuse UI**](/docs/evaluation/evaluation-methods/annotation-queues) (Human annotation, data labelling, manual evaluation)
...
**Yes, Langfuse can provide customers with a DPA.** You can review the current [DPA](/dpa) from our [Security Center](/security/gdpr).
...
**Yes, Langfuse is GDPR compliant.** You can use Langfuse in compliance with GDPR by using our EU Cloud Data Region and entering into a [DPA](/dpa), or by self-hosting Langfuse in your chosen environment.

You can find more information in our [Security Center](/security/gdpr).

## 11. Does Langfuse support HIPAA-regulated use?

**Yes, Langfuse offers a HIPAA-ready cloud region.** You will need to use our HIPAA Cloud Data Region, subscribe to an eligible plan and enter into a signed Business Associate Agreement (BAA).
...
The answer is yes, Langfuse is an open source alternative to Promptlayer. You can use Langfuse to [manage your prompts](/docs/prompt-management/get-started), [monitor your application](/docs/observability/overview), [track analytics](/docs/metrics/overview) and [run evaluations](/docs/evaluation/overview). Langfuse is an open source project while Prompt Layer is closed source.

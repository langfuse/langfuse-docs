...
Trace-level evaluators use Langfuse's old trace-centric data model and are deprecated as part of [Langfuse v4](/changelog/2026-08-13-langfuse-v4). Existing evaluators continue to run while you upgrade.

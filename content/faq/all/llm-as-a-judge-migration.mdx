...
| -------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`Observation` for every variable, all from one observation** | Target the same observation and translate the filters and variable mappings.                                                                                                           |
...
dataset run's root observation is the same observation that carries the run's input and
...
This example upgrades a trace-level evaluator that reads trace input and output to target the observation containing the same values.

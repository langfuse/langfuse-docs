...
Vapi sends data to Langfuse through the [Vapi integration](/integrations/no-code/vapi), which the Vapi team operates. Projects relying on this integration are currently opted into the Langfuse v3 experience because the integration does not yet ingest data on the [Langfuse v4](/changelog/2026-08-13-langfuse-v4) data model.

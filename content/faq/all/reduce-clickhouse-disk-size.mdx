...
seoTitle: "Reduce ClickHouse Disk Size When Self-Hosting"
description: "On self-hosted Langfuse, ClickHouse system log tables usually dominate disk usage. Two levers for reclaiming space, in order of recommendation."
tags: [self-hosting]
---

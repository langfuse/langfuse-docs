...
Use the [Experiments API](/docs/api-and-data-platform/features/public-api#experiments)
...
For full trace and observation details, use the [Observations API v2](/docs/api-and-data-platform/features/public-api#v2).
For score-centric queries across experiments, traces, or observations, use the
[Scores API v3](/docs/api-and-data-platform/features/public-api#v3).
...
- [Experiments API](/docs/api-and-data-platform/features/public-api#experiments)

...
See the [Scores Data Model](/docs/evaluation/evaluation-methods/data-model#scores) for details on score properties.
...
- [Scores Data Model](/docs/evaluation/evaluation-methods/data-model#scores)

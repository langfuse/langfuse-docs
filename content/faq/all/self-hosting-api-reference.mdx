...
seoTitle: "API Reference for Self-Hosted Langfuse"
description: "Open /api/docs on your Langfuse instance to browse and test the API reference generated from the OpenAPI spec bundled with your deployment."

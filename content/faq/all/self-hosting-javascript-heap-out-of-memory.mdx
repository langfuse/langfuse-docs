...
description: "Why self-hosted Langfuse containers hit JavaScript heap out of memory errors, and how to raise the Node.js heap limit to match the memory you allocated."
tags: [self-hosting]
---

...
seoTitle: "PostgreSQL Table Ownership Migration Failures"
description: "Fixing PostgreSQL permission errors during self-hosted Langfuse migrations when the database user running them changed and no longer owns the tables."
tags: [self-hosting]
---

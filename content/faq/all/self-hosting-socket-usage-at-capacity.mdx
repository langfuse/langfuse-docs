...
description: "Socket usage at capacity errors mean the Langfuse web container cannot open new connections. Scale out containers or raise the socket limit."
tags: [self-hosting]
---

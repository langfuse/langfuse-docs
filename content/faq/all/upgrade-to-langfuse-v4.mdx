...
# Upgrade to Langfuse v4 [#upgrade-to-langfuse-v4]
...
Langfuse Cloud becomes v4-only on **November 9, 2026**. Complete every action detected for your projects before this date. Follow the [v4 timeline](/docs/v4#timeline) for rollout updates.

If the sidebar still shows the **Langfuse v4 preview** toggle, enable it. Organization owners can then open [**Migration status**](https://cloud.langfuse.com/v4-migration) to review every project in their organizations. The page flags the specific SDK, evaluator, experiment, API, or export work required for each project.

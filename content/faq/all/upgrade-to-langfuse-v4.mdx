...
If the sidebar still shows the **Langfuse v4 preview** toggle, enable it. Then open **Action required** to view the project checklist. Each category shows **Up to date**, **Not detected**, or the number of affected items.

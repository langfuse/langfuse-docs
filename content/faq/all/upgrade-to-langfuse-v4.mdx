...
Langfuse v4 uses an observations-first data model. The [v4 overview](/changelog/2026-08-13-langfuse-v4) explains what changed. New managed projects already use v4 and need no migration.
...
- Organizations created before that date can switch the **Langfuse v4 preview** toggle (bottom-left in the UI) on and off until Langfuse Cloud becomes v4-only on November 16, 2026.

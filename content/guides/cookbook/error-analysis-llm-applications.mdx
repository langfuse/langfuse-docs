...
Please install the langfuse skill and langfuse CLI and guide me step by step through this guide: https://langfuse.com/guides/cookbook/error-analysis-llm-applications
```

---
title: Error Analysis for LLM Applications - A Step-by-Step Guide
...
# Error Analysis for LLM Applications: A Step-by-Step Guide

A hands-on walkthrough for understanding how your system fails before you build evaluators for it.
...
<details>
<summary>What to expect when you run this</summary>

The agent plans the work as a TODO list mapped to the five steps, then walks through each one with you — pulling traces, setting up score configs and annotation queues, prompting you for observations, and proposing failure clusters you can refine.
...
At the clustering step it groups your annotations into a candidate failure taxonomy with definitions and counts, mapped against any prior categories so you can see where the distribution is shifting.
...
This guide is self-contained — you can follow it end-to-end without prior reading. For background on why error analysis matters, see the [Langfuse blog post](https://langfuse.com/blog/2025-08-29-error-analysis-to-evaluate-llm-applications).
...
![Dad Tech Support chatbot interface showing saved device profile and chat input](/images/cookbook/error-analysis-llm-applications/dad_support_sample_app.png)
...
| **5. Decide what to do about each category** | Choose which to fix in the prompt, which need evaluators, and which to monitor |

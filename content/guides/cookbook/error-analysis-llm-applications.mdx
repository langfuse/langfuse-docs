...
Make sure you have [Claude Code](https://claude.ai/download) and the [Langfuse skill](https://langfuse.com/docs/api-and-data-platform/features/agent-skill) installed, then copy the prompt below and paste it into Claude Code:
...
For an introduction to the method, see the [Langfuse blog post](https://langfuse.com/blog/2025-08-29-error-analysis-to-evaluate-llm-applications).

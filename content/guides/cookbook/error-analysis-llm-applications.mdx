...
Target ~100 traces. The goal is coverage, not randomness: over-represent edges and anything already flagged as problematic. In the process of selecting traces there are certain signals worth looking for that qualify a trace to be part of the sampe.
...
In the second step your review each trace in your example in detail. Work through the annotation queue in Langfuse. For each trace:

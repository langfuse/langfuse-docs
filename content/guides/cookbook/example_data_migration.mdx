...
while True:
    ...
    for s in resp.data:
        ...
        # endpoint expects: exactly one of traceId / sessionId / datasetRunId,
        # and observationId additionally requires traceId.
        trace_id = observation_id = session_id = dataset_run_id = None

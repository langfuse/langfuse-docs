...
This notebook shows how to query the [Langfuse Metrics API v2](https://langfuse.com/docs/metrics/features/metrics-api) from Python to build custom analytics on observations and scores.
...
To explore the full query schema and supported fields, see the [Metrics API documentation](https://langfuse.com/docs/metrics/features/metrics-api) and the [API reference](https://api.reference.langfuse.com/#tag/metrics/GET/api/public/v2/metrics).

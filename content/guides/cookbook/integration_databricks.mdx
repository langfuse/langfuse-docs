...
Configure your **Langfuse** credentials and **Databricks** credentials as environment variables. Replace the dummy keys below with the real ones from your respective accounts.
 ...
 - `LANGFUSE_BASE_URL`: `https://cloud.langfuse.com` (EU), `https://us.cloud.langfuse.com` (US), `https://jp.cloud.langfuse.com` (Japan), or `https://hipaa.cloud.langfuse.com` (HIPAA).
...
os.environ.setdefault("LANGFUSE_PUBLIC_KEY", "pk-lf-...")  # your public key
os.environ.setdefault("LANGFUSE_SECRET_KEY", "sk-lf-...")  # your secret key
os.environ.setdefault("LANGFUSE_BASE_URL", "https://cloud.langfuse.com")  # Other regions: https://us.cloud.langfuse.com (US), https://jp.cloud.langfuse.com (Japan), https://hipaa.cloud.langfuse.com (HIPAA)

os.environ.setdefault("DATABRICKS_TOKEN", "dapi-...")  # Databricks personal access token
os.environ.setdefault("DATABRICKS_HOST", "https://dbc-XXXXX-XXXX.cloud.databricks.com")
```

...
title: LiteLLM (Proxy) + Langfuse OpenAI Integration (JS/TS)
...
```typescript
import { startActiveObservation, startObservation, propagateAttributes } from "npm:@langfuse/tracing";
import { observeOpenAI } from "npm:@langfuse/openai";

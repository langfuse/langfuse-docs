...
title: OpenAI Integration (JS/TS)
...
The trace is a core object in Langfuse, and you can add rich metadata to it. Refer to the JS/TS SDK documentation and the [reference](https://js.reference.langfuse.com/functions/_langfuse_openai.observeOpenAI.html) for comprehensive details.

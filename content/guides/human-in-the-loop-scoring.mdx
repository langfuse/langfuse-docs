...
response = langfuse.api.observations.get_many(
    ...
    from_start_time="2026-07-01T00:00:00Z",
    to_start_time="2026-07-16T00:00:00Z",
    limit=50,
)
...
const response = await langfuse.api.observations.getMany({
  filter,
  fields: "core,basic,io,trace_context",
  fromStartTime: "2026-07-01T00:00:00Z",
  toStartTime: "2026-07-16T00:00:00Z",
  limit: 50,
});
...
<Callout type="info">
  ...
  per trace, and group by `traceId` or fetch all observations for a given
  `traceId` when your reviewers need the full trace activity. See [Migration of

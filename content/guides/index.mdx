...
## All guides [#cookbooks]

Cookbooks and video guides, sorted by topic. The notebook sources (`ipynb`) live in the [`cookbook`](https://github.com/langfuse/langfuse-docs/tree/main/cookbook) directory of the repository.

import { CookbookIndex } from "@/components/CookbookIndex";

<CookbookIndex includeVideos />

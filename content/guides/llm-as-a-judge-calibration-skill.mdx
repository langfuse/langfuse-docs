...
___TODO: add a high-level diagram of the calibration setup here (dataset of ground-truth labels + judge prompt in Prompt Management → Langfuse experiment → comparison of judge output vs. expected output → calibration report).___

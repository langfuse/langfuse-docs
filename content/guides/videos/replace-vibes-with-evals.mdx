...
[Monitoring](/docs/metrics) does two jobs on top of that raw data: it tracks aggregate trends like cost, latency, and quality scores over time, and it surfaces the individual traces worth investigating right now.
...
- [Evaluation overview](/docs/evaluation) — all evaluation methods in Langfuse
...
- [Metrics and monitoring](/docs/metrics) — track cost, latency, and quality over time

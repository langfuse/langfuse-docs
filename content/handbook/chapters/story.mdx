...
description: "How Langfuse got here: a short history of the company and the product, from the first release to the platform it is today."
---
...
### Apr 2024: Launch Week 1 and _The AI Engineering Platform_
...
In our [first Launch Week](/blog/launch-week-1), we reintroduced Langfuse as the [AI Engineering Platform](/blog/2024-04-introducing-langfuse-2.0) and launched essential features to cover the workflow:
...
### Jan 2026: Langfuse joins ClickHouse

<Frame className="max-w-sm">
  ![Langfuse joins ClickHouse](/images/blog/acquisition/banner.jpg)
</Frame>

On January 16, ClickHouse [acquired Langfuse](/blog/joining-clickhouse). We did not plan to sell the company -- we actually had term sheets for a Series A and were looking forward to some days off over Christmas. What changed was realizing how much faster we can go together with ClickHouse while staying true to what makes Langfuse work: open source, self-hosting, and a product built for real production workloads.

Because Langfuse already ran on ClickHouse since v3, we had been collaborating closely for a long time: sharing feedback with the database team, co-hosting community meetups in Berlin, San Francisco, and Amsterdam, and introducing thousands of self-hosted teams to ClickHouse through the v2 to v3 upgrade path. Langfuse Cloud is a large ClickHouse Cloud customer; teams at ClickHouse use Langfuse to improve their agentic applications. In many ways we already operated like long-term partners, and this acquisition made that partnership permanent.

Nothing changed for users: Langfuse stays open source under its existing MIT license, self-hosting remains a first-class path, and Langfuse Cloud continues running as before. The whole team joined ClickHouse to keep building Langfuse, now with more resources behind performance, reliability, and enterprise readiness.

### Mar 2026: Simplifying Langfuse for Scale

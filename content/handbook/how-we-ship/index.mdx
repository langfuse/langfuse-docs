...
When in doubt, tag your lead (24h SLA on the Linear inbox). Keep one Linear project or issue for your current main task, and the [bug view](https://linear.app/langfuse/view/bugs-confirmedopen-97856f9f745c) or "My issues" for smaller work. Every ticket has a priority. See [How we use Linear](/handbook/how-we-ship/how-we-use-linear) for the company-wide working agreement.

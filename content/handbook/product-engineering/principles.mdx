---
title: Principles
description: "The principles that guide product engineering at Langfuse: how we decide what to build, how we ship it, and what we expect of each other."
---
...
- Follow the [Product Ops workflow](/handbook/product-engineering/how-we-work/product-ops) to
  ...
  - Move feedback from Slack/Pylon/… into Linear ASAP if we want to ship this, thereby we reduce noise in public channels and track execution of improvements

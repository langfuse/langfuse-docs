...
1. Confirm the customer is on a plan tier that includes SSO (Team plan and above on Cloud; included in self-hosted OSS — only SCIM / Org Management API are EE-gated). If not, route to sales — do not promise a discount.

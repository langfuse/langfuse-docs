...
3. For the BAA, route to the enterprise team to handle the signature flow.
...
For HIPAA usage you'll need to be on hipaa.cloud.langfuse.com (separate region from us./cloud.) and have a signed BAA. I'm looping in our enterprise team to handle the BAA, they'll send it on our paper.

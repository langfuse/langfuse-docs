---
title: Support
description: "How the Langfuse support team works: triage, ownership, response expectations, and escalation. To get help yourself, see the support overview."
---
...
This page documents how the Langfuse support team works. If you want to know how you can reach Langfuse support, please refer to the [support overview page](/support).
...
We use [Pylon](https://usepylon.com) to manage support across all channels. Please read [how to use Pylon](/handbook/support/using-pylon) for more details and best practices as using Pylon correctly will make you much more effective at Support.
...
In Pylon, we apply priorities as follows automatically:

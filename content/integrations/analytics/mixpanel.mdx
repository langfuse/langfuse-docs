...
[Mixpanel](https://mixpanel.com) is a popular choice for product analytics. While Langfuse offers [metrics](/docs/metrics) out of the box, many of our users have asked for a way to **integrate their LLM related metrics that they capture with Langfuse into their Mixpanel dashboards**.

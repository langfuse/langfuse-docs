...
> **What is Langfuse?** [Langfuse](https://langfuse.com/) is the open-source LLM engineering platform. It helps teams trace AI workflows, debug issues, evaluate quality, and monitor usage in production. Use [Langfuse Cloud](/cloud) (managed, free tier, nothing to run) or a [self-hosted](/self-hosting) instance; this integration works with both.

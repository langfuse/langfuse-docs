...
> **What is Langfuse?** [**Langfuse**](https://langfuse.com) is the open-source AI engineering platform. It helps teams collaboratively debug, analyze, and iterate on their LLM applications with features like tracing, prompt management, and evaluation. Use [Langfuse Cloud](/cloud) (managed, free tier, nothing to run) or a [self-hosted](/self-hosting) instance; this integration works with both.
...
<div className="p-6 mt-6 border bg-muted/30 rounded-lg overflow-auto max-h-[70vh]">
  <GitHubReadme url="https://raw.githubusercontent.com/naoufalelh/cursor-langfuse/refs/heads/main/README.md" />
</div>

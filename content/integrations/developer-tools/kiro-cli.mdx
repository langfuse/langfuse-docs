...
- Click a trace to see the full conversation breakdown with nested [observations](/docs/observability/data-model#observations-traces-and-sessions) and the completion score.

...
> **What is Langfuse?** [**Langfuse**](https://langfuse.com/) is an open-source AI engineering platform. It helps teams trace LLM applications, debug issues, evaluate quality, and monitor costs in production. Use [Langfuse Cloud](/cloud) (hosted by Langfuse, free tier, no infrastructure to run) or [self-host](/self-hosting) it.
...
Kiro triggers hook event
    ...
    → Creates observations and scores in Langfuse
...
- Click a trace to see the full conversation breakdown with nested [observations](/docs/observability/data-model#observations-traces-and-sessions) and scores

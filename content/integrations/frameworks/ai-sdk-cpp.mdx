...
> **What is Langfuse?** [Langfuse](/) is an open-source AI engineering platform that provides tracing, evaluation, prompt management, and metrics to debug and improve LLM applications. Use [Langfuse Cloud](/cloud) (hosted by Langfuse, free tier, no infrastructure to run) or [self-host](/self-hosting) it.

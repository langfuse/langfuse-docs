...
_Tip: the wrapper span also gives the trace a clean preview: the Input/Output shown at the trace level come from the root span, so the plain values set via `span.update(...)` are what you see at the top of the trace._
...
[Link to a public example trace in Langfuse](https://cloud.langfuse.com/project/cloramnkj0002jz088vzn1ja4/traces/b82a0bdc1994fc5d1c8576ca032543f7?timestamp=2025-08-28T07:32:30.303Z&display=details)

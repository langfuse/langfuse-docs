...
> **What is Langfuse?** [Langfuse](https://langfuse.com) is the open source AI engineering platform. It helps teams to collaboratively manage prompts, trace applications, debug problems, and evaluate their LLM system in production.

...
To check which tools the graph called across a golden dataset (duplicate side effects, forbidden tools, step budgets) and gate CI on it, see [Evaluate agent trajectories in experiments](/resources/engineering/agent-trajectory-evaluation).

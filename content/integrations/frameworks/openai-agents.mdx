...
- [Evaluate agent trajectories in experiments](/resources/engineering/agent-trajectory-evaluation): check tool calls for duplicate side effects, forbidden tools, and step budgets over a golden dataset, and gate CI on it.

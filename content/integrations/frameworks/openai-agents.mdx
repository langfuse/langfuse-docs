...
If you manage your prompt with [Langfuse Prompt Management](https://langfuse.com/docs/prompt-management), you can link the used prompt to the trace by setting up an OTel Span processor.

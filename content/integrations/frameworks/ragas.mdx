...
<Details id="ragas-ground-truth">
<Summary>Do Ragas evaluations in Langfuse require ground-truth answers?</Summary>
...
<Details id="ragas-scores-in-langfuse">
<Summary>How do Ragas scores show up in Langfuse?</Summary>
...
<Details id="ragas-local-datasets">
<Summary>Can I run Ragas metrics on a dataset that lives outside Langfuse?</Summary>
...
<Summary>Do I need Ragas to evaluate RAG pipelines in Langfuse?</Summary>

...
> **What is Langfuse?** [Langfuse](https://langfuse.com/) is an open-source observability platform for AI agents. It helps you monitor LLM calls, tool usage, cost, latency, and run automated evaluations. Use [Langfuse Cloud](/cloud) (managed, free tier, nothing to run) or a [self-hosted](/self-hosting) instance; this integration works with both.

...
title: Observability for Strands with Langfuse
sidebarTitle: Strands
logo: /images/integrations/strands_agents_icon.svg
logoAppearance: dark
description: Learn how to integrate Langfuse with Strands using OpenTelemetry for comprehensive tracing and debugging of your AI agents.
category: Integrations
---

# Integrate Langfuse with Strands
...
> **What is Strands?** [Strands](https://strandsagents.com) is an open-source SDK, built by AWS, for building and running production AI agents in Python and TypeScript. It is model-provider agnostic, with first-class support for Amazon Bedrock, Anthropic, OpenAI, Gemini, and more, and ships with out-of-the-box components for tools, MCP, memory and sessions, context management, multi-agent patterns, structured output, guardrails, and tracing.

> **What is Langfuse?** [Langfuse](https://langfuse.com) is an open-source AI engineering platform. It provides robust tracing, debugging, evaluation, and monitoring capabilities for AI agents and LLM applications. Langfuse integrates seamlessly with multiple tools and frameworks through native integrations, OpenTelemetry, and its SDKs. Use [Langfuse Cloud](https://langfuse.com/cloud) (hosted by Langfuse, free tier, no infrastructure to run) or [self-host](https://langfuse.com/self-hosting) it.

## Get Started

We'll guide you through a simple example of building a Strands agent and integrating it with Langfuse for observability.

<Steps>
### Step 1: Install Dependencies

<Callout type="info" emoji="ℹ️">
To enable OTEL exporting, install Strands with the otel extra: pip install 'strands-agents[otel]'

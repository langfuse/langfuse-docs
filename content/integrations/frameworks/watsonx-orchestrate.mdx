...
> **What is Langfuse?** [Langfuse](/) is a platform for monitoring, debugging, and analyzing your AI applications. It provides a set of tools and services to help you monitor, debug, and analyze your AI applications. Use [Langfuse Cloud](/cloud) (hosted by Langfuse, free tier, no infrastructure to run) or [self-host](/self-hosting) it.

...
> **What is Langfuse?** [Langfuse](/) is a platform for monitoring, debugging, and analyzing your AI applications. It provides a set of tools and services to help you monitor, debug, and analyze your AI applications. Use [Langfuse Cloud](/cloud) (managed, free tier, nothing to run) or a [self-hosted](/self-hosting) instance; this integration works with both.

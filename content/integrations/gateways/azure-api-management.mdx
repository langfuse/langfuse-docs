...
seoTitle: "Route OpenTelemetry via Azure API Management"
...
> **What is Langfuse?** [Langfuse](https://langfuse.com/) is an open-source LLM engineering platform that helps teams trace, debug, and evaluate their LLM applications. Langfuse is not a proxy: your requests never pass through Langfuse on the way to the model, so it adds no hop to the gateway path. Use [Langfuse Cloud](/cloud) (hosted by Langfuse, free tier, no infrastructure to run) or [self-host](/self-hosting) it.
...
<Details id="does-langfuse-have-a-native-azure-api-management-plugin-or-policy">
<Summary>Does Langfuse have a native Azure API Management plugin or policy?</Summary>
...
<Details id="why-route-telemetry-through-the-gateway-instead-of-exporting-directly">
<Summary>Why route telemetry through the gateway instead of exporting directly?</Summary>
...
<Details id="does-our-llm-traffic-pass-through-langfuse">
<Summary>Does our LLM traffic pass through Langfuse?</Summary>
...
<Details id="can-the-langfuse-playground-and-evaluations-call-models-through-our-gateway">
<Summary>Can the Langfuse Playground and evaluations call models through our gateway?</Summary>
...
<Details id="does-this-work-with-self-hosted-langfuse">
<Summary>Does this work with self-hosted Langfuse?</Summary>

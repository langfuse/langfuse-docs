...
<Callout type="info">
  Helicone has moved into maintenance mode following its [acquisition by Mintlify](https://www.helicone.ai/blog/joining-mintlify). If you're looking to migrate, see our [Helicone to Langfuse migration guide](/faq/all/migrate-from-helicone).
</Callout>

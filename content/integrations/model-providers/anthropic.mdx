...
1. **OpenTelemetry Instrumentation (recommended):** Use the [`opentelemetry-instrumentation-anthropic`](https://pypi.org/project/opentelemetry-instrumentation-anthropic/) package to wrap Anthropic SDK calls and send OpenTelemetry spans to Langfuse.
...
> **What is Langfuse?**\
> [Langfuse](https://langfuse.com) is an open source platform for LLM observability and monitoring. It helps you trace and monitor your AI applications by capturing metadata, prompt details, token usage, latency, and more. Use [Langfuse Cloud](https://langfuse.com/cloud) (managed, free tier, nothing to run) or a [self-hosted](https://langfuse.com/self-hosting) instance; the code below is the same for both.

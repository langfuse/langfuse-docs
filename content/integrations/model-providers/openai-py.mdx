...
[Langfuse Tracing](/docs/observability) groups multiple observations (can be any LLM or non-LLM call) into a single trace. This integration by default creates a single trace for each openai call.
...
<Callout type="info">
  New to Langfuse Tracing? Checkout this [introduction](/docs/observability) to the
  basic concepts.
</Callout>

...
- `sessionId` (via `langfuse.session.id`, `session.id`, or `gen_ai.conversation.id`)
...
Where a field lists multiple source attributes, they are resolved in the order shown and the first attribute present on the span wins.
...
| <a id="userId"></a>`userId`           | The unique identifier for the end-user.                                                                                                  | • `langfuse.user.id`: `string`<br/>• `user.id`: `string`<br/>• `langfuse.observation.metadata.langfuse_user_id`: `string`<br/>• `langfuse.trace.metadata.langfuse_user_id`: `string`<br/>• `ai.telemetry.metadata.userId`: `string` (Vercel AI SDK)                                                         |
| <a id="sessionId"></a>`sessionId`     | The unique identifier for the user session.                                                                                              | • `langfuse.session.id`: `string`<br/>• `session.id`: `string`<br/>• `gen_ai.conversation.id`: `string`<br/>• `langfuse.observation.metadata.langfuse_session_id`: `string`<br/>• `langfuse.trace.metadata.langfuse_session_id`: `string`<br/>• `ai.telemetry.metadata.sessionId`: `string` (Vercel AI SDK) |

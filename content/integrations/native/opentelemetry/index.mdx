...
<Callout type="warning">
  Langfuse accepts incomplete or non-standard OTLP spans instead of rejecting them. The request still succeeds; the span is rewritten.

...
<Callout type="info">
  ...
  [Migration of deprecated APIs](/docs/deprecated-api-migration#ingestion) for
  the endpoint mapping; the deprecated endpoint itself is documented in the
  [Deprecated APIs reference](/docs/api-and-data-platform/features/deprecated-apis#endpoints).
</Callout>
...
## Experiments: Ingesting Experiment Spans [#experiments-ingesting-experiment-spans]

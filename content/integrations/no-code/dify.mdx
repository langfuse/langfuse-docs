...
This integration streamlines the process of managing and versioning your prompts, contributing to more efficient development and iteration cycles. The [plugin and installation instructions](https://github.com/gao-ai-com/dify-plugin-langfuse) are available on GitHub.

...
> **What is Langfuse?** [Langfuse](https://langfuse.com) is an open-source AI engineering platform that helps teams trace, debug, and evaluate their LLM applications. Use [Langfuse Cloud](https://langfuse.com/cloud) (hosted by Langfuse, free tier, no infrastructure to run) or [self-host](https://langfuse.com/self-hosting) it.
...
[Example trace in Langfuse](https://cloud.langfuse.com/project/cmt9p6v7u0p67ad0gzqrbh7x3/traces/3863cbb5ddb81b7158e80f5ba1f58633)

...
All conversations in the chat are automatically traced and sent to Langfuse. You can view the traces in the [Traces section](/docs/observability) of the Langfuse platform.

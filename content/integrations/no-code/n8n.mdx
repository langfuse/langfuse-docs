...
Currently, there is no native n8n tracing integration. Please upvote the [related GitHub discussion](https://github.com/orgs/langfuse/discussions/4397) if you are interested in this.

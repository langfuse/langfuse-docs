...
> **What is Langfuse?** [Langfuse](https://langfuse.com) is the open-source AI engineering platform. It helps teams trace applications, debug issues, evaluate quality, and monitor costs in production. Use [Langfuse Cloud](/cloud) (hosted by Langfuse, free tier, no infrastructure to run) or [self-host](/self-hosting) it.

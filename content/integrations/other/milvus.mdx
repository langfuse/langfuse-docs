...
Thanks to the team at Milvus for developing this guide. These docs are adapted from their [write-up in the Milvus documentation](https://milvus.io/docs/integrate_with_langfuse.md).

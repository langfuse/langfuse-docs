...
- [**Alerts**](/docs/metrics/features/alerts): Send threshold breach and recovery notifications for your Langfuse alerts to Slack. Use this to surface latency, cost, score, or quality changes before they affect users.
...
- [Configure alert notifications](/docs/metrics/features/alerts) for warning, alert, recovery, and re-notification events.

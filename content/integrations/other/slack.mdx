...
<Frame>
  ![Slack integration card in Langfuse project settings](/images/docs/slack-integration-settings-card.png)
</Frame>
...
<Frame>
  ![Connect Slack workspace from Langfuse](/images/docs/slack-connect-workspace.png)
</Frame>

...
The [Agent Skill](/skills) follows the open [Agent Skills](https://github.com/anthropics/skills) standard and works across Claude Code, Cursor, Codex, Windsurf, and other compatible agents. It is open source on [GitHub](https://github.com/langfuse/skills).
...
<Cards>
  <Card title="Browse the skill landing page" href="/skills" />
...
- [Skill landing page](/skills) · [Agent Skill docs](/docs/api-and-data-platform/features/agent-skill) · [CLI docs](/docs/api-and-data-platform/features/cli) · [MCP server docs](/docs/api-and-data-platform/features/mcp-server) · [Langfuse Assistant docs](/docs/langfuse-assistant)

...
<BrandAssetGrid>
  ...
  />
  <BrandAssetCard
    src="/brand-assets/icon/monochrome/langfuse-icon-monochrome-white.svg"
    alt="Langfuse icon monochrome white SVG preview"
    label="Icon - Monochrome White (SVG)"
    variant="dark"
    tall
  />
</BrandAssetGrid>
...
<BrandAssetGrid>
  ...
  />
  <BrandAssetCard
    src="/brand-assets/wordmark/Langfuse/monochrome/langfuse-wordart-monochrome-white.svg"
    alt="Langfuse wordmark monochrome white SVG preview"
    label="Wordmark Monochrome White (SVG)"
    variant="dark"
  />
  <BrandAssetCard
...
<BrandAssetGrid>
  ...
  />
  <BrandAssetCard
    src="/brand-assets/wordmark/Langfuse%20by%20ClickHouse/monochrome/langfuse-by-clickhouse-monochrome-white.svg"
    alt="Langfuse by ClickHouse monochrome white SVG preview"
    label="By ClickHouse Monochrome White (SVG)"
    variant="dark"
  />
  <BrandAssetCard
...
<BrandAssetGrid>
  <BrandAssetCard
    src="/brand-assets/background/langfuse-brand-background.png"
    alt="Langfuse brand background preview"
    label="Langfuse brand background (PNG)"
    fill
  />
</BrandAssetGrid>

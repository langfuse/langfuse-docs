...
import { LANGFUSE_CAREERS_BOARD_URL } from "@/lib/ashby-jobs";
...
<div className="not-prose flex flex-col gap-4 mb-8 items-center text-center">
  ...
  <div className="mt-2 flex flex-wrap items-center justify-center gap-3">
    <Button href={LANGFUSE_CAREERS_BOARD_URL} target="_blank" rel="noopener">
      View Open Positions →
    </Button>
...
We operate out of San Francisco and Berlin, with team members spread across Europe. European roles are remote-first with 3-5 days every two months in Berlin (travel covered); SF and Berlin locals use the office when it's useful.
...
import { PolaroidGallery } from "@/components/careers";
...
>
  <Button asChild variant="default" size="sm">
    <a
      href={LANGFUSE_CAREERS_BOARD_URL}
      target="_blank"
      rel="noopener"
    >
      See open roles
...
<Cards num={2}>
  <Cards.Card
    href="https://www.youtube.com/watch?v=1UjJh9a9O1k"
    title="A Day in the Life of a Technical Support Engineer at Langfuse"
    arrow
    target="_blank"
  ...
  >
    <div className="relative aspect-video">
      <Image
        src="/images/careers/day-in-the-life-support-engineer.jpg"
        alt="A Day in the Life of a Technical Support Engineer at Langfuse"
        fill

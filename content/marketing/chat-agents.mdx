  ...
  <section className="grid border-b border-line-structure lg:grid-cols-[1.2fr_0.8fr]">
    <div className="min-w-0 border-b border-line-structure px-6 py-7 sm:px-10 sm:py-8 lg:border-b-0 lg:border-r">
      ...
      <div className="mt-6 flex flex-wrap gap-2">
        ...
        <a href="/docs/observability/get-started" className="border border-line-structure bg-surface-bg px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.06em] text-text-secondary transition-colors hover:border-line-cta hover:text-text-primary">Chat agent quickstart →</a>
      </div>
    </div>
      ...
      <div className="corner-box-corners relative w-full border border-line-structure bg-surface-bg shadow-sm">
        <div className="space-y-3 px-3 py-3 text-text-secondary">
          ...
          <div className="grid grid-cols-[18px_minmax(0,1fr)] items-start gap-x-2 gap-y-1">
            ...
            <p className="justify-self-end rounded-[2px] border border-line-structure border-l-2 border-l-surface-cta-primary bg-surface-2 px-2 py-2 text-[11px] leading-[1.45] text-text-primary">That&apos;s not what I asked. Last <em>week</em>.</p>

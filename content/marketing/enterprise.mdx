...
- **Langfuse Cloud** ([plans and pricing](/pricing)): fully managed, with data regions in the EU, US (including a HIPAA-ready US region), and Japan. Start pay-as-you-go on the public price list, or move to an annual committed-spend agreement: you purchase Langfuse Cloud Credits that draw down against list pricing and get volume discounts, procurement support, and upgraded support.
...
- Committed-spend agreements include upgraded support and procurement flexibility (vendor onboarding, security and legal reviews), with custom contract terms available for larger agreements.

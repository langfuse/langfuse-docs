...
<Frame>![랭퓨즈란 무엇인가요?](/images/docs/korean-example-trace.png)</Frame>
...
- **프레임워크 지원**: [LangChain](/integrations/frameworks/langchain), [BytePlus](/integrations/model-providers/byteplus), [LlamaIndex](/integrations/frameworks/llamaindex), [AWS Bedrock과](/integrations/model-providers/amazon-bedrock) 같은 인기 있는 LLM 프레임워크와 통합하세요.
...
[Langfuse Cloud를](https://langfuse.com/cloud) 방문하여 무료 계정을 만들거나 몇 분 안에 Langfuse를 [셀프 호스팅하세요](/pricing-self-host). 새 프로젝트를 생성하고 Langfuse API 키를 받아 데이터 수집을 시작하세요.
...
- **지원 옵션 개요:** 모든 지원 방법에 대한 자세한 내용은 [지원 페이지](/support)를 참고하세요.
- **기업 지원:** 관심이 있으시면 [영업팀에 문의해 주세요](/talk-to-us).

---
title: Press & Media
description: Official press page for Langfuse, part of ClickHouse — the open source AI engineering platform. Latest news, company information, media assets, and press contacts.
---
...
Langfuse is the open source AI engineering platform, now part of [ClickHouse](https://clickhouse.com). Teams use Langfuse to trace, evaluate, and improve LLM applications and AI agents in production. The platform provides:
...
- **April:** Langfuse 2.0 launch — "The AI Engineering Platform" with evaluations, datasets, and playground. Product Hunt Product of the Day again

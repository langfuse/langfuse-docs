...
seoTitle: "AI Agent Evaluation: Trajectory and Tool Calls"
...
For a complete recipe with the OpenAI Agents SDK and LangGraph, including checks for duplicate side effects, forbidden and required tools, step budgets, and tool errors, run over a golden dataset and gated in CI, see [Evaluate agent trajectories in experiments](/resources/engineering/agent-trajectory-evaluation).
...
<Details id="what-is-ai-agent-evaluation">
<Summary>What is AI agent evaluation?</Summary>
...
<Details id="agent-evaluation-metrics">
<Summary>What metrics should I use to evaluate an AI agent?</Summary>
...
<Details id="tool-call-evaluation">
<Summary>How do you evaluate agent tool calls?</Summary>
...
<Details id="evaluate-without-ground-truth">
<Summary>How do you evaluate an agent without ground truth?</Summary>
...
<Details id="trace-vs-observation-evals">
<Summary>What is the difference between trace-level and observation-level evaluation?</Summary>
...
<Details id="multi-turn-evaluation">
<Summary>How do you evaluate multi-turn conversations?</Summary>
...
<Details id="evaluate-rag-agent">
<Summary>How do I evaluate a RAG agent?</Summary>
...
<Details id="agent-evals-in-ci">
<Summary>Should agent evaluations run in CI?</Summary>

...
<Details id="establish-alignment">
<Summary>Can Langfuse establish whether an AI model is aligned?</Summary>
...
<Details id="external-evaluators">
<Summary>Can external safety evaluators send results to Langfuse?</Summary>

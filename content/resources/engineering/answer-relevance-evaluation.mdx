...
<Details id="relevance-vs-correctness">
<Summary>What is the difference between answer relevance and answer correctness?</Summary>
...
<Details id="no-ground-truth">
<Summary>Can you evaluate answer relevance without ground truth?</Summary>
...
<Details id="handling-refusals">
<Summary>How should refusals be scored in answer relevance evaluation?</Summary>
...
<Details id="ragas-answer-relevancy">
<Summary>Is answer relevance the same as Ragas answer relevancy?</Summary>

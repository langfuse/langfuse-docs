...
<Details id="when-did-langfuse-ship-code-evaluators">
<Summary>When did Langfuse ship code evaluators?</Summary>

Code evaluators shipped on May 28, 2026 and run on live observations. They are generally available.

</Details>

<Details id="is-langfuse-only-for-early-stage-llm-apps">
<Summary>Is Langfuse only for early-stage LLM apps?</Summary>
...
<Details id="is-langfuse-still-open-source-after-the-clickhouse-acquisition">
<Summary>Is Langfuse still open source after the ClickHouse acquisition?</Summary>
...
<Details id="can-i-export-datasets-from-langfuse">
<Summary>Can I export datasets from Langfuse?</Summary>

...
<Details id="can-code-evaluators-run-on-production-traces-or-only-in-experiments">
<Summary>Can code evaluators run on production traces or only in experiments?</Summary>
...
<Details id="can-one-evaluator-return-several-scores">
<Summary>Can one evaluator return several scores?</Summary>
...
<Details id="do-code-evaluator-runs-cost-anything">
<Summary>Do code evaluator runs cost anything?</Summary>
...
<Details id="how-do-i-debug-an-evaluator-that-is-not-producing-scores">
<Summary>How do I debug an evaluator that is not producing scores?</Summary>

...
For the product overview, including gateway vs hook paths, see [Track and optimize coding agent usage](/coding-agents).
...
<Details id="can-i-track-which-claude-code-skills-or-rules-are-used">
<Summary>Can I track which Claude Code skills or rules are used?</Summary>
...
<Details id="what-does-tracing-a-coding-agent-cost-in-langfuse-units">
<Summary>What does tracing a coding agent cost in Langfuse units?</Summary>
...
<Details id="can-developers-opt-out">
<Summary>Can developers opt out?</Summary>

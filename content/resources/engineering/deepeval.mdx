...
<Details id="can-deepeval-run-inside-a-langfuse-code-evaluator">
<Summary>Can DeepEval run inside a Langfuse code evaluator?</Summary>
...
<Details id="do-i-need-to-replace-deepeval-to-use-langfuse-evaluations">
<Summary>Do I need to replace DeepEval to use Langfuse evaluations?</Summary>
...
<Details id="how-do-deepeval-results-appear-in-langfuse">
<Summary>How do DeepEval results appear in Langfuse?</Summary>

...
<Details id="processed-outside-eu">
<Summary>Is Langfuse Cloud data processed outside the EU?</Summary>
...
<Details id="move-us-to-eu">
<Summary>Can I move an existing US project to the EU region?</Summary>
...
<Details id="is-langfuse-gdpr-compliant">
<Summary>Is Langfuse GDPR compliant?</Summary>
...
<Details id="delete-user-data">
<Summary>How do I delete one user's data from Langfuse?</Summary>
...
<Details id="keep-pii-out">
<Summary>How do I keep PII out of traces in the first place?</Summary>

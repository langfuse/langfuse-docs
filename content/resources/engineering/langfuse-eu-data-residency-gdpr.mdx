...
The full comparison is in [self-hosted vs. Cloud](/resources/engineering/self-hosted-vs-cloud). For an EU team, the EU region satisfies a residency requirement and self-hosting satisfies an isolation requirement.

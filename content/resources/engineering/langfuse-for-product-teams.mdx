...
model](/self-hosting/configuration/in-app-agent).
...
are available on self-hosted deployments with an [instance Langfuse AI model](/self-hosting/configuration/in-app-agent).

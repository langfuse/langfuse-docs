...
seoTitle: "Langfuse for Product Teams"
...
questions about your project data in plain language, directly in the Langfuse UI. You
...
Langfuse pages, and asks for explicit approval before any action that changes data. It is
available on Langfuse Cloud, and in public beta on self-hosted deployments with an [instance
Langfuse AI model](/self-hosting/configuration/langfuse-assistant).

On the traces and observations tables, an [Ask AI](/docs/observability/features/filter-search-bar#ask-ai)
button additionally builds filters from a plain-language description ("enterprise customers
in the membership-support queue") without knowing the field names. Like the Assistant, it is
off by default until an organization owner or admin
[enables it](/security/ai-features).
...
<Details id="non-technical-users">
<Summary>Can non-technical team members use Langfuse?</Summary>
...
<Details id="review-conversations">
<Summary>How do product managers review AI conversations in Langfuse?</Summary>
...
<Details id="score-without-code">
<Summary>Can I score LLM outputs without writing code?</Summary>
...
<Details id="analyze-user-questions">
<Summary>Can I analyze what users ask my AI product?</Summary>
...
<Details id="self-hosted">
<Summary>Does this work on self-hosted Langfuse?</Summary>

Mostly. Session review, annotation queues, manual scoring, user feedback, custom dashboards,
and score analytics are available on self-hosted deployments. The [Langfuse Assistant](/docs/langfuse-assistant)
and [Ask AI](/docs/observability/features/filter-search-bar#ask-ai) in the filter search bar
are available on self-hosted deployments with an [instance Langfuse AI model](/self-hosting/configuration/langfuse-assistant).

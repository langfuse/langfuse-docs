...
Langfuse pages, and asks for explicit approval before any action that changes data. The
Assistant is generally available on Langfuse Cloud and not available on self-hosted
deployments.

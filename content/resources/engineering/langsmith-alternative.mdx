...
Langfuse [Alerts](/docs/metrics/features/alerts) watch metrics over observations and scores (for example average cost per trace, p95 latency, or an evaluation score), support separate warning and alert thresholds plus no-data handling, and route notifications to Slack, webhooks, or GitHub Actions workflows. Alerts are available on Langfuse Cloud.
...
| Feature          | Langfuse Alerts                                                | LangSmith Alerts                                     |
| ---------------- | -------------------------------------------------------------- | ---------------------------------------------------- |
...
| **Adoption**       | Trusted by **21 of Fortune 50** and 129 of Fortune 500.                                                                    | Wide adoption among LangChain enterprise users.                                 |

...
| Prompt management       | [Yes](/docs/prompt-management) (framework-agnostic)                                                                         | Yes                                                            |
...
- **Datasets, prompts, and evaluators:** import datasets via [CSV, SDK, or API](/docs/evaluation/experiments/datasets) and recreate prompts and judges in [prompt management](/docs/prompt-management/get-started) and [evaluators](/docs/evaluation). A coding agent with the [agent skill](/docs/api-and-data-platform/features/agent-skill) can do this for you.

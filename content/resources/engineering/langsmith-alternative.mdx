...
**2. Data sovereignty.** An open-source ClickHouse data plane ([launched 2016](https://clickhouse.com/blog/yandex-opensources-click-house)) you can query, join, and hire for. Cloud and self-hosted share the same engine.
...
|                            | Langfuse                                                                                                                                    | LangSmith                                                                                              |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Data store                 | **ClickHouse**, [launched 2016 (OSS)](https://clickhouse.com/blog/yandex-opensources-click-house), Apache 2.0                               | **SmithDB**, [launched 2026](https://www.langchain.com/blog/introducing-smithdb), proprietary / closed |
...
**Sources:** [ClickHouse OSS launch (Jun 15, 2016)](https://clickhouse.com/blog/yandex-opensources-click-house) · [ClickHouse 10-year / 2,000+ contributors](https://clickhouse.com/blog/open-source-10) · [SmithDB announcement (May 13, 2026)](https://www.langchain.com/blog/introducing-smithdb)
...
- **Cloud stores traces in a closed engine launched in 2026.** [SmithDB](https://www.langchain.com/blog/introducing-smithdb) is proprietary ([May 13, 2026](https://www.langchain.com/blog/introducing-smithdb)). Langfuse Cloud and self-hosted stay on the same [ClickHouse](#storage) architecture, [open source since 2016](https://clickhouse.com/blog/yandex-opensources-click-house).
...
No. The LangSmith platform (backend, UI, storage, including [SmithDB](https://www.langchain.com/blog/introducing-smithdb), [launched 2026](https://www.langchain.com/blog/introducing-smithdb)) is closed source. LangChain, LangGraph, and the LangSmith client SDKs are MIT open source. Langfuse is MIT and [self-hostable](/self-hosting) on [ClickHouse](#storage), open source since 2016.

...
seoTitle: "What Is an LLM Gateway? When You Need One"
...
- Langfuse has step-by-step integration guides for
  ...
  [Azure API Management](/integrations/gateways/azure-api-management),
  [Anannas](/integrations/gateways/anannas), and
  [Eden AI](/integrations/gateways/edenai).
...
<Details id="is-langfuse-an-llm-gateway">
<Summary>Is Langfuse an LLM gateway?</Summary>
...
<Details id="does-an-llm-gateway-add-latency">
<Summary>Does an LLM gateway add latency?</Summary>
...
<Details id="do-i-need-a-gateway-to-get-llm-observability">
<Summary>Do I need a gateway to get LLM observability?</Summary>
...
<Details id="can-i-use-multiple-gateways">
<Summary>Can I use multiple gateways?</Summary>

...
<Details id="i-am-on-phoenix-not-ax-is-this-the-right-page">
<Summary>I am on Phoenix, not AX. Is this the right page?</Summary>

No. Use [Migrate from Arize Phoenix](/resources/engineering/migrate-from-phoenix).

</Details>

<Details id="can-i-evaluate-old-ax-traces-in-langfuse">
<Summary>Can I evaluate old AX traces in Langfuse?</Summary>

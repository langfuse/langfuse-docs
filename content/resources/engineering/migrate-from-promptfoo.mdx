...
<Details id="keep-both-tools">
<Summary>Can I keep running Promptfoo alongside Langfuse?</Summary>
...
<Details id="assertion-parity">
<Summary>Do Langfuse evaluators cover Promptfoo's assertion types?</Summary>
...
<Details id="ci-parity">
<Summary>Can Langfuse fail my CI pipeline the way `promptfoo eval` does?</Summary>
...
<Summary>How do non-engineers access results after migrating?</Summary>

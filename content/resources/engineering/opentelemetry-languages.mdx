...
<Details id="can-i-send-traces-from-multiple-languages-into-one-project">
<Summary>Can I send traces from multiple languages into one project?</Summary>
...
<Details id="why-does-grpc-not-work">
<Summary>Why does gRPC not work?</Summary>
...
<Details id="should-i-use-an-opentelemetry-collector-in-between">
<Summary>Should I use an OpenTelemetry Collector in between?</Summary>

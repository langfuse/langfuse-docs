...
Two rules determine how your OpenTelemetry spans render as Langfuse observations (Langfuse calls spans observations; `span` is also a specific observation type):

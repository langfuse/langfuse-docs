...
<Details id="should-i-mask-before-or-after-the-model-call">
<Summary>Should I mask before or after the model call?</Summary>
...
<Details id="does-masking-break-the-ability-to-debug-traces">
<Summary>Does masking break the ability to debug traces?</Summary>
...
<Details id="can-i-mask-data-that-third-party-frameworks-emit">
<Summary>Can I mask data that third-party frameworks emit?</Summary>
...
<Details id="is-prompt-level-instruction-do-not-repeat-personal-data-a-masking-strategy">
<Summary>Is prompt-level instruction ("do not repeat personal data") a masking strategy?</Summary>

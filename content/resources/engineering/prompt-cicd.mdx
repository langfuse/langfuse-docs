...
<Details id="faq-approval">
<Summary>Does Langfuse have a built-in approval workflow for prompt changes?</Summary>
...
<Details id="faq-traffic-split">
<Summary>How do I run a 90/10 traffic split between two prompt versions?</Summary>
...
<Details id="faq-promote-winner">
<Summary>How do I promote the winner after a canary or A/B test?</Summary>
...
<Details id="faq-trigger-ci">
<Summary>Can a prompt change trigger my CI pipeline automatically?</Summary>
...
<Details id="faq-rollback-speed">
<Summary>How fast does a prompt rollback take effect?</Summary>
...
<Details id="faq-git-vs-prompt-management">
<Summary>Should prompts live in Git or in a prompt management system?</Summary>

...
<Details id="organize-hundreds-of-prompts">
<Summary>How should we name and organize hundreds of prompts?</Summary>
...
<Details id="pm-edit-flow">
<Summary>What happens when a product manager edits a prompt in the UI?</Summary>
...
<Details id="restrict-production-deploys">
<Summary>Can we restrict who is allowed to deploy prompts to production?</Summary>
...
<Details id="move-prompts-between-projects">
<Summary>How do we move prompts between staging and production projects?</Summary>
...
<Details id="langfuse-unreachable">
<Summary>What happens to our application if Langfuse is unreachable?</Summary>

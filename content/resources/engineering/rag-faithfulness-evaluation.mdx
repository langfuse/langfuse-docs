...
<Details id="faithfulness-vs-hallucination">
<Summary>What is the difference between RAG faithfulness and hallucination detection?</Summary>
...
<Details id="reference-free-vs-ground-truth">
<Summary>Does faithfulness evaluation require ground-truth answers?</Summary>
...
<Details id="judge-model-choice">
<Summary>Which model should I use as the faithfulness judge?</Summary>
...
<Details id="binary-vs-graded">
<Summary>Should faithfulness be a binary or a graded score?</Summary>
...
<Details id="ragas-required">
<Summary>Do I need Ragas to evaluate faithfulness?</Summary>

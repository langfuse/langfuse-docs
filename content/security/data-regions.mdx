...
Alternatively, you can self-host Langfuse for full control over your data and infrastructure. For installation and configuration, see: [Self-hosting guide](/self-hosting). The [self-hosted vs. Cloud decision guide](/resources/engineering/self-hosted-vs-cloud) walks through when self-hosting is the right call, and [Langfuse for EU teams](/resources/engineering/langfuse-eu-data-residency-gdpr) covers data residency and GDPR in the EU region in detail.

...
- **Data importer:** Langfuse GmbH, Oranienburger Str. 91, 10178 Berlin, Germany; privacy@langfuse.com; legal@langfuse.com; role: Processor.
...
- **Table 1 (Parties):** Exporter \= the Client as identified in the Main Contract; Importer \= Langfuse GmbH, Oranienburger Str. 91, 10178 Berlin, Germany.

...
Langfuse (Langfuse GmbH) uses the following subprocessors to provide our services. See [data regions](/security/data-regions) for more information on our availability zones (EU, Japan, US, and HIPAA-compliant US).

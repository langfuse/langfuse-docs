...
### ClickHouse Cloud/BYOC (Managed Service)

**Automatic Backups**: ClickHouse Cloud/BYOC automatically manages backups for you with:
...
**No Action Required**: If you're using ClickHouse Cloud/BYOC, backups are handled automatically.

...
- Always include project and time filters where possible. Langfuse tracing data is optimized around project and time access patterns including monthly partioning.

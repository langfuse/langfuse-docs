...
For day-2 operations such as sizing, disk management, monitoring, backups, and troubleshooting, see the [ClickHouse operations playbook](/self-hosting/deployment/infrastructure/clickhouse-operations).
...
## Blob Storage as Disk [#blob-storage-as-disk]

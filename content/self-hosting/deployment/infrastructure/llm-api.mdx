...
The [Langfuse Assistant](/docs/langfuse-assistant) and [Ask AI](/docs/observability/features/filter-search-bar#ask-ai) do not use project LLM connections. Configure an instance-wide Langfuse AI model instead. See [self-hosted Assistant setup](/self-hosting/configuration/langfuse-assistant).

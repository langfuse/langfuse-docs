...
The [Langfuse Assistant](/docs/langfuse-assistant) does not use project LLM connections. Configure instance-wide Amazon Bedrock instead. See [self-hosted Assistant setup](/self-hosting/configuration/in-app-agent).

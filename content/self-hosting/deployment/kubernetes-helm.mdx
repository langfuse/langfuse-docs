...
If you would rather not run any infrastructure, [Langfuse Cloud](/cloud) is the fully managed version of Langfuse with a free tier. The SDKs and integrations work identically against Langfuse Cloud and a self-hosted instance.

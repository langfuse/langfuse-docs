...
Some add-on features require a [license key](/self-hosting/license-key). If you are still weighing self-hosting against Langfuse Cloud, the [self-hosted vs. Cloud decision guide](/resources/engineering/self-hosted-vs-cloud) lays out the trade-offs.

...
For BYOC-style deployments where a vendor-managed data layer runs inside your own cloud account, see [BYOC architecture and security](/resources/engineering/byoc).

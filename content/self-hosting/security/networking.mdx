...
See [Hostnames contacted by Langfuse](/self-hosting/security/telemetry#hostnames) for the full list of external hosts, for example to configure an egress firewall or proxy.

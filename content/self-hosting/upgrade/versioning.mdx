...
<CompatDetail name="Monitors and alerts">

GA. Requires Langfuse v4. Threshold-based alerts on your LLM application metrics with notifications via Slack, webhooks, and GitHub Actions; self-hosted deployments have no monitor limit. See the [monitors docs](/docs/metrics/features/monitors).

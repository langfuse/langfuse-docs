...
| Public API & querying (`api.*`) | Supported                                        | Unsupported (deprecated read APIs are removed on v4. Langfuse Cloud serves these endpoints until **November 16, 2026**; upgrade to JS/TS SDK v5) |

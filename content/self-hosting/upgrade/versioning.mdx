...
GA. Requires self-hosted server ≥ [3.63.0](https://github.com/langfuse/langfuse/releases/tag/v3.63.0); OSS v2 and older are unsupported. Server ≥ [3.125.0](https://github.com/langfuse/langfuse/releases/tag/v3.125.0) is recommended: it fixes usage and cost parsing for spans that arrive without SDK attribution, for example via an OpenTelemetry Collector.
...
Deprecated. Requires self-hosted server ≥ [3.63.0](https://github.com/langfuse/langfuse/releases/tag/v3.63.0); OSS v2 and older are unsupported. Server ≥ [3.125.0](https://github.com/langfuse/langfuse/releases/tag/v3.125.0) is recommended: it fixes usage and cost parsing for spans that arrive without SDK attribution, for example via an OpenTelemetry Collector.

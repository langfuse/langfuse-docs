...
| **Metrics & alerts** · [Alerts docs](/docs/metrics/features/alerts)                                     |                                                       |                                                                 |                                                                 |             |
| [Alerts](/docs/metrics/features/alerts)                                                                 | <CompatBadge variant="none">Unsupported</CompatBadge> | <CompatBadge variant="none">Unsupported</CompatBadge>           | <CompatBadge variant="full">Full</CompatBadge>                  | GA          |
...
| Public API & querying (`api.*`) | Use the [legacy APIs](/docs/api-and-data-platform/features/public-api#access-via-sdks) `api.legacy.observationsV1` / `api.legacy.metricsV1` | Supported (deprecated read APIs are removed on v4. Langfuse Cloud serves these endpoints until <V4CutoverDate />; migrate to v4 before this date.) |
...
| Public API & querying (`api.*`) | Supported                                        | Unsupported (deprecated read APIs are removed on v4. Langfuse Cloud serves these endpoints until <V4CutoverDate />; upgrade to JS/TS SDK v5) |
...
GA. Requires Langfuse v4. Threshold-based alerts on your LLM application metrics with notifications via Slack, webhooks, and GitHub Actions; self-hosted deployments have no alert limit. See the [alerts docs](/docs/metrics/features/alerts).

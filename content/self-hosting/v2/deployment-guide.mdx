...
| [OneLogin](https://next-auth.js.org/providers/onelogin)                                                                                                                          | `AUTH_ONELOGIN_CLIENT_ID`<br/>`AUTH_ONELOGIN_CLIENT_SECRET`<br/>`AUTH_ONELOGIN_ISSUER`<br/><br/>`AUTH_ONELOGIN_ALLOW_ACCOUNT_LINKING=true` (optional)                                                                                                                                                                                    | `/api/auth/callback/onelogin`          |
...
| Input/Outputs of LLM Calls, Traces, Spans | Work in progress, [contact sales](/talk-to-us) if you are interested in this |

/*
  ...
  endpoint, the page index, and the tools we want agents to use before writing
  Langfuse code. (The docs MCP server is deliberately not listed here — it is
  documented in llms.txt and on /docs/docs-mcp, and an agent already reading a
  page over MCP does not need to be told about it.)

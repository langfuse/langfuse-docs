...
const TERMS = [
  ...
  {
    term: "Chart Any Table",
    id: "chart-any-table",
    definition:
      "A Table | Chart toggle on the Observations table that plots the same filtered query as a configurable chart (type, metric, aggregation, breakdown). Charts can be added as widgets to a custom dashboard.",
    link: "/docs/observability/features/events-table-charts",
    categories: ["OBSERVABILITY"],
    relatedTerms: ["Custom Dashboards", "Pulse", "Filter Search Bar"],
  },
  {
    term: "Chat Prompt",
    id: "chat-prompt",
  ...
  },
  {
    ...
    categories: ["OBSERVABILITY"],
    relatedTerms: ["Score", "Token", "Pulse", "Chart Any Table"],
  },
  {
  ...
  },
  {
    ...
    link: "/docs/observability/features/observation-types",
    categories: ["OBSERVABILITY"],
    relatedTerms: ["Observation", "Generation", "Retriever", "Token"],
    synonyms: ["Observation Type"],
  },
  {
    term: "Environment",
  ...
  },
  {
    ...
    link: "/docs/observability/features/observation-types",
    categories: ["OBSERVABILITY"],
    relatedTerms: ["Observation", "Token", "Span"],
    synonyms: ["Observation Type"],
  },
  {
    term: "Guardrail",
  ...
  },
  {
    ...
    link: "/docs/observability/features/pulse",
    categories: ["OBSERVABILITY"],
    relatedTerms: ["Observation", "Custom Dashboards", "Chart Any Table"],
  },
  {
    term: "RBAC",
    id: "rbac",

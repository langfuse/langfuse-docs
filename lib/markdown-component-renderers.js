...
function replaceComponentsWithMarkdown(fileContent) {
  ...
  return stripResourceArrayExports(
    ...
    .replace(
      ...
      (fullMatch) =>
        `\n${
          fullMatch.includes("workflowAutomationInsights")
            ? renderWorkflowAutomationInsights()
            : renderChatAgentsInsights()
        }\n`,
    )
    .replace(
      ...
      (fullMatch) =>
        `\n${
          fullMatch.includes("workflowAutomationQuoteRoutes")
            ? renderWorkflowAutomationQuotes()
            : renderChatAgentsQuotes()
        }\n`,
    )
    .replace(
    ...
    .replace(
      ...
      (fullMatch) =>
        `\n${
          fullMatch.includes("workflowAutomationIntegrationGroups")
            ? renderWorkflowAutomationIntegrations()
            : renderChatAgentsIntegrations()
        }\n`,
    )
...
function renderChatAgentsQuotes() {
  return [
    "- [SumUp](/users/sumup)",
    "- [Canva](/users/canva)",
...
function renderChatAgentsIntegrations() {

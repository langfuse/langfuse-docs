...
function renderVersionTimeline(attributes) {
  ...
  const lines = [
    "- [Langfuse Cloud](/changelog/2026-08-13-langfuse-v4): v3 and the v4 preview run side by side until November 16, 2026. From November 16, Langfuse Cloud is v4-only and legacy APIs, features, and ingestion are removed.",
  ];

...
function renderProductFaq(attributes) {
  const match = attributes.match(/items=\{\s*([A-Za-z][A-Za-z0-9]*)\s*\}/);
  const items = match ? PRODUCT_FAQ_SETS[match[1]] : null;

...
function renderSentimentClassifierCompare() {
  return [
    ...
    "",
    "- Jev is a lot faster and cheaper than GPT-5.6 Luna with high reasoning. Add classifications with the 1–4 control: Jev keeps one request, Luna runs parallel calls that resolve independently so cost scales with the count. Latency and estimated cost are compared below the results.",

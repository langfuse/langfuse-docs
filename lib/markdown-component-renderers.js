...
function replaceComponentsWithMarkdown(fileContent) {
  ...
  return stripResourceArrayExports(
    ...
    .replace(
      /<SecurityBadgesGrid\s*\/>/g,
      () => `\n${renderSecurityBadgesGrid()}\n`,
    );
}
...
function renderSecurityBadgesGrid() {
  return "[ISO 27001](/security/iso27001) · [SOC 2](/security/soc2) · [GDPR](/security/gdpr) · [HIPAA](/security/hipaa)";
}

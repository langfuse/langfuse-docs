...
/**
 * Keeps the walkthrough video and its docs link available to Markdown/PDF
 * consumers; the component renders them as an iframe and a button otherwise.
 */
function renderWatchWalkthroughs() {
  return [

...
const nonPermanentRedirects = [
  ...
  // Redirect to overview pages (sections that still live at /overview)
  ...[
    "/docs/integrations",
    "/docs/datasets",
    "/docs/security",
  ...
  // Scores moved into Evaluation — hop straight to the product landing page
  // instead of /docs/scores → /docs/scores/overview → /docs/evaluation.
  ["/docs/scores", "/docs/evaluation"],

  // Product landing pages live at the section root. Keep the old /overview
  // URLs as one-hop redirects so existing links and search results resolve.
  // The .md twins are required too: agents and bookmarks hit /page.md, and
  // the HTML redirect does not cover that rewrite.
  ["/docs/observability/overview", "/docs/observability"],
  ["/docs/observability/overview.md", "/docs/observability.md"],
  ["/docs/prompt-management/overview", "/docs/prompt-management"],
  ["/docs/prompt-management/overview.md", "/docs/prompt-management.md"],
  ["/docs/evaluation/overview", "/docs/evaluation"],
  ["/docs/evaluation/overview.md", "/docs/evaluation.md"],
  ["/docs/metrics/overview", "/docs/metrics"],
  ["/docs/metrics/overview.md", "/docs/metrics.md"],
  ...
  ["/docs/scores/getting-started", "/docs/evaluation"],
  ...
  ["/docs/debugging-ui", "/docs/observability"],
...
const reorderTracingSection = [
  ["/docs/tracing/overview", "/docs/observability"],
  ["/docs/tracing-features", "/docs/observability"],
...
const mainDocsReorder202507 = [
  ...
  ["/docs/analytics/overview", "/docs/metrics"],
  ...
  ["/docs/scores/overview", "/docs/evaluation"],
  ...
  ["/docs/tracing", "/docs/observability"],
...
const removedPages202602 = [
  ...
  ["/blog/uptrain-integration", "/docs/evaluation"],
...
const agentGuessedPaths202609 = [
  ...
  // Educational FAQ folded into the agent observability landing FAQ.
  ["/faq/all/llm-observability", "/docs/observability#faq"],
  ["/faq/all/llm-observability.md", "/docs/observability.md#faq"],
...
const guidesCleanup202608 = [
  ...
  ["/guides/cookbook/evaluation_with_uptrain", "/docs/evaluation"],
  [

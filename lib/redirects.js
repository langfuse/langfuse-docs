...
const sdkReferenceRedirects202512 = [
  ...
  ["/docs/observability/sdk/python/instrumentation#propagate-attributes", "/docs/observability/sdk/instrumentation#add-attributes-to-observations"],
  ["/docs/observability/sdk/python/instrumentation#propagating-trace-attributes", "/docs/observability/sdk/instrumentation#add-attributes-to-observations"],
  ...
  ["/docs/observability/sdk/python/evaluation", "/docs/evaluation/evaluation-methods/custom-scores"],
  ["/docs/observability/sdk/python/evaluation#create-scores", "/docs/evaluation/evaluation-methods/custom-scores#ingesting-scores-via-apisdks"],
  ...
  ["/docs/observability/sdk/python/advanced-usage#filtering-by-instrumentation-scope", "/docs/observability/sdk/advanced-features#filter-exported-spans"],
  ["/docs/observability/sdk/python/advanced-usage#isolated-tracerprovider", "/docs/observability/sdk/advanced-features#tracer-provider-isolation"],
  ...
  ["/docs/observability/sdk/typescript/setup#tracing-setup", "/docs/observability/sdk/overview#initialize-opentelemetry-jsts"],
  ...
  ["/docs/observability/sdk/typescript/instrumentation#native-instrumentation", "/docs/observability/sdk/instrumentation#native-integrations"],
  ...
  ["/docs/observability/sdk/typescript/instrumentation#propagate-attributes", "/docs/observability/sdk/instrumentation#add-attributes-to-observations"],
  ["/docs/observability/sdk/typescript/instrumentation#framework-third-party-telemetry", "/docs/observability/sdk/instrumentation#native-integrations"],
  ...
  ["/docs/observability/sdk/typescript/advanced-usage#filtering-spans", "/docs/observability/sdk/advanced-features#filter-exported-spans"],
  ["/docs/observability/sdk/typescript/advanced-usage#sampling", "/docs/observability/sdk/advanced-features#sampling"],
  ["/docs/observability/sdk/typescript/advanced-usage#managing-trace-and-observation-ids", "/docs/observability/sdk/instrumentation#managing-trace-and-observation-ids"],
  ["/docs/observability/sdk/typescript/advanced-usage#isolated-tracer-provider", "/docs/observability/sdk/advanced-features#tracer-provider-isolation"],
  ["/docs/observability/sdk/typescript/advanced-usage#serverless-environments", "/docs/observability/sdk/advanced-features#serverless-environments"],
  ...
  ["/docs/sdk/typescript/guide", "/docs/observability/sdk/overview"],
  ["/docs/sdk/typescript/guide#score", "/docs/evaluation/evaluation-methods/custom-scores#ingesting-scores-via-apisdks"],
];

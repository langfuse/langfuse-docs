...
const nonPermanentRedirects = [
  ...
  // Observations, Scores, and Experiments API pages were merged into the
  // Public API page (LFE-16170). Fragments (#v2, #v3, ...) are preserved by the
  // browser and match anchors defined on the merged page.
  [
    "/docs/api-and-data-platform/features/observations-api",
    "/docs/api-and-data-platform/features/public-api#v2",
  ],
  [
    "/docs/api-and-data-platform/features/scores-api",
    "/docs/api-and-data-platform/features/public-api#v3",
  ],
  [
    "/docs/api-and-data-platform/features/experiments-api",
    "/docs/api-and-data-platform/features/public-api#experiments",
  ],
  [
    "/docs/admin-api",

...
const nonPermanentRedirects = [
  [
    "/docs/evaluation/get-started/existing-application",
    "/resources/engineering/evaluate-existing-application",
  ],
  [
    "/faq/all/evaluating-sessions-conversations",
    "/resources/engineering/evaluating-sessions-conversations",
  ],
  ...
  // 2023 webinar moved from /guides/videos to engineering resources
  [
    "/guides/videos/webinar-observability-llm-systems",
    "/resources/engineering/webinar-observability-llm-systems",
  ],
  [
    "/terms",
  ...
  [
    "/security/toms",
    "https://clickhouse.com/legal/agreements/security-addendum",
  ],
  ...
  ["/langfuse_icon.svg", "/langfuse-icon.svg"],
  ["/langfuse_icon.png", "/brand-assets/icon/color/langfuse-icon.png"],
  ["/icon256.png", "/brand-assets/icon/color/langfuse-icon.png"],

  // Japan page (consolidated /jp and /jp-cloud into /japan)
  ["/jp", "/japan"],
  ["/jp-cloud", "/japan"],
  ...
  ["/docs/api-migration", "/faq/all/deprecated-api-migration"],
  ["/docs/api-migration.md", "/faq/all/deprecated-api-migration.md"],
  ["/docs/deprecated-api-migration", "/faq/all/deprecated-api-migration"],
  ["/docs/deprecated-api-migration.md", "/faq/all/deprecated-api-migration.md"],
  [
    "/docs/api-and-data-platform/features/deprecated-apis",
    "/faq/all/deprecated-api-migration",
  ],
  [
...
const integrationsSection202507 = [
  ...
  ["/docs/integrations/other/inferable", "/integrations/frameworks/inferable"],
  ...
  [
    ...
    "/integrations/frameworks/langgraph",
  ],
  [
...
const mainDocsReorder202507 = [
  ...
  ["/docs/opentelemetry/example-arize", "/integrations/other/openinference"],
  ["/docs/opentelemetry/example-mlflow", "/integrations/other/mlflow"],
  ["/docs/opentelemetry/example-openlit", "/integrations/other/openlit"],
  [
  ...
  [
    "/docs/prompts/mcp-server",
    "/docs/prompt-management/features/agentic-access",
  ],
  ...
  ["/docs/sdk/python/sdk-v4", "/docs/observability/sdk/overview"],
  ["/docs/sdk/typescript/example-notebook", "/guides/cookbook/js_langfuse_sdk"],
...
const pythonv3sdkSection202508 = [
  ["/docs/observability/sdk/python/sdk-v3", "/docs/observability/sdk/overview"],
  [
...
const evaluationGetStartedFolder202609 = [
  ["/docs/evaluation/get-started", "/docs/evaluation/get-started/online"],
];
...
const handbookRestructure202510 = [
  ...
  [
    ...
    "/handbook/how-we-work/productivity-and-ai",
  ],
  [
  ...
  [
    ...
    "/handbook/support/using-pylon",
  ],
  ["/handbook/support/using-plain", "/handbook/support/using-pylon"],
  [
  ...
  [
    ...
    "/handbook/tools-and-processes/time-off",
  ],
  [
    "/docs/sdk/python/sdk-v3#multi-project-setup-experimental",
    "/docs/observability/sdk/advanced-features#multi-project-setup-experimental",
  ],
];
...
const launchWeek4202511 = [
  [
    "/changelog/2025-10-10-advanced-filtering-public-traces-api",
    "/changelog/2025-11-03-advanced-filtering-traces-and-observations-api",
  ],
  [
    "/changelog/2025-10-29-comment-mentions-and-reactions",
    "/changelog/2025-11-04-comment-mentions-and-reactions",
  ],
];
...
const productEngineeringRestructure202511 = [
  ...
  [
    "/handbook/engineering-super-day",
...
const evaluationMethodsRestructure202512 = [
  ...
  // Deleted data-model page - redirect to scores data model
  [
    "/docs/evaluation/evaluation-methods/data-model",
    "/docs/evaluation/scores/data-model",
  ],
  [
  ...
  [
    ...
    "/docs/evaluation/scores/score-analytics",
  ],
];
...
const sdkReferenceRedirects202512 = [
  ...
  [
    "/docs/observability/sdk/python/setup",
    "/docs/observability/sdk/overview#setup",
  ],
  [
    "/docs/observability/sdk/python/setup#initialize-client",
    "/docs/observability/sdk/overview#client-setup",
  ],
  [
  ...
  [
    ...
    "/docs/observability/sdk/instrumentation#custom",
  ],
  [
    "/docs/observability/sdk/python/instrumentation#propagate-attributes",
    "/docs/observability/sdk/instrumentation#add-attributes",
  ],
  [
  ...
  [
    "/docs/observability/sdk/python/evaluation#create-scores",
    "/docs/evaluation/evaluation-methods/scores-via-sdk#ingesting-scores-via-apisdks",
  ],
  [
    "/docs/observability/sdk/python/advanced-usage",
    "/docs/observability/sdk/advanced-features",
  ],
  [
    "/docs/observability/sdk/python/advanced-usage#masking-sensitive-data",
    "/docs/observability/sdk/advanced-features#mask-sensitive-data",
  ],
  [
    "/docs/observability/sdk/python/advanced-usage#logging",
    "/docs/observability/sdk/advanced-features#logging--debugging",
  ],
  [
    "/docs/observability/sdk/python/advanced-usage#sampling",
    "/docs/observability/sdk/advanced-features#sampling",
  ],
  [
    "/docs/observability/sdk/python/advanced-usage#filtering-by-instrumentation-scope",
    "/docs/observability/sdk/advanced-features#filtering-by-instrumentation-scope",
  ],
  [
    "/docs/observability/sdk/python/advanced-usage#isolated-tracerprovider",
    "/docs/observability/sdk/advanced-features#isolated-tracerprovider",
  ],
  [
    "/docs/observability/sdk/python/advanced-usage#multi-project-setup-experimental",
    "/docs/observability/sdk/advanced-features#multi-project-setup-experimental",
  ],
  [
    "/docs/observability/sdk/python/advanced-usage#using-threadpoolexecutors",
    "/docs/observability/sdk/advanced-features#thread-pools-and-multiprocessing-python",
  ],
  [
    "/docs/observability/sdk/python/advanced-usage#distributed-tracing",
    "/docs/observability/sdk/instrumentation#cross-service-propagation",
  ],
  [
  ...
  [
    "/docs/observability/sdk/typescript/setup",
    "/docs/observability/sdk/overview#setup",
  ],
  [
    "/docs/observability/sdk/typescript/setup#tracing-setup",
    "/docs/observability/sdk/overview#setup",
  ],
  [
    "/docs/observability/sdk/typescript/setup#client-setup",
    "/docs/observability/sdk/overview#client-setup",
  ],
  [
    "/docs/observability/sdk/typescript/instrumentation",
    "/docs/observability/sdk/instrumentation",
  ],
  [
    "/docs/observability/sdk/typescript/instrumentation#native-instrumentation",
    "/docs/observability/sdk/instrumentation",
  ],
  [
    "/docs/observability/sdk/typescript/instrumentation#custom-instrumentation",
    "/docs/observability/sdk/instrumentation#custom",
  ],
  [
    "/docs/observability/sdk/typescript/instrumentation#context-management-with-callbacks",
    "/docs/observability/sdk/instrumentation#context-manager",
  ],
  [
    "/docs/observability/sdk/typescript/instrumentation#observe-wrapper",
    "/docs/observability/sdk/instrumentation#observe-wrapper",
  ],
  [
    "/docs/observability/sdk/typescript/instrumentation#manual-observations",
  ...
  [
    "/docs/observability/sdk/typescript/instrumentation#framework-third-party-telemetry",
    "/docs/observability/sdk/instrumentation",
  ],
  [
  ...
  [
    "/docs/observability/sdk/typescript/advanced-usage#masking",
    "/docs/observability/sdk/advanced-features#mask-sensitive-data",
  ],
  [
    "/docs/observability/sdk/typescript/advanced-usage#filtering-spans",
    "/docs/observability/sdk/advanced-features#filtering-by-instrumentation-scope",
  ],
  [
    "/docs/observability/sdk/typescript/advanced-usage#sampling",
    "/docs/observability/sdk/advanced-features#sampling",
  ],
  [
    "/docs/observability/sdk/typescript/advanced-usage#managing-trace-and-observation-ids",
    "/docs/observability/sdk/instrumentation#trace-ids",
  ],
  [
    "/docs/observability/sdk/typescript/advanced-usage#isolated-tracer-provider",
    "/docs/observability/sdk/advanced-features#isolated-tracerprovider",
  ],
  [
    "/docs/observability/sdk/typescript/advanced-usage#serverless-environments",
    "/docs/observability/sdk/instrumentation#client-lifecycle--flushing",
  ],
  [
    "/docs/observability/sdk/typescript/advanced-usage#multi-project-setup",
    "/docs/observability/sdk/advanced-features#multi-project-setup-experimental",
  ],
  [
    "/docs/observability/sdk/typescript/upgrade-path",
    "/docs/observability/sdk/upgrade-path/js-v3-to-v4",
  ],
  [
    "/docs/observability/sdk/typescript/troubleshooting-and-faq",
    "/docs/observability/sdk/troubleshooting-and-faq",
  ],
  ...
  ["/docs/sdk/typescript/guide", "/docs/observability/sdk/overview"],
  [
    "/docs/sdk/typescript/guide#score",
    "/docs/evaluation/evaluation-methods/scores-via-sdk#ingesting-scores-via-apisdks",
  ],
];
...
// Blog post date fix - Apr 2026
const blogRedirects202604 = [
  [
    "/blog/2026-03-26-categorical-llm-as-a-judge-user-intent",
    "/blog/2026-04-14-categorical-llm-as-a-judge-user-intent",
  ],
];

// Broken links cleanup - February 2026
const brokenLinksCleanup202602 = [
  // Blog post renames / removals
  ["/blog/voice", "/blog/2025-01-22-evaluating-voice-ai-agents"],
  [
    "/blog/model-context-protocol",
    "/blog/2025-12-09-building-langfuse-mcp-server",
  ],
  ["/blog/langchain-integration", "/integrations/frameworks/langchain"],
  // Docs path changes
  ["/docs/data-export", "/docs/api-and-data-platform/overview"],
  [
    "/docs/integrations/llama-index/example-python-instrumentation-module",
    "/integrations/frameworks/llamaindex",
  ],
  [
    "/docs/sdk/typescript/example-vercel-ai",
    "/integrations/frameworks/vercel-ai-sdk",
  ],
  ["/guides/cookbook/python_sdk_low_level", "/docs/observability/sdk/overview"],
];

// Rename Customer Stories to User Stories - February 2026
const userStoriesRename202602 = [
  ["/customers", "/users"],
  ["/customers/canva", "/users/canva"],
  ["/customers/sumup", "/users/sumup"],
  ["/customers/khan-academy", "/users/khan-academy"],
  [
    "/customers/magic-patterns-ai-design-tools",
    "/users/magic-patterns-ai-design-tools",
  ],
  ["/customers/merckgroup", "/users/merckgroup"],
...
const removedPages202602 = [
  // Removed blog post: UpTrain is no longer maintained
  ["/blog/uptrain-integration", "/docs/evaluation/overview"],
  // Removed case study pages
  ["/faq/all/mava-langfuse-case-study", "/faq"],
  ["/faq/all/huntr-langfuse-case-study", "/faq"],
  ["/faq/all/ai-transparency-remberg-langfuse", "/faq"],
  ["/faq/tag/case-studies", "/faq"],
  // Weco is an integration page, not a cookbook guide (isGuide:false in
  // cookbook/_routes.json); the duplicate guide route was removed.
  ["/guides/cookbook/integration_weco", "/integrations/other/weco"],
];

// Move self-hosted telemetry into the self-hosting security section - March 2026
const selfHostedTelemetryMove202603 = [
  ["/faq/all/self-hosted-telemetry", "/self-hosting/security/telemetry"],
  ["/self-hosting/telemetry", "/self-hosting/security/telemetry"],
];

// Move v4 dashboard changes reference from docs/metrics into the v4 migration FAQ - May 2026
const v4DashboardChangesMove202605 = [
...
// Integration pages moved out of the "Other" catch-all into more specific buckets - September 2026
const integrationsOtherRefile202609 = [
  ["/integrations/other/hermes", "/integrations/no-code/hermes"],
  ["/integrations/other/hermes.md", "/integrations/no-code/hermes.md"],
  ["/integrations/other/inferable", "/integrations/frameworks/inferable"],
  ["/integrations/other/inferable.md", "/integrations/frameworks/inferable.md"],
  ["/integrations/other/mcp-use", "/integrations/frameworks/mcp-use"],
  ["/integrations/other/mcp-use.md", "/integrations/frameworks/mcp-use.md"],
  ["/integrations/other/openclaw", "/integrations/no-code/openclaw"],
  ["/integrations/other/openclaw.md", "/integrations/no-code/openclaw.md"],
  ["/integrations/other/zapier", "/integrations/no-code/zapier"],
  ["/integrations/other/zapier.md", "/integrations/no-code/zapier.md"],
];

// Developer-tool integrations moved from "Other" into the new "Developer Tools" section - June 2026
const integrationsDeveloperToolsMove202606 = [
  [
    "/integrations/other/augment-code",
    "/integrations/developer-tools/augment-code",
  ],
  [
    "/integrations/other/claude-code",
    "/integrations/developer-tools/claude-code",
  ],
  ["/integrations/other/codex", "/integrations/developer-tools/codex"],
  ["/integrations/other/cursor", "/integrations/developer-tools/cursor"],
  ["/integrations/other/kiro", "/integrations/developer-tools/kiro"],
  ["/integrations/other/kiro-cli", "/integrations/developer-tools/kiro-cli"],
];

// LibreChat integration moved from Other into ClickHouse Products - September 2026
const integrationsLibrechatMove202609 = [
  ["/integrations/other/librechat", "/integrations/clickhouse/librechat"],
  ["/integrations/other/librechat.md", "/integrations/clickhouse/librechat.md"],
];

// Agentic Data Stack page moved into ClickHouse Products - September 2026
const integrationsAgenticDataStackMove202606 = [
  [
    "/integrations/agentic-data-stack",
    "/integrations/clickhouse/agentic-data-stack",
  ],
  [
    "/integrations/agentic-data-stack.md",
    "/integrations/clickhouse/agentic-data-stack.md",
  ],
  [
  ...
  [
    "/integrations/other/agentic-data-stack.md",
    "/integrations/clickhouse/agentic-data-stack.md",
  ],
];
...
// Guessed /compare/<vendor> slugs that do not match the page filename
const compareShortAliases202609 = [
  ["/compare/arize", "/compare/arize-phoenix"],
  ["/compare/arize.md", "/compare/arize-phoenix.md"],
  ["/compare/phoenix", "/compare/arize-phoenix"],
  ["/compare/phoenix.md", "/compare/arize-phoenix.md"],
];
...
const promptMcpPageRemoval202607 = [
  [
...
// Markdown twins of legacy SDK paths that AI coding agents still request - September 2026
const legacySdkMarkdownPaths202609 = [
  [
    "/docs/observability/sdk/typescript/setup.md",
    "/docs/observability/sdk/overview.md",
  ],
  [
    "/docs/observability/sdk/python/instrumentation.md",
    "/docs/observability/sdk/instrumentation.md",
  ],
  [
    "/docs/observability/sdk/instrumentation/js/overview.md",
    "/docs/observability/sdk/instrumentation.md",
  ],
];
...
const brokenLinksCleanup202608 = [
  ...
  [
    "/self-hosting/deployment/examples/v4-installation",
    "/changelog/2026-08-17-langfuse-v4",
  ],
  [
    "/self-hosting/deployment/examples/v4-installation.md",
...
const guidesCleanup202608 = [
  // LangServe is discontinued (folded into LangChain)
  [
    "/guides/cookbook/integration_langserve",
    "/integrations/frameworks/langchain",
  ],
  ["/integrations/frameworks/langserve", "/integrations/frameworks/langchain"],
  // Companion cookbooks merged into their integration reference pages
  [
  ...
  [
    "/guides/cookbook/integration_azure_openai_langchain",
    "/integrations/frameworks/langchain",
  ],
  [
  ...
  // Dual-published integration cookbooks now live only at their /integrations URL
  [
  ...
  [
    ...
    "/integrations/model-providers/anthropic-js",
  ],
  // LangGraph cookbook promoted to the LangGraph integration page
  [
    "/guides/cookbook/integration_langgraph",
    "/integrations/frameworks/langgraph",
  ],
  // Duplicate/outdated LlamaIndex cookbooks consolidated into the integration page
  [
  ...
  [
    "/guides/cookbook/integration_llama-index_milvus-lite",
    "/integrations/other/milvus",
  ],
  [
    "/guides/cookbook/integration_llama_index_posthog_mistral",
    "/integrations/analytics/posthog",
  ],
  [
  ...
  // Removed evaluation cookbooks (UpTrain unmaintained, LangChain evals superseded)
  ["/guides/cookbook/evaluation_with_uptrain", "/docs/evaluation/overview"],
  [
    "/guides/cookbook/evaluation_with_langchain",
    "/guides/cookbook/example_external_evaluation_pipelines",
  ],
  // Removed decorator + OpenAI + Langchain interop demo
  [
    "/guides/cookbook/example_decorator_openai_langchain",
    "/docs/observability/sdk/instrumentation",
  ],
  // OTel instrumentation-library cookbooks moved to /integrations/other
  [
    "/guides/cookbook/otel_integration_arize",
    "/integrations/other/openinference",
  ],
  ["/guides/cookbook/otel_integration_mlflow", "/integrations/other/mlflow"],
  ["/guides/cookbook/otel_integration_openlit", "/integrations/other/openlit"],
  [
    "/guides/cookbook/otel_integration_openllmetry",
    "/integrations/other/openllmetry",
  ],
  // Ragas evaluation cookbook moved to engineering resources
  [
    "/guides/cookbook/evaluation_of_rag_with_ragas",
    "/resources/engineering/evaluation-of-rag-with-ragas",
  ],
  // Performance benchmarks moved to engineering resources
  [
    "/guides/cookbook/langfuse_sdk_performance_test",
    "/resources/engineering/langfuse-sdk-performance-test",
  ],
  [
    "/guides/cookbook/prompt_management_performance_benchmark",
    "/resources/engineering/prompt-management-performance-benchmark",
  ],
  // Outdated launch/announcement videos removed from /guides/videos
  ["/guides/videos/introducing-langfuse-2.0", "/guides/videos"],
  ["/guides/videos/introducing-datasets-v2", "/guides/videos"],
  // Video wrapper pages whose video is embedded on the canonical page
  [
    "/guides/videos/run-langfuse-locally",
    "/self-hosting/deployment/docker-compose",
  ],
  [
    "/guides/videos/external-evaluation-pipelines",
    "/guides/cookbook/example_external_evaluation_pipelines",
  ],
  [
    "/guides/videos/introducing-python-decorator",
    "/docs/observability/sdk/instrumentation",
  ],
  ["/guides/videos/posthog-integration", "/integrations/analytics/posthog"],
  [
    "/guides/videos/llm-playground",
    "/docs/prompt-management/features/playground",
  ],
  [
    "/guides/videos/llm-as-a-judge-eval-on-dataset-experiments",
    "/docs/evaluation/evaluation-methods/llm-as-a-judge",
  ],
];

// Monitors feature renamed to Alerts (2026-08)
const monitorsToAlertsRename202608 = [
  ["/docs/metrics/features/monitors", "/docs/observability/features/alerts"],
  [
    "/docs/metrics/features/monitors.md",
    "/docs/observability/features/alerts.md",
  ],
];

// Alerts docs moved from Metrics to Observability (2026-08)
const alertsMoveToObservability202608 = [
  ["/docs/metrics/features/alerts", "/docs/observability/features/alerts"],
  [
    "/docs/metrics/features/alerts.md",
    "/docs/observability/features/alerts.md",
  ],
];
...
// Destinations carry no fragment so inbound deep links (e.g. #scores,
// #parquet-exports) keep their anchor, which still resolves against the
// collapsible field reference on the merged export page.
const blobStorageFieldReferenceMerge202609 = [
  [
    "/docs/api-and-data-platform/features/blob-storage-export-fields",
    "/docs/api-and-data-platform/features/export-to-blob-storage",
  ],
  [
    "/docs/api-and-data-platform/features/blob-storage-export-fields.md",
    "/docs/api-and-data-platform/features/export-to-blob-storage.md",
  ],
];

// Destinations intentionally omit a fragment so the browser carries over any
// subsection fragment from the original deep link (e.g. #v2, #v3,
// #logical-root-observations), all of which are anchors on the Public API page.
// The `.md` twins need their own entries, or agent-facing Markdown URLs 404
// (extensionless redirect sources do not match `.md`).
const apiPagesMerge202609 = [
  [
    "/docs/api-and-data-platform/features/observations-api",
    "/docs/api-and-data-platform/features/public-api",
  ],
  [
    "/docs/api-and-data-platform/features/observations-api.md",
    "/docs/api-and-data-platform/features/public-api.md",
  ],
  [
    "/docs/api-and-data-platform/features/scores-api",
    "/docs/api-and-data-platform/features/public-api",
  ],
  [
    "/docs/api-and-data-platform/features/scores-api.md",
    "/docs/api-and-data-platform/features/public-api.md",
  ],
  [
    "/docs/api-and-data-platform/features/experiments-api",
    "/docs/api-and-data-platform/features/public-api",
  ],
  [
    "/docs/api-and-data-platform/features/experiments-api.md",
    "/docs/api-and-data-platform/features/public-api.md",
  ],
];
...
const permanentRedirects = [
  ...
  ["/users/adopters.md", "/users.md#adopters"],
  // Langfuse v4 launch announcement moved from the blog to the changelog (2026-08)
  ...
  // The v4 overview moved into the changelog entry. content/docs/v4.mdx is
  // kept but carries noindex:true so the redirected route stays out of the sitemap.
  ["/docs/v4", "/changelog/2026-08-17-langfuse-v4"],
  ["/docs/v4.md", "/changelog/2026-08-17-langfuse-v4.md"],
  ...
  [
    ...
    "/blog/2025-11-12-evals",
  ],
  [
    "/guides/videos/headless-langfuse-evaluations",
    "/guides/videos/headless-langfuse",
  ],

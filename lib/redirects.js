...
const nonPermanentRedirects = [
  ...
  // Observations, Scores, and Experiments API now live as sections of the
  // Public API page. Destinations intentionally omit a fragment so the browser
  // carries over any subsection fragment from the original deep link (e.g.
  // #v2, #v3, #logical-root-observations), all of which are anchors on the
  // Public API page. The `.md` twins need their own entries, or agent-facing
  // Markdown URLs 404 (extensionless redirect sources do not match `.md`).
  [

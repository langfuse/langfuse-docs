...
const sdkReferenceRedirects202512 = [
  ...
  ["/docs/observability/sdk/python/upgrade-path", "/docs/observability/sdk/upgrade-path/python-v2-to-v3"],
  ...
  ["/docs/observability/sdk/typescript/upgrade-path", "/docs/observability/sdk/upgrade-path/js-v3-to-v4"],
...
const brokenLinksCleanup202602 = [
  ...
  [
    "/guides/cookbook/python_sdk_low_level",
    "/docs/observability/sdk/overview",
  ]
];
...
const userStoriesRename202602 = [
  ...
  ["/customers/magic-patterns-ai-design-tools", "/users/magic-patterns-ai-design-tools"],

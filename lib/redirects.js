...
const brokenLinksCleanup202608 = [
  ...
  // Point directly at the final destination to avoid a redirect chain
  // (/docs/v4 is itself redirected to the v4 launch changelog entry).
  [
    "/self-hosting/deployment/examples/v4-installation",
    "/changelog/2026-08-13-langfuse-v4",
  ],
  [
...
const monitorsToAlertsRename202608 = [
  ["/docs/metrics/features/monitors", "/docs/metrics/features/alerts"],
];

// The /docs/v4 overview page is superseded by the v4 launch changelog entry (2026-08)
const v4OverviewToChangelog202608 = [
  ["/docs/v4", "/changelog/2026-08-13-langfuse-v4"],
  // Also redirect the .md variant so the markdown URL does not 404
  ["/docs/v4.md", "/changelog/2026-08-13-langfuse-v4.md"],
];

const permanentRedirects = [
  // Langfuse v4 launch announcement moved from the blog to the changelog (2026-08)
  ["/blog/2026-08-13-langfuse-v4", "/changelog/2026-08-13-langfuse-v4"],
  // Also redirect the .md variant so the markdown URL does not 404
  ["/blog/2026-08-13-langfuse-v4.md", "/changelog/2026-08-13-langfuse-v4.md"],

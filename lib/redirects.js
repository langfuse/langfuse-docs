...
const nonPermanentRedirects = [
  ...
  // Get Started redirects (moved to top-level section)
  ["/docs/observability/get-started", "/docs/get-started/trace-an-application"],
  ["/docs/prompt-management/get-started", "/docs/get-started/test-a-prompt"],

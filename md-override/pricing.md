...
<CloudPricingValue name="reviewed" />
...
- <CloudPricingValue name="hobbyUnits" /> units / month included
- <CloudPricingValue name="hobbyHistory" /> data access
- 2 users
- Community support via GitHub

Trusted by: <CompanyCount /> companies using Langfuse

[Sign up](/cloud)

### Core (<CloudPricingValue name="corePrice" />/month)

For production projects. Longer data access and unlimited users.

- Everything in Hobby
- <CloudPricingValue name="paidUnits" /> units / month included, additional: <CloudPricingValue name="startingRate" /> (lower with volume)
- <CloudPricingValue name="coreHistory" /> data access
- Unlimited users
- In-app support
...
### Pro (<CloudPricingValue name="proPrice" />/month)

For scaling projects. <CloudPricingValue name="proHistory" /> of history, high rate limits, all features.

- Everything in Core
- <CloudPricingValue name="paidUnits" /> units / month included, additional: <CloudPricingValue name="startingRate" /> (lower with volume)
- <CloudPricingValue name="proHistory" /> data access
...
Optional **Teams Add-on** (<CloudPricingValue name="teamsPrice" />/month):
...
### Enterprise (<CloudPricingValue name="enterprisePrice" />/month)
...
| [Included usage](/docs/administration/billable-units)                                               | <CloudPricingValue name="hobbyUnits" /> units | <CloudPricingValue name="paidUnits" /> units | <CloudPricingValue name="paidUnits" /> units | <CloudPricingValue name="paidUnits" /> units |
| [Additional usage](/docs/administration/billable-units)                                             | --                                            | <CloudPricingValue name="startingRate" />    | <CloudPricingValue name="startingRate" />    | <CloudPricingValue name="startingRate" />    |
...
| Access to historical data                                                                           | <CloudPricingValue name="hobbyHistory" />     | <CloudPricingValue name="coreHistory" />     | <CloudPricingValue name="proHistory" />      | <CloudPricingValue name="proHistory" />      |
...
Graduated pricing means you pay different rates for different volume tiers. See the graduated usage pricing table above for the included units and current rates. Use the pricing calculator on [langfuse.com/pricing](https://langfuse.com/pricing#pricing-calculator) to estimate your bill.

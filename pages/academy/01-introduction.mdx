...
![Overview of Langfuse within the LLMOps cycle, showing interactions between User, LLM Agent/Application, LLM, and Langfuse components (Evaluation, Prompt Management, Traces).](/images/academy/langfuse-llmops-cycle.png)

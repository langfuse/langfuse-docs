...
[Evaluations](https://langfuse.com/docs/scores) are the most important part of the LLM Application development workflow. Langfuse adapts to your needs and supports:

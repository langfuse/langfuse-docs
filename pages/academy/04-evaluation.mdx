...
| Content Taken from: [https://langfuse.com/blog/2025-03-04-llm-evaluation-101-best-practices-and-challenges](https://langfuse.com/blog/2025-03-04-llm-evaluation-101-best-practices-and-challenges) |
| :---- |
...
![Continuous Evaluation Loop](/images/academy/continuous-evaluation-loop.png)
...
![Example of a dataset in Langfuse][image12]
...
![Example of a live LLM-as-a-Judge Evaluator in Langfuse][image13]
...
![Example of user feedback in ChatGPT][image15]
...
![Example of a manual annotation workflow in Langfuse][image16]
...
![Example of different automated evaluation scores over time in Langfuse][image17]
...
| Content from: [https://langfuse.com/blog/2024-06-monitoring-llm-security](https://langfuse.com/blog/2024-06-monitoring-llm-security)  |
| :---- |
...
For more in-depth guidance on setting up your evaluation workflows with Langfuse, check out the [evaluation docs](https://langfuse.com/docs/scores/overview). It's packed with step-by-step instructions for capturing traces, running tests, and refining your pipeline.

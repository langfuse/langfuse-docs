...
For an end-to-end example on running Dataset experiments in Langfuse, check out [this cookbook](/docs/integrations/langchain/example-langgraph-agents#offline-evaluation).
</Callout>
...
<Callout type="info" emoji="📚">
Find out how to set up a live LLM-as-a-Judge Evaluator in Langfuse [here](/docs/scores/model-based-evals). 
</Callout>
...
<Tabs items={["Retrieval-Augmented Generation (RAG)", "Agent-Based LLM Applications", "Voice Agent Evaluation"]}>
...
<Callout type="info" emoji="🪢">
Run the [end-to-end cookbook](/docs/security/example-python) or check out our [documentation](/docs/security/overview).
</Callout>

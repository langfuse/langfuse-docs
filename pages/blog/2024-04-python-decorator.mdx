...
![Deeply-nested user trace](/images/blog/python-decorator/complex-trace.png)
...
3. For async-safety, the decorator leverages [Python Contextvars](https://docs.python.org/3/library/contextvars.html) for managing its state
...
In short, the decorator will work in async environments, but not in ThreadPoolExecutors or ProcessPoolExecutors.

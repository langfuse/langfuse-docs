...
Roadmap: The decorator is currently only available for Python. We are working on a similar implementation for JS/TS. The decorator currently does not support class methods.

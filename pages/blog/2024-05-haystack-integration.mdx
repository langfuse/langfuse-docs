...
[Langfuse tracing](/docs/observability/overview) can be helpful for Haystack pipelines in the following ways:
...
If you want to learn more about traces and what they can do in Langfuse, read our [documentation](/docs/observability/overview).

## Dive In

Head to the [Langfuse Docs](/integrations/frameworks/haystack) or see an example integration in this [end-to-end cookbook](/guides/cookbook/integration_haystack) to dive straight in.

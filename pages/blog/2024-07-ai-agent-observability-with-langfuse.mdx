...
When deploying LLMs, some edge cases will always slip through in initial testing. A proper observability set-up helps identify these cases, allowing you to add them to future test sets for more robust evaluations. With [Datasets](/docs/datasets/overview), Langfuse allows you to collect datasets of inputs and expected outputs to benchmark new releases before deployment. Datasets can be incrementally updated with new edge cases found in production and integrated with existing CI/CD pipelines.
...
If you want to get started with building your AI Agents and monitoring them with Langfuse, check out our [end-to-end example](/docs/integrations/langchain/example-python-langgraph) of building a simple agent with LangGraph and monitoring it with Langfuse.

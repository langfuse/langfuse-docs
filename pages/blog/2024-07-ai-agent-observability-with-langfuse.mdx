...
For a comprehensive guide on setting up this integration, please refer to our [Trace the OpenAI Agents SDK with Langfuse](./cookbook/integration_openai-agents.ipynb) notebook.
...
For a comprehensive, step-by-step guide, see our integration notebook: [Observability for smolagents with Langfuse](/cookbook/integration_smolagents.ipynb).

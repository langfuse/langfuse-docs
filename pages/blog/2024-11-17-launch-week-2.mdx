...
Langfuse now offers LLM-as-a-judge evaluators for offline evaluation. This powerful feature helps teams transform AI development uncertainty into structured engineering processes. Set up automated evaluations with custom prompts and scoring criteria, then automatically evaluate your experiment runs to identify improvements or regressions. Perfect for teams wanting to test changes and build conviction using test datasets before pushing to production.

See the [changelog](/changelog/2024-11-19-llm-as-a-judge-for-datasets) for more details.

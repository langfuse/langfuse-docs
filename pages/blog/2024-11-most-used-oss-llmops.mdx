...
<Steps>
  ### Large community: 
  Langfuse has numerous actively maintained **integrations** with the latest LLM frameworks (such as [Langchain](/docs/integrations/langchain/tracing),
  ...
  [GitHub](https://github.com/orgs/langfuse/discussions). 

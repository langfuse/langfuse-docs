...
In this blog post, we'll explore how you can create more robust and reliable voice applications. We'll draw insights from setups we have seen from our users at [Langfuse](/) and the recent discussion between me and Brooke (Co-Founder of [Coval](https://www.coval.dev/)) to provide a comprehensive guide on Voice AI evaluation.
...
We are excited that [Coval](https://www.coval.dev/) will natively integrate with Langfuse. With this integration, Langfuse users can use Coval to perform end-to-end simulation testing on the whole conversation of their voice agents.
</Callout>
## Resources

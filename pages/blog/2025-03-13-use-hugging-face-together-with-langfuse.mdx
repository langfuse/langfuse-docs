...
Hugging face offers a great variety of dataset that can be used to evaluate LLMs and AI agents. These datasets can be used to run Langfuse Dataset Experiments. The following Python example shows how you can load a dataset and create Langfuse dataset items:

...
You can also use Hugging Face models in the [Langfuse Playground](/docs/playground) and for [LLM-as-a-Judge evaluators](/docs/playground/llm-as-a-judge). This lets you test your prompts and use open source models for model-based evaluations.
...
Hugging Face offers a variety of datasets that can be used to evaluate LLMs and AI agents. These datasets can be used to run [Langfuse Dataset Experiments](/docs/dataset-experiments). The following Python example shows how you can load a dataset and create Langfuse dataset items:
...
For more details on how to use Langfuse Dataset Experiments, check out the [docs](/docs/dataset-experiments).

...
### 📐 &nbsp;&nbsp;&nbsp;Day&nbsp;6: Langfuse Evaluation Library

Making LLM evaluation easier, more powerful, and production-ready is now possible with the new Langfuse Evaluator Library. Whether fine-tuning prototypes or monitoring deployed agents, this library supports LLM-as-a-Judge evaluations across diverse metrics. 

It ships with **RAGAS evaluators** (context relevance, goal accuracy, SQL semantic equivalence, and more), Langfuse-managed evaluators, and the ability to build custom ones. Stay ahead with evaluators **updated from the latest research**, enjoy broad metric coverage, and experience a smoother UX for setting up and running evaluations.

We'd love to hear your feedback as you explore the new Evaluator Library.

👉 **Read the full changelog → [Langfuse Evaluation Library](/changelog/2025-05-24-langfuse-evaluation-library)**

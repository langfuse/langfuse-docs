...
date: 2025/06/04
description: "Open Sourcing all Product Features in Langufse under the MIT license"
tag: announcement
...
<BlogHeader
  ...
  image="/images/blog/2025-06-04-open-sourcing-langfuse-product/langfuse-open-source-og.png"
  date="June 4, 2025"
/>

_![][image1]_

## **All Langfuse Product Features are now OSS**
...
Newly open sourced features include managed [LLM-as-a-judge evaluations](https://langfuse.com/docs/scores/model-based-evals), [annotation queues](https://langfuse.com/docs/scores/annotation), [prompt experiments](https://langfuse.com/docs/datasets/prompt-experiments) and [the playground](https://langfuse.com/docs/playground), all of which are now freely available to self-host under the MIT license.

_If you are self-hosting Langfuse already today, **upgrade your deployment to the [latest version](https://langfuse.com/self-hosting/upgrade)**. You will find a more powerful version of Langfuse._
...
**Langfuse was [launched](https://langfuse.com/blog/product-analytics-for-LLM-apps) as an open source project.** This was based on a few [core beliefs](https://langfuse.com/why):
...
Today is the day to start self-hosting Langfuse. Head over to [our self hosting docs](https://langfuse.com/self-hosting) and use the new [terraform modules](https://langfuse.com/changelog/2025-05-22-terraform-modules) for deploying Langfuse at production-scale.

## **How can you follow and contribute to Langfuse?**

- [🤩 Star us on Github](https://github.com/langfuse/langfuse/)
- [🙋 Upvote or Contribute requests/feedback on Github Discussions](https://github.com/orgs/langfuse/discussions)
- [🚗 Langfuse Roadmap](https://langfuse.com/roadmap)

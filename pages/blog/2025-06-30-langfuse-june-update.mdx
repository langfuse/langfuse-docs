...
_Missed it? **Langfuse Python SDK v3** is now generally available and ready for production use ([upgrade guide](/docs/sdk/python/upgrade-paths))._
...
Anything before the "/" becomes a folder. Organise by use-case, model, or team—no more endless scroll.
...
→ [Quick-start guide](/docs/tracing-features/agent-graphs)

## ➕ More June Releases

- **Histogram charts** in custom dashboards
- **Export dataset items** via the UI
...
- **Audit-log exports** for compliance teams

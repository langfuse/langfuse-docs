...
<Frame className="rounded-lg overflow-hidden">
  ![observation
  types](/images/blog/2025-08-31-langfuse-august-update/observation-types.png)
</Frame>
...
<Frame className="rounded-lg overflow-hidden">
  ![example
  project](/images/blog/2025-08-31-langfuse-august-update/demo-project.png)
</Frame>
...
<Frame className="rounded-lg overflow-hidden">
  ![community
  growth](/images/blog/2025-08-31-langfuse-august-update/community-growth.png)
</Frame>

...
This guide describes a process to **build automated evaluators** for your application. The is a robust evaluator that you can scale for different tests and evolutions of your application:

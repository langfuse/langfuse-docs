...
<Frame className="rounded-lg overflow-hidden">
  ![LLM-as-a-Judge
  Prompt](/images/blog/2025-09-05-automated-evaluations/prompt.png)
</Frame>
...
<Frame className="rounded-lg overflow-hidden">
  ![Evaluator
  Setup](/images/blog/2025-09-05-automated-evaluations/setup-evaluator.png)
</Frame>
...
<Frame className="rounded-lg overflow-hidden">
  ![Evaluator
  Tuning](/images/blog/2025-09-05-automated-evaluations/evaluator-tuning.png)
</Frame>

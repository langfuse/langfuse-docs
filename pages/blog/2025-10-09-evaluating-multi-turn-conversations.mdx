...
ogImage: /images/blog/2025-10-09-evaluating-multi-turn-conversations/evaluating-multi-turn-conversations.png
tag: guide
date: 2025/10/09
author: "Abdallah"
---
...
I've written two cookbooks on evaluating multi-turn conversations that tackle this from different angles. This post will help you understand when to use each approach—and why you probably need both.
...
### The Problem: Your Chatbot Has Memory Problems

...
OpenAI lost 27.4 percentage points of market share (82.7% → 55.3%), Google grew from 0.5% → 13.1% share in just 12 months with **336x growth**, while the combined "Other" category grew faster in absolute terms than any single major provider.
...
## 💡 Key Insights
- **Despite 9x absolute growth, OpenAI is yielding (down -27.4 points) market share** while Google and Anthropic grow.
...
- **Google's Rise:** Google went from 0.5% → 13.1% share in just 12 months with **336x growth**.

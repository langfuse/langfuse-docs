...
We power global enterprises like [Khan Academy](/customers/khan-academy), [SumUp](/customers/sumup) and [Merck](/customers/merckgroup) as well as AI-native startups like [Magic Patterns](/customers/magic-patterns-ai-design-tools), [Circleback](https://circleback.ai/) and [Juicebox](https://juicebox.ai/) to build safe and scalable LLM applications and agents.
...
<Frame className="rounded-lg overflow-hidden">
  ![Status Quo in September
  2025](/images/blog/2025-10-13-state-of-llms-september-2025/Marketshare-sep.png)
</Frame>
...
<Frame className="rounded-lg overflow-hidden">
  ![Status Quo in September
  2025](/images/blog/2025-10-13-state-of-llms-september-2025/Marketshare-12mo.png)
</Frame>
...
<Frame className="rounded-lg overflow-hidden">
  ![Market Share by
  Model](/images/blog/2025-10-13-state-of-llms-september-2025/top-models-over-time.png)
</Frame>

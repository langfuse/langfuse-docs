...
- **[Annotations in Compare View](/changelog/2025-10-23-annotate-from-compare-view)**: Add human scores and comments directly alongside experiment results.

- **[Baseline Comparison](/changelog/2025-11-06-compare-view-baseline-support)**: Set a specific run as a baseline to identify metric regressions in newer runs.

- **Compare View Filters**: Filter experiment results based on specific criteria, such as evaluator scores.

- **[Experiment Runner SDK](/changelog/2025-09-17-experiment-runner-sdk)**: High-level SDK abstraction for automatic tracing, concurrent execution, and flexible evaluation.

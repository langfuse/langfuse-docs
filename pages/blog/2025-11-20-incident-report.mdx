...
On November 18th, Langfuse Cloud experienced a [multi-hour outage](https://status.langfuse.com/incident/768837) from 11:33am to 2:40pm UTC due to a global [Cloudflare incident](https://blog.cloudflare.com/18-november-2025-outage/). All API and UI traffic was unavailable during this period.

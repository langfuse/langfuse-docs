...
description: "Langfuse November Update: Next level Agent Tracing & Evals, Score Analytics, Langfuse MCP Server and more."
...
<BlogHeader
  title="Langfuse November Update"
  description="Next level Agent Tracing & Evals, Score Analytics, Langfuse MCP Server and more."
  authors={["marcklingen"]}
...
<Frame className="rounded-lg overflow-hidden">
  ![Experiment Runner
  SDK](/images/blog/2025-09-30-langfuse-september-update/01-experiment-runner-sdk.png)
</Frame>
...
<Frame className="rounded-lg overflow-hidden">
  ![Natural Language
  Filters](/images/blog/2025-09-30-langfuse-september-update/02-natural-language-filtering-for-traces.png)
</Frame>
...
<Frame className="rounded-lg overflow-hidden">
  ![Structured
  Output](/images/blog/2025-09-30-langfuse-september-update/03-structured-output-support-for-prompt-experiments.png)
</Frame>
...
<Frame className="rounded-lg overflow-hidden">
  ![TypeScript SDK v4
  GA](/images/blog/2025-09-30-langfuse-september-update/04-typescript-sdk-v4-ga.png)
</Frame>
...
<Frame className="rounded-lg overflow-hidden">
  ![Khan Academy case
  study](/images/blog/2025-09-30-langfuse-september-update/05-user-highlights.png)
</Frame>

...
If a user searched for a specific `sessionId`, we would have to scan their entire history to check whether it is present and if a trace contained thousands of observations, we would read and process all of them.

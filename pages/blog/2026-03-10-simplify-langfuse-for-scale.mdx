...
When we moved to ClickHouse 1.5 years ago, ReplacingMergeTree was the main option for handling updates, and it required writing full-row replacements rather than updating individual fields.

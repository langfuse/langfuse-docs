...
We are open, the project is super easy to [self-host](/self-hosting), and you can try Langfuse Cloud without a credit card. Join us on [Discord](/discord), give Langfuse a spin ([sign-up](https://cloud.langfuse.com)), or try the [live demo](/docs/demo).

Thank you all!<br/>Clemens, Max and Marc

_PS: If you're intrigued by solving some of the hard problems we've laid out above, check out our [open roles](/careers), we'll need smart and driven people on the journey alongside us!_

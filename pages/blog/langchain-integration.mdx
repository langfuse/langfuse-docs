...
date: 2023/07/26
description: Users of Langchain can get observability and analytics for their chain/agent with a single code change.
tag: release
...
We are happy to hear from you! If you have questions or feature requests, open an issue on [Github](https://github.com/langfuse/langfuse), join the Langfuse [Discord](https://discord.gg/2Y5YzK8Q) or email us: hi@langfuse.com

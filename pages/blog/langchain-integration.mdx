...
We are happy to hear from you! If you have questions or feature requests, open an issue on [Github](https://github.com/langfuse/langfuse), join the Langfuse [Discord](https://discord.gg/2Y5YzK8Q), or contact us via Twitter or email: hi@langfuse.com

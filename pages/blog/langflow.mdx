...
date: 2023/09/20
description: "Langflow and Lanfuse collaborate to enable people to build and iterate on LLM features faster."
tag: collaboration
ogImage: /images/blog/langflow-langfuse/og.jpg
author: Max
---
...
<BlogHeader
  title="Langflow x Langfuse"
  description="Enable people to build and iterate on LLM features faster."
  date="Sept 20, 2023"
  authors={["maxdeichmann"]}
/>

Many people wonder whether LLMs could be helpful for their specific use case: for example, a professional may wants to create a chatbot on corporate knowledge in a specific language or on a very niche company domain.
...
Here is a detailed [guide](https://github.com/logspace-ai/langflow/blob/2459833b871abe77fff9a0ea556ce71d1cf72ffd/docs/docs/guides/langfuse_integration.mdx#L1) on how to get started in your environment with Langflow. Here is a [video](https://langfuse.com/docs/video) showing the tracing and analytics features of Langfuse.

If you want to learn more, join our Discords ([Langfuse](https://langfuse.com/discord), [Langflow](https://discord.com/invite/EqksyE2EX9)). Also, there are plenty of open issues where we would like to collaborate with the community ([Langfuse](https://github.com/langfuse/langfuse), [Langflow](https://github.com/logspace-ai/langflow/issues)).

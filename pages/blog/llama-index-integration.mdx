...
LlamaIndex completes our roster of major integrations next to existing integrations with [OpenAI](/docs/integrations/openai/get-started) and LLM framework [LangChain](/docs/integrations/langchain/tracing) (see [full list of integrations](/docs/integrations/overview)). We are committed to support the most popular ways developers build on top of LLMs and specifically to open source application frameworks.
...
While easy to set up, the integration makes extensive use of [Langfuse Tracing](/docs/tracing) to capture sessions, users, tags, versions, and additional metadata. Also, the integration is [fully interoperable](/docs/integrations/llama-index/get-started#interoperability-with-langfuse-sdks) with the Langfuse Python SDK.
...
<Cards num={3}>
  ...
  <Card
    ...
    icon={<FileCode />}
  />
  <Card title="Video" href="/guides/videos/llama-index" icon={<Video />} />
</Cards>

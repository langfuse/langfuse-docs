...
// Legacy demo UI removed in favor of new AI SDK v5 chat.
...
<Callout type="info">This article references our legacy chat demo. See the new demo at <a href="/docs/ai-demo">/docs/ai-demo</a>.</Callout>

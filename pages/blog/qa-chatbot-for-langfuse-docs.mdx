...
<div className="max-w-2xl overflow-hidden mt-5 rounded-xl shadow-lg ring-1 ring-slate-700">
...
<div className="max-w-2xl overflow-hidden mt-10 rounded-xl shadow-lg ring-1 ring-slate-700">

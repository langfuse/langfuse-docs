...
<BlogHeader
  title="Using LLM Security packages in Langfuse"
  description="How to use Langfuse to trace, prevent, and evaluate risks common to LLM-based applications."
  date="2024/05/14"
  authors={["lydiayou"]}
/>

Protecting against security risks and attacks is becoming increasingly important for productionizing LLM apps. Not only do LLM applications need to be secure to protect users' private and sensitive information, they also need ensure a level of quality and safety of responses to maintain product standards. 
...
- **Controlling LLM interactions**
  ...
  - **Output Controls**: Evaluate model ouputs for risks before returning them to your users. Sanitize outputs and prevent data leakage.

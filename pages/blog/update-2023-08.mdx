...
Learn more → [Python](/docs/sdk/python#releases-and-versions), [JS/TS](/docs/sdk/typescript#releases-and-versions)
...
```
GET/v1/public/users
GET/v1/public/metrics/usage
GET/v1/public/metrics/usage?group_by=trace_name
```

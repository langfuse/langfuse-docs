...
description: The new major version allows to track usage and costs across all LLM models.
author: Marc
---
...
If you are [self-hosting](/docs/deployment/self-host) Langfuse, new model/price definitions are applied to all newly ingested traces. You need to run a migration script to apply them to your existing data in Langfuse.

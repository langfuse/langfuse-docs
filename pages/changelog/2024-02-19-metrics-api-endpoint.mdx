...
See [API reference](https://api.reference.langfuse.com/#tag/Metrics/operation/metrics_daily) for more details.

Do you miss any other GET API routes? Add them to our [idea board](/ideas)!

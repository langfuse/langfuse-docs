...
PostHog is a popular choice for OSS product analytics. While Langfuse offers [analytics](/docs/analytics) out of the box, many of our users have asked for a way to **integrate their LLM related metrics tat they capture with Langfuse into their PostHog dashboards**.

We've build an integration to make it easy to answer questions like:
...
If you are interested in activate this integration for your Langfuse project, please reach out to us: early-access@langfuse.com
...
| ------------------------------------------ | -------------- | ------------------------------------------------------------------------- |
| `user_id`                                  | `$distinct_id` |                                                                           |
| `trace.timestamp`, `generation.started_at` | `timestamp`    |                                                                           |

...
We are excited to kick off [**Langfuse Launch Week 1**](/blog/launch-week-1) a bit early on Day 0 with a new integration for the OpenAI JS SDK. The [Python version](/docs/integrations/openai/python/get-started) has been extremely popular with the community, and we are thrilled to bring the same level of observability to the JS/TS SDK.
...
<Cards num={3}>
  <Card
    title="Docs"
    href="/docs/integrations/openai/js/get-started"
    icon={<FileCode />}
  />
  <Card

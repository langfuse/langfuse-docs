...
<Video
  src="https://static.langfuse.com/docs-videos/datasets-tables.mp4"
...
<Video
  src="https://static.langfuse.com/docs-videos/json-editor.mp4"
  aspectRatio={16 / 6.93}
  title="JSON editor"
  gifStyle
  className="max-w-2xl"
...
<Video
  src="https://static.langfuse.com/docs-videos/dataset-item-from-trace.mp4"

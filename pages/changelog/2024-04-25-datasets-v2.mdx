...
On Day 4 of [Launch Week 1](/blog/launch-week-1), we're happy to share Datasets v2 as we have made significant improvements to the dataset experience in Langfuse.

> Quick recap on [Datasets](/docs/datasets) in Langfuse:
>
...
New endpoints to manage and use datasets programmatically ([api reference](https://api.reference.langfuse.com)):

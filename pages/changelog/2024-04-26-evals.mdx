...
So far, you have to manually read all the lengthy LLM outputs to judge feature quality or ask your users to do that for you. This is very time consuming and error prone. Especially when you try to be a good engineer iterating fast on your LLM feature.
With Model Based Evals, you sit back and ship or sleep, while Langfuse takes care of building up a large dataset of scored `traces`.

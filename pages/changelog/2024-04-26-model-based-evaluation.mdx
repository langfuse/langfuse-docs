...
On the final day of [Launch Week 1](/blog/launch-week-1), we're happy to release the biggest change to Langfuse yet: [Model-based evaluations](/docs/scores/model-based-evals/).
...
<Cards num={2}>
  <Card title="Documentation" href="/docs/scores/model-based-evals" icon={<Book />} />
</Cards>

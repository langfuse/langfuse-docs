...
![Start page](/images/changelog/2024-07-15-organizations/organization-home.png)
...
This transfer will centralize user management and permissions in an organization, while API Keys remain associated with the project.

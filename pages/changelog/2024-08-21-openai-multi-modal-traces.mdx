...
Langfuse now supports rendering multi-modal traces. In addition to text, you may now include images (passed via URL). We follow OpenAI's content format convention. For more details, please refer to [Multi-Modal Tracing](https://langfuse.com/docs/tracing#multi-modal-traces). 

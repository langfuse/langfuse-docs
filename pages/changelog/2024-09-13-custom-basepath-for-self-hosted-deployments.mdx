...
author: Marc
canonical: /self-hosting/configuration/custom-base-path
---
...
See the [self-hosting documentation](/self-hosting/configuration/custom-base-path) for more details. Thanks to everyone who contributed to the [discussion](https://github.com/orgs/langfuse/discussions/2400) on this!

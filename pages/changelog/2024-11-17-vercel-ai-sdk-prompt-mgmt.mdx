...
[Langfuse Prompt Management](/docs/prompt-management/get-started) now enables seamless prompt deployment and optimization. Key features include client-side caching with async refreshing and flexible management through UI, SDK, or API interfaces.
...
- Create a prompt in Langfuse ([guide](/docs/prompt-management/get-started)).
...
See the [prompt management](/docs/prompt-management/get-started) docs for more details.

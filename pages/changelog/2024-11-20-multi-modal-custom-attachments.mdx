...
Multi-modal attachments are available today. You need to configure your own object storage bucket via the Langfuse environment variables. Please see the [multi-modal documentation](/docs/tracing-features/multi-modality) for more details.

...
author: Hassieb
ogImage: /images/changelog/2024-11-20-multi-modal-custom-attachments.png
---
...
See the [multi-modal documentation](/docs/tracing-features/multi-modality) for more details.

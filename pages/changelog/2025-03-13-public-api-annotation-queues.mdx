...
[Annotation queues](/docs/scores/annotation) help to label and review LLM Traces in Langfuse and are often a baseline for any LLM evaluation. This change adds a new public API to manage annotation queues programmatically. Thereby, you can now scale and automate your annotation workflows.

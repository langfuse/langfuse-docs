...
Refer to the [UI Customization](/self-hosting/administration/ui-customization#visibility) documentation for more information on how to configure these environment variables.

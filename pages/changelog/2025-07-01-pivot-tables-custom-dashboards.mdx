...
For detailed instructions on creating and customizing pivot tables, visit our [Custom Dashboards documentation](/docs/analytics/custom-dashboards).

Discover how pivot tables can transform your LLM application analytics and help you make more informed decisions.

## Questions or Feedback?

We'd love to hear how you're using pivot tables in your dashboards!

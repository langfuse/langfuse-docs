...
When using Langfuse [Prompt Management](/docs/prompt-management/get-started), you can now receive real-time notifications when prompts are changed:
...
- [Prompt Webhooks Documentation](/docs/prompt-management/features/webhooks)
- [Prompt Management Overview](/docs/prompt-management/get-started)

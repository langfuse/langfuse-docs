...
For most [integrations with agent frameworks](/docs/integrations) the observation types should be automatically detected, but you can also manually set them via the Langfuse SDK.

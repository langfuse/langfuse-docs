...
This feature is currently available in beta for **Langfuse Cloud only**. AI features require an organization-level opt-in setting that can be enabled by organization owners and admins in _Organization Settings_ → _General_ → _AI Features_. Learn more about [data privacy and security](/security/ai-features).

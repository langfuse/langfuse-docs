...
description: Every LLM evaluation execution now creates a trace, allowing you to inspect the exact prompts, responses, and token usage for each evaluation.
author: Hassieb
...
Every LLM-as-a-Judge evaluation execution going forward is linked to a Langfuse trace of the underlying LLM call. This means you can:

...
2. **Offset pagination doesn't scale** - Page-based pagination makes database do more work then striclty necessary.
...
- **Stricter limits** - Default limit of 50 (max 1,000). With cursor based pagination, large result sets can be efficiently retrieved in smaller chunks, while less work is requied per chunk.

...
Context attributes (`user_id`, `session_id`, `metadata`) set at the trace level now propagate automatically to all observations of a Trace. This eliminates the need to repeatedly update trace metadata or patch outputs across observations.
...
Browsing traces, users and sessions table becomes snappier and filter significantly faster.  
...
## Technical changes
<Frame fullWidth>
  ![Langfuse](/images/changelog/2026-03-10-v4-preview/data-model.png)
</Frame>

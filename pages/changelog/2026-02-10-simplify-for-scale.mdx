...
See [Explore Observations in V4](/guides/explore-observations-in-v4) for a practical guide to using the unified table, setting up a default saved view, and populating it with the right data.

...
- **Python SDK**: v4 ([migration guide](/docs/observability/sdk/upgrade-path#python-v3--v4))
- **JS/TS SDK**: v5 ([migration guide](/docs/observability/sdk/upgrade-path#jsts-v4--v5))
...
<Callout type="info">
Set trace-level attributes (`user_id`, `session_id`, `metadata`) via `propagate_attributes()` as early as possible in your instrumentation so they propagate to all downstream spans automatically.
</Callout>

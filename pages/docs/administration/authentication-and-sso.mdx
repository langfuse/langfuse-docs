...
For increased security, you can also configure Enterprise SSO (e.g. Okta, Authentik, OneLogin, Azure AD, Keycloak etc.) via OIDC.
...
Langfuse supports **Enterprise SSO** (e.g. Okta, Authentik, OneLogin, Azure AD, Keycloak etc.) via OIDC. Please reach out to [support](/support) to enable this feature.

...
<Video
  src="https://static.langfuse.com/docs-videos/2026-03-06-add-llm-connection-v2.mp4"
  gifStyle
  className="mt-4"
/>
...
<Callout type="info">
  The gateway must support [tool calling](https://platform.openai.com/docs/guides/function-calling) in the OpenAI format for LLM-as-a-Judge evaluations to work.
</Callout>

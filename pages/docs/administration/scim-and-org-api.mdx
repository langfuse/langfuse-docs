...
If you self-host Langfuse, you can use the [Organization Management API](/self-hosting/organization-management-api) to administer organizations across an instance.

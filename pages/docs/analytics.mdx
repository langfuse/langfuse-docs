---
description: Langfuse analytics derives actionable insights from production data. Currently in alpha on Langfuse Cloud.
---
...
<Callout type="info" emoji="ℹ️">
  Langfuse analytics is currently in alpha on Langfuse Cloud.
</Callout>

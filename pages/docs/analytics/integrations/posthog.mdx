...
All events include the `langfuse_environment` property which corresponds to the [environment](/docs/tracing-features/environments) configured in Langfuse for organizing traces across different contexts (e.g., production, staging, development).

...
To export generations and training data for fine-tuning, see the comprehensive [Export Data](/docs/data-analytics/features/export) guide which includes:
...
All data collected in Langfuse is also available programmatically via the API and SDKs (Python, JS/TS). Refer to the [API reference](https://api.reference.langfuse.com/) and [Export Data](/docs/data-analytics/features/export) for more information.

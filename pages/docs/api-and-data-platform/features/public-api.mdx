...
For bug reports, feature requests, and community discussions related to the Public API, please visit our GitHub repository:

- [Langfuse GitHub Issues](https://github.com/langfuse/langfuse/issues)
- [API-specific discussions](https://github.com/langfuse/langfuse/discussions/categories/api)

When reporting API-related issues, please include:
- The endpoint you're trying to access
- Your request method and parameters

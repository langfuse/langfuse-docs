...
# fetch a trace
langfuse.client_instance.api.trace.get(trace_id)

# async client via asyncio
await langfuse.client_instance.async_api.trace(trace_id)

# explore more endpoints via Intellisense
langfuse.client_instance.api.*
await langfuse.client_instance.async_api.*
```

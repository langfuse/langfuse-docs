...
Langfuse is [open-source](/open-source) and data tracked with Langfuse is open. You can query data via: [SDKs](#sdks) and [API](#api). For export functionality, see [Export Data](/docs/data-analytics/features/export).
...
For comprehensive export capabilities including UI exports, scheduled blob storage exports, and programmatic access via SDKs and APIs, see the dedicated [Export Data](/docs/data-analytics/features/export) page.

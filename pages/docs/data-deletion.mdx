...
While most deletions in Langfuse happen instantly, event data like traces is not.
...
<Callout type="warning">
  Deleting a project is irreversible and all data will be removed.
  Be cautious when executing this action.
</Callout>

## Deleting an Organization (Cloud only)

To delete an organization, please message us at support@langfuse.com.

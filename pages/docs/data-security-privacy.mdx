...
- Our database and application run on AWS infrastructure, partly managed by Clickhouse.
  - US data region (https://us.cloud.langfuse.com): Virginia (AWS us-east-1)
...
## Compliance Measures [#compliance]
...
| HIPAA         | Compliant. Please reach out to sales@langfuse.com for details. See BAA [here](/baa)                                      |

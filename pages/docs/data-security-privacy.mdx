...
- We can enter into a DPA (Data Processing Agreement) including a subprocessor list upon request. Please see our DPA Template [here](https://static.langfuse.com/DPA_Langfuse_Template_11_07_2024.docx.pdf) for your prior review. Please email us at privacy@langfuse.com with a signed copy, we will then counter-sign your request. Please note that we require users to be on a Pro, Team or Enterprise Plan when we enter into DPAs with them.

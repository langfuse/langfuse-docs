...
The following users identified security vulnerabliities which lead to a significant improvement of Langfuse.

| Name                                                    | GitHub PR                                                 | Description                                                                                       |
| ------------------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [Ather Iqbal](https://linkedin.com/in/atheriqbalhacker) | [PR 4434](https://github.com/langfuse/langfuse/pull/4434) | Require stronger passwords when users sign up and prevent links in user names and sign up emails. |

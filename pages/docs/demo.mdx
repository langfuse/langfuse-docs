...
We are currently running an [alpha](/docs/analytics) with more prebuilt analytics capabilities based on the ingested production data. All users of Langfuse Cloud get early access.

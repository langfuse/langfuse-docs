...
<Callout type="warning">
  ...
  If you are interested in contributing to our Kubernetes deployment guide or Helm chart, please reach out to us on [Discord](/discord) or contact the maintainers at support@langfuse.com.
</Callout>
...
```bash
helm dependency update
helm update langfuse . -n langfuse-v3-preview
```

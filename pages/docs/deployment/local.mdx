...
Requirements: `docker` and `docker compose`, both included in [Docker Desktop](https://docs.docker.com/get-docker/)
...
`. Otherwise, it will use the cached version of the Langfuse container.

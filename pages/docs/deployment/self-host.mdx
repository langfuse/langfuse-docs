...
### Provisioning of default Langfuse organization and project

By default, Langfuse will create a default organization and project when the application is started. This is useful for getting started quickly.

You can disable the creation of the default organization and project by setting `LANGFUSE_DISABLE_DEFAULT_ORGANIZATION` and `LANGFUSE_DISABLE_DEFAULT_PROJECT` to `true`.

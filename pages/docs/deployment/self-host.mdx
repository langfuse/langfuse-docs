...
| `LANGFUSE_ALLOWED_ORGANIZATION_CREATORS`                                                             |                    | Comma-separated list of allowlisted users that can create new organizations. By default, all users can create organizations. E.g. `user1@langfuse.com,user2@langfuse.com`. This is an EE feature and requires a license key.                                                                                                                                                                          |

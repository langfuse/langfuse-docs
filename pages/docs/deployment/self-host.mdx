...
1. First, mirror the latest release of Langfuse to your private GitHub repository. You can do this by using [this link](https://github.com/new/import).
...
#### How to Setup Project on Google Cloud Run

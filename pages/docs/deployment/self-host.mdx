...
To host Langfuse on Google Cloud Run, you cannot use the image hosted on GitHub Container Registry. Instead, pull from Docker Hub: [langfuse/langfuse:2](https://hub.docker.com/r/langfuse/langfuse). Note: use tag `2` to pin the major version.

...
Not really a platform, but Kubernetes is a popular way to deploy Langfuse. You can find community-maintained templates and Helm Chart at [langfuse/langfuse-k8s](https://github.com/langfuse/langfuse-k8s).

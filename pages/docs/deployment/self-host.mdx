...
To host Langfuse on Google Cloud Run, you cannot use the image hosted on GitHub Container Registry. Instead, pull from Docker Hub: [langfuse/langfuse](https://hub.docker.com/r/langfuse/langfuse).

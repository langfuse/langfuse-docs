...
| Custom | `AUTH_CUSTOM_CLIENT_ID`<br/>`AUTH_CUSTOM_CLIENT_SECRET`<br/>`AUTH_CUSTOM_ISSUER`<br/>`AUTH_CUSTOM_NAME`<br/>`AUTH_CUSTOM_ALLOW_ACCOUNT_LINKING=true` (optional)     | `/api/auth/callback/cognito`  |

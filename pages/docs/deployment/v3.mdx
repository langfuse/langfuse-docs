...
<Callout type="warning">
  SDK versions below 2.0.0 need to be upgraded until Nov. 10th, 2024. Please upgrade your SDKs to the latest version.
</Callout>

Langfuse V3 is not completely backwards compatible with our SDKs on versions below 2.0.0. If you use a SDK with major version 1, please upgrade. With the upgrade, you will also get many features and improvements such as [prompt caching](https://langfuse.com/changelog/2024-02-05-sdk-level-prompt-caching) and many performance improvements.

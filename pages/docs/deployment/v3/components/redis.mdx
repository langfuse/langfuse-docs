...
Langfuse uses Redis/Valkey (Redis going forward) as a caching layer and as a queue.
...
This guide covers hwo to configure Redis within Langfuse and what to keep in mind when bringing your own Redis.

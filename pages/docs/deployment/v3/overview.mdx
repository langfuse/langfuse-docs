...
<Callout type="info">
  We recommend that you test V3 using the latest release candidate.
  You can find the newest tag in our [GitHub Releases](https://github.com/langfuse/langfuse/releases?q=v3.0.0-rc&expanded=true).
</Callout>

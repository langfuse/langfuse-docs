...
Example evaluations:
- checking whether a response is factually accurate
- evaluating the tone of voice ("Is this response using a professional tone?")
- checking whether the LLM successfully avoids generating harmful content
...
#### Asynchronous Evaluation (Experiments) [#asynchronous-evaluation]
...
Asynchronous evaluations are also known as [experiments](/docs/evaluation//core-concepts#experiments).


#### Live evaluations [#live-evaluation]
...
<Frame fullWidth>
  ![Experiments and live evaluation loop](/images/docs/evaluation/experiments-flow.png)
</Frame>
...
Todo: link to a page on what's available in the UI for experiments.
...
Langfuse currently supports LLM-as-a-Judge and human annotation checks for live evaluation. [Deterministic checks are on the roadmap](https://github.com/orgs/langfuse/discussions/6087).

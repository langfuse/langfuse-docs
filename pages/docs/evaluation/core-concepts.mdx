...
| **Evaluation Method** | A function that scores experiment results. In the context of a Langfuse experiment, this can be a [deterministic check](/docs/evaluation/evaluation-methods/scores-via-sdk), or [LLM-as-a-Judge](/docs/evaluation/evaluation-methods/llm-as-a-judge). |

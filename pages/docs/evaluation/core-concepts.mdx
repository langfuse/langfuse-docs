...
| **Score** | The result of an evaluator. This can be numeric, categorical, or boolean. See [Scores](/docs/evaluation/data-model#scores) for more details.|
| **Experiment Run** | A single execution of your task against all items in a dataset, producing outputs (and scores). |

You can find the data model for these objects [here](/docs/evaluation/data-model).
...
You can find more details on how these objects link together under the hood on the [data model page](/docs/evaluation/data-model). 

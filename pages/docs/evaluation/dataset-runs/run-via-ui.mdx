...
Create a prompt that you want to test on the dataset.

<Callout type="info">
As you are testing your prompt using all dataset items as input, your prompt needs to contain variables that match the keys in the dataset items.
</Callout>
...
You can set up an LLM-as-a-judge to score the responses based on the expected outputs.

<Callout type="info">
Make sure to set the target of the LLM-as-a-Judge to "Experiment runs" and optionally filter for the dataset you want to use.
</Callout>

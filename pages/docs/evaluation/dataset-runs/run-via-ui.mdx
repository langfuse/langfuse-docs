...
You can execute Dataset Runs in the Langfuse UI to test different prompt versions from [Prompt Management](/docs/prompt-management) or different models and compare the results side-by-side.
...
<Callout type="info">
This is a no-code feature within Langfuse. You can run more complex experiments via the Langfuse SDKs/API. Follow [this guide](/docs/evaluation/dataset-runs/run-via-sdk) to get started.
</Callout>

...
Annotation Queues are a manual [evaluation method](/docs/evaluation/evaluation-methods/overview) which is build for domain experts to add scores and comments to traces, observations or sessions.

<Video
  src="https://static.langfuse.com/2025-12-16-annotation-queues.mp4"
  aspectRatio={16 / 9}
  gifStyle
/>

...
**Migration Path**: Use our [migration guide](/blog/llm-as-a-judge-migration) to upgrade your evaluators to run on observations.
...
If you have existing evaluators running on traces and want to upgrade to running on observations for better performance and reliability, check out our comprehensive [Evaluator Migration Guide](/blog/llm-as-a-judge-migration).

...
<Callout type="info">
**URL Encoding**: When using dataset names with slashes as path parameters in the API, use URL encoding. For example, in Python: `urllib.parse.quote(name, safe="")`, in TypeScript: `encodeURIComponent(name)`.
</Callout>

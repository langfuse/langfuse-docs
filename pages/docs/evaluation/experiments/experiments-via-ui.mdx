...
2. **Select** the prompt you want to use
   - If you only have one piece of dynamic content, we recommend a static system prompt and a dynamic user message (e.g., full user message as a variable). This ensures you can map your dynamic content as the user message. 

...
If you want to test a single prompt, you can use [Prompt Experiments](/docs/evaluations/features/prompt-experiments) which does not require any code.
...
<Cards num={1}>
  <Card
    ...
    href="/guides/cookbook/datasets_synthetic_datasets"
    icon={<FileCode />}
  />
</Cards>

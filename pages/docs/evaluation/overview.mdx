...
## How to think about LLM evaluation?

LLM evaluation is a broad field and includes different methods coming together to form a comprehensive evaluation strategy.

## Evaluation Methods

As soon as you have traces of your LLM application in Langfuse, you want add scores to them to help you understand the quality of your application.

Langfuse offers a flexible scoring system to capture all your evaluations in one place and make them actionable.
...
{/* To be Editted into a headline section not a details section */}

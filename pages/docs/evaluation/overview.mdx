...
We typically think in two categories of evaluations: **online evaluation** and **offline evaluation**. Both are valuable, and complement each other.
...
Learn more about the [Scores Data Model](/docs/scores/data-model). 
...
Learn more about the [Dataset Runs Data Model](/docs/scores/data-model).

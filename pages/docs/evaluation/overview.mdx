...
This involves **evaluating the application in a controlled setting**, typically using test [datasets](/docs/evaluation/dataset-runs/datasets), not live user queries. 

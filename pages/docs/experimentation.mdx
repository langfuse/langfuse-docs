---
description: Track the effect of changes to your LLM app on metrics in AssistMe using versions and releases.
---

# Experimentation (releases & versions)

You can track the effect of changes to your LLM app on metrics in AssistMe. This allows you to:

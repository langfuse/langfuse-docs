---
description: Langfuse allows rapidl iteration on LLM applications by providing insights into the effect of experiments such as A/B tests on LLM costs, latencies and quality.
---

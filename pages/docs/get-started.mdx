...
The v3 SDK is currently in **beta**. Please check out the [SDK v3](https://langfuse.com/docs/sdk/python/sdk-v3) for more details.

</Callout>

The [OpenTelemetry-based SDK (v3)](/docs/sdk/python/otel_based_sdk_v3) is the latest generation of the Python SDK with improved developer experience and enhanced ease of use.
...
For more information, see the [Python SDK v3 documentation](/docs/sdk/python/otel_based_sdk_v3).
...
<Cards num={2}>
  ...
  <Card
    icon={<IconPython />}
    title="Python SDK (v3)"
    href="/docs/sdk/python/otel_based_sdk_v3"
    arrow
  />
  <Card
    icon={<IconPython />}

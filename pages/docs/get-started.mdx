...
<Tabs items={["Manual", "✨ Agentic: Cursor, GitHub Copilot, Windsurf, etc"]}>
...
The agent will use the Langfuse `searchLangfuseDocs` tool to find the correct documentation for the integration you are looking for. This is optional, alternatively the agent can use its native websearch capabilities.

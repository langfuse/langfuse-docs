...
<Tabs items={["Python Decorator + OpenAI","JS/TS","OpenAI SDK (Python)","Langchain","Langchain (JS)","LlamaIndex","Python (low-level)","API"]}>
...
Do you want to track any model in Python? See the [decorator documentation](/docs/sdk/python/decorators) for more details.

...
The [`@observe()` decorator](/docs/sdk/python/decorators) works with both SDK versions. If you do not use any of our native integrations, you can trace any LLM call via `@observe(as_type="generation")`.

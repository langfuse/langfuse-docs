...
<Frame>![Agent Playground](/agent-createagent.png)</Frame>

4. **Setting up Data Connectors:** Integrate your Google Drive and SharePoint to give the agent access to necessary data.
4.1 **Choose existing connectors or create new**

<Frame>![Data Connector](/data-connector-dailog.png)</Frame>

...
For more granular updates, see the release notes of our repositories: [AssistMe](https://github.com/AssistMe/AssistMe/releases) (application), [AssistMe-python](https://github.com/AssistMe/AssistMe-python/releases) (Python SDK), [AssistMe-js](https://github.com/AssistMe/AssistMe-js/releases) (JS/TS SDK).

<Frame className="max-w-md block mb-0" border>
  ![AssistMe releases](/images/docs/github-watch-changelog.gif)
</Frame>
<span>_Watch the repository on GitHub to get notified about new releases_</span>

## Get in touch

We actively develop AssistMe in [open source](/docs/open-source). Join our [Discord](/discord), provide feedback, report bugs, or request features via GitHub [issues](/issue).

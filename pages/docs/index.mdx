...
1. [Nested traces](/docs/tracing)
   ...
   - Track multiple traces in a single [session](/docs/session)
...
Langfuse is actively developed in [open source](/docs/open-source).
Join our [Discord](/discord), provide feedback, report bugs, or request features via GitHub [issues](/issue).

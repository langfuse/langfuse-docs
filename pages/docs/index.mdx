...
- Integration
  ...
  - [OpenAI SDK](/docs/integrations/openai) (drop-in replacement, change only the import)
  - [JS/TS Web SDK](/docs/integrations/sdk/typescript-web) to create scores from the client-side

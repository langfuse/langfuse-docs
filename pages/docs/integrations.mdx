...
| ------------------------- | --------------------------------------------------------------------- | -------------------- |
| Langchain integration     | Yes, with fully automated instrumentation                             | No, use SDKs         |
| SDKs for JS/TS and Python | Yes, incrementally adoptable and abstractions to create nested traces | Yes                  |
| API                       | Yes, ingest manually                                                  | Yes, ingest manually |

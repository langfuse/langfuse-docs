---
description: Swagger API reference for the Langfuse API to integrate with your own application
---
...
To allow for client-side usage of the API, a subset of the API routes are available with a public key. To integrate this API with your web application, you can also use the [Typescript frontend SDK](/docs/integrations/sdk/typescript#frontend).

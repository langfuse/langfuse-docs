...
<Callout type="info" emoji="⚠️">
  ...
  of Python SDK v2, please refer to our [legacy CrewAI integration
  guide](https://github.com/langfuse/langfuse-docs/blob/26a3aa9e935a0325b463e3fa585772fd20c23642/cookbook/integration_crewai.ipynb)._
</Callout>
...
<Callout type="info" emoji="🔗">
  _**Note:** Linking the Langfuse Prompt and the Generation is currently not
  possible. This is on our roadmap and we are tracking this
  [here](https://github.com/orgs/langfuse/discussions/7180)._
</Callout>

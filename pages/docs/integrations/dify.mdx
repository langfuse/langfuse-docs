...
The [Langfuse Prompt Management plugin](https://github.com/gao-ai-com/dify-plugin-langfuse) (community maintained) now lets you use Langfuse prompts in your Dify applications, enhancing your LLM application development workflow. Key features include:
...
This integration streamlines the process of managing and versioning your prompts, contributing to more efficient development and iteration cycles. You can find the plugin and installation instructions on [GitHub](https://github.com/gao-ai-com/dify-plugin-langfuse).

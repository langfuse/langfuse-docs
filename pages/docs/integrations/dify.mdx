...
The Langfuse Prompt Management plugin (community maintained) now lets you use Langfuse prompts in your Dify applications, enhancing your LLM application development workflow. Key features include:

...
| ---------------------------------------------------------------- | ----------------------------------- | ------------------------------------------------------------------------------------ |
| [chatId](https://docs.flowiseai.com/integrations/langchain/memory/threads) | [sessionId](/docs/tracing/sessions) | [Flowise 1.4.10](https://github.com/FlowiseAI/Flowise/releases/tag/flowise%401.4.10) |

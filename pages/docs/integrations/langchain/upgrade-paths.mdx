...
<Callout type="info" emoji="ℹ️">
  ...
  integration. If you want to add the integration to your project, you should start with the latest version and follow the [integration guide](/docs/integrations/langchain/overview).

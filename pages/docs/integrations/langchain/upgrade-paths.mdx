...
<Callout type="info" emoji="ℹ️">
  ...
  integration. If you want to add the integration to your project, you should start with the latest version and follow the [integration guide](/docs/integrations/langchain/get-started).
...
If you still want to group multiple invocations on one trace, you can use the Langfuse SDK combined with the Langchain integration ([more details](/docs/integrations/langchain/get-started)).

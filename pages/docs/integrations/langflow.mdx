...
**LiteLLM** ([GitHub](https://github.com/logspace-ai/langflow)): Langflow simplifies LangChain flow prototyping with drag-and-drop, real-time chat, parameter editing, chain/agent creation, thought tracking, and flow export.

## Integration

You'll need to export two environment variables: LANGFLOW_LANGFUSE_SECRET_KEY and LANGFLOW_LANGFUSE_PUBLIC_KEY.

...
<iframe
  ...
  src="https://www.youtube.com/embed/SA9gGbzwNGU?si=J_J85tcrlCsdUwo_"
  ...
  allowFullScreen
></iframe>
_[Video](https://www.youtube.com/watch?v=SA9gGbzwNGU) guide on how to integrate Langflow with Langfuse (published by Langflow)_
...
```
LANGFLOW_LANGFUSE_SECRET_KEY=secret_key LANGFLOW_LANGFUSE_PUBLIC_KEY=public_key LANGFUSE_HOST="http://localhost:3000" langflow
```

...
<Card
    ...
    href="/cookbook/LiteLLM"
    icon={<FileCode />}
  />
</Cards>
</Tab>
<Tab>
By setting the callback to Langfuse in the LiteLLM Admin UI you can instantly log your responses across all providers.

// Screenshot of LiteLLM UI
</Tab>
</Tabs>
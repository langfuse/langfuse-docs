...
gpt_completion = client.chat.completions.create(
  model="gpt-4o-mini"
  name="gpt-4o-mini", # optional name of the generation in langfuse
  messages=[
...
- [gpt-4o-minihttps://cloud.langfuse.com/project/cloramnkj0002jz088vzn1ja4/traces/a4e67d7d-d9cb-455b-9795-3ad41f39431e?observation=81006513-82b1-4ae4-bb98-7e1bc6c009a7)
...
def rap_battle(topic: str):
    ...
    # First model (gpt-4o-miniarts the rap
    gpt_completion = client.chat.completions.create(
        model="gpt-4o-mini
        name="rap-gpt-4o-mini add custom name to Langfuse observation
        messages=messages,
    )

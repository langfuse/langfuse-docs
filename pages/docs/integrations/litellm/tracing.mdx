...
You can add additional Langfuse attibutes to the requests in order to group requests into traces, add userIds, tags, sessionIds, and more. See [integration docs](https://docs.litellm.ai/docs/proxy/logging#langfuse) for details.

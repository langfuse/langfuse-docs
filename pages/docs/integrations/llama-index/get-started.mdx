...
# 🦙 LlamaIndex Integration (SDK v2)

<Callout type="info">
This integration is for the Python SDK v2. For the Python SDK v3, use a third-party OTEL-based instrumentation library such as [openinference-instrumentation-llama-index](https://pypi.org/project/openinference-instrumentation-llama-index/).
</Callout>

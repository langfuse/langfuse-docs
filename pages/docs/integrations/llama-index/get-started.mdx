...
Currently only Python is supported by this integration. If you are interested in an integration with LlamaIndex.TS, add your upvote/comments [here](https://github.com/orgs/langfuse/discussions/1291).

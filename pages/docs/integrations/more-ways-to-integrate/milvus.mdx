...
In this quickstart, we'll show you how to set up a LlamaIndex application using [Milvus Lite](https://milvus.io/docs/milvus_lite.md) as the vector store. We'll also show you how to use the [Langfuse LlamaIndex integration](https://langfuse.com/docs/integrations/llama-index/get-started) to trace your application.

...
The replacement works for OpenAI SDK version `>=0.27.8`. Async functions and streaming are supported for the OpenAI SDK version `>=1.0.0`.
...
Simple example using the OpenAI async client.

...
### Interoperability with Langfuse Decorator

Use the OpenAI integration in combination with the Langfuse `@observe()` decorator ([docs](/docs/sdk/python/decorators)) if you want to:

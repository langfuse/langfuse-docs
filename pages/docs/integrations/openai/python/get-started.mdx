...
<Callout>
  This integration does not cover the [OpenAI Assistants
  API](https://platform.openai.com/docs/assistants/overview). You can instrument
  the assistants api via the `observe` decorator as shown in this

...
Langfuse ([GitHub](https://github.com/langfuse/langfuse)) is an open-source LLM engineering platform for model [tracing](/docs/tracing), [prompt management](/docs/prompts/get-started), and application [evaluation](/docs/scores/overview). 

Integrating Langfuse with OpenWebUI allows you to develop, monitor, and improve your LLM applications. Read more on improving your LLM applications [here](/faq/all/llm-analytics-101).
...
<Callout type="info">
  Capture usage (token counts) for OpenAi models while streaming is enabled, you have to navigate to the model settings in OpenWebUI and check the "Usage" [box](https://github.com/open-webui/open-webui/discussions/5770#discussioncomment-10778586) below *Capabilities*.
</Callout>

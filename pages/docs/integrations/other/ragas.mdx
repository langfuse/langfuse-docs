...
Langfuse ([GitHub](https://github.com/langfuse/langfuse)) is a platform for LLM [tracing](/docs/tracing), [prompt management](/docs/prompts/get-started), and [evaluation](/docs/scores/overview). It allows you to score your traces and spans, providing insights into the performance of your RAG pipelines. Langfuse supports various integrations, including [OpenAI](/docs/integrations/openai/python/get-started), [Langchain](/docs/integrations/langchain/tracing), and [more](/docs/integrations/overview).

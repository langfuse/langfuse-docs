...
# Promptfoo Integration with Langfuse

Thanks to the team at Promptfoo for developing this integration. These docs are adapted from their write-up, which you can read [here](https://www.promptfoo.dev/docs/integrations/langfuse/).
...
## Langfuse Prompt Management with Promptfoo
...
3. Set the `LANGFUSE_PUBLIC_KEY`, `LANGFUSE_SECRET_KEY`, and `LANGFUSE_HOST` environment variables as desired.
...
Learn more about analyzing and improving your LLM application [here](/faq/all/llm-analytics-101).

...
**[Ragflow](https://ragflow.io/)** ([GitHub](https://github.com/ragflow-ai/ragflow)) is a no-code / low-code framework to design and run Retrieval-Augmented-Generation (RAG) pipelines.
...
<Frame border fullWidth>
  ![Example Ragflow trace in Langfuse](/images/docs/ragflow/ragflow-example-trace.png)
</Frame>

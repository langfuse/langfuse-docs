---
title: "Customizable Dashboards for LLM Applications"
sidebarTitle: Custom Dashboards
description: "Create customizable dashboards to visualize, monitor, and share insights from your LLM application data. Build customized dashboards with flexible metrics, rich filtering, and dynamic layouts."
---
...
Custom dashboards provide a flexible, self-service analytics solution built on a powerful query engine that supports multi-level aggregations across your [tracing data](/docs/observability/data-model).

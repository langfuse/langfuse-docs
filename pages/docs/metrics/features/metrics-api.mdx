...
We recognize that "top N" queries (e.g., top 10 users by cost) are a valid use case not currently supported. We're exploring ways to enable this efficiently in the future.

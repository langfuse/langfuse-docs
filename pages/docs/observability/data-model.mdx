...
- **Python SDK v4**: See [migration guide](/docs/observability/sdk/upgrade-path#python-v3--v4)
- **JS/TS SDK v5**: See [migration guide](/docs/observability/sdk/upgrade-path#jsts-v4--v5)

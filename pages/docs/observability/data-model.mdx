...
<Callout type="info">
The observation-centric data model is available with Python SDK v4+ and JS/TS SDK v5+. This data model is live on Langfuse Cloud. For OSS deployments, this will be Langfuse V4. See the [changelog post](/changelog/2026-03-10-simplify-for-scale) for more details.
</Callout>

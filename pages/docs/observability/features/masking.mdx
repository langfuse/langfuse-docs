...
<Tabs items={["Python SDK (v3)", "Python SDK (v2)", "JS/TS SDK", "OpenAI (Python v2)", "Langchain (Python v2)", "Langchain (JS/TS)"]}>
...
See [JS/TS SDK docs](/docs/observability/sdk/typescript/advanced-usage#masking) for more details.

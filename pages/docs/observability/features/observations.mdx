---
title: Observations
description: Observations are the building blocks of observability in Langfuse.
...
Observations are either created automatically by one of our [integrations](/docs/integrations) or manually by you using the [Langfuse SDK](/docs/sdk/overview).

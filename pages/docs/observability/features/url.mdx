...
<Tabs items={["Python SDK (v3)", "Python SDK (v2)", "JS/TS SDK", "Langchain (Python v2)", "Langchain (JS/TS)"]}>
...
<Tabs items={["Langfuse UI", "Python SDK (v3)", "Python SDK (v2)", "JS/TS SDK"]}>
<Tab title="Langfuse UI">
...
```ts /public: true/
import { startSpan, updateTrace } from "@langfuse/tracing";

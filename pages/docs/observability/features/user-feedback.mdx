---
description: Collect user feedback on LLM outputs to improve model performance and user satisfaction.
...
See [Model-based Evals](/docs/scores/model-based-evals) for implementation patterns and examples.
...
- [Scores](/docs/scores) - Core evaluation concept
- [Model-based Evals](/docs/scores/model-based-evals) - LLM-as-a-Judge patterns
- [Web SDK](/docs/sdk/typescript/guide-web) - Browser integration
...
Langfuse integrates seamlessly with the Vercel AI SDK via OpenTelemetry. If you already use the Vercel AI SDK, you can start using Langfuse with minimal changes to your code.
...
<Cards num={2}>
  ...
  <Card
    ...
    href="/integrations/frameworks/vercel-ai-sdk#setup-with-nextjs"
    arrow
  />
</Cards>

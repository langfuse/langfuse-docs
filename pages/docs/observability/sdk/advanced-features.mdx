...
You can provide a `mask` function to the `LangfuseSpanProcessor`. This function will be applied to the input, output, and metadata of every observation.
...
### Thread pools and multiprocessing (Python)
...
The full list of the observation types is documented here: [Observation types](/docs/observability/features/observation-types).

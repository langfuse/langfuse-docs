...
<Callout type="warning">
  Multi-project setups are **experimental** and have important limitations
  regarding third-party OpenTelemetry integrations.
</Callout>
...
<Callout type="warning">
  Changing SSL settings has major security implications depending on your
  environment. Be sure you understand these implications before you proceed.
</Callout>

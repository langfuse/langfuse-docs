...
<Callout type="info">
  **Note:** For `user_id`, `session_id`, `metadata`, and `version`, consider
...
<Callout type="warning">
  **Important Timing:** Call `propagate_attributes()` as early as possible in
  your trace. Only the currently active span and spans created after entering
  this context will have these attributes. Pre-existing spans will NOT be
  updated.
</Callout>

...
If you are self-hosting Langfuse or using a data region other than the default (EU, `https://cloud.langfuse.com`), ensure you configure the `base_url` argument or the `LANGFUSE_BASE_URL` environment variable (recommended).
...
if langfuse.auth_check():
    ...
    print("Authentication failed. Please check your credentials and base URL.")
```
...
| `base_url`                  | `LANGFUSE_BASE_URL`                  | The base URL for your Langfuse instance.                                                                                               | `"https://cloud.langfuse.com"` |

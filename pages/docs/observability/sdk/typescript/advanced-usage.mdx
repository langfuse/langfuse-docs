...
<Callout>
  Sending custom scores directly from the browser is not yet supported in the
  TypeScript SDK v4. The docs below describe the still valid approach with the
  SDK v3.
</Callout>

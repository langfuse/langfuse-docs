...
<Callout type="info">
This documentation is for the TypeScript SDK v4. If you are looking for the documentation for the TypeScript SDK v3, please [click here](js-sdk-v3.docs-snapshot.langfuse.com).
</Callout>

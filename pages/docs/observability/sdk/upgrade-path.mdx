...
The Python SDK v4 introduces the observation-centric data model. See the [full migration guide](/docs/observability/sdk/python-v3-to-v4-upgrade).

## JS/TS SDK v4 → v5

The JS/TS SDK v5 introduces the observation-centric data model. See the [full migration guide](/docs/observability/sdk/js-v4-to-v5-upgrade).
...
`update_trace()` is deprecated in Python SDK v4. See the [v3 → v4 migration guide](/docs/observability/sdk/python-v3-to-v4-upgrade).
</Callout>

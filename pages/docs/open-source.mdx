...
- **Pro** (self-serve) - an online, pay-as-you-go license that unlocks all Enterprise Edition (`/ee`) code for small teams. Purchase instantly from the dashboard and cancel anytime.

...
You can use the following command to get the base64 encoded API keys (referred to as `AUTH_STRING`): `echo -n "pk-lf-1234567890:sk-lf-1234567890" | base64 -w 0` # Note: `-w 0` is GNU-specific; macOS uses `-b` or other methods.

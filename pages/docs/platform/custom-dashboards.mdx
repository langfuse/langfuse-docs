...
Export your dashboard data for further analysis or integration with external tools:

- **CSV Export**: Download the underlying data from any chart as CSV files for spreadsheet analysis
- **Complete Data Access**: Export includes all metrics, dimensions, and data points used in the visualization

Alternatively, you can also use the [Metrics API](/docs/analytics/metrics-api) to get the data in a structured format.

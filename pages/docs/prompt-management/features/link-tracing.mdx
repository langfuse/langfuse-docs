...
When navigating to the generation in Langfuse, you can see the prompt that was used to generate the response. This lets you also analyze [aggregated metrics](/docs/prompt-management/features/metrics) by prompt version to see which version of the prompt performed best.

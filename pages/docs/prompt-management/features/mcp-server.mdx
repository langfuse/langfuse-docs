...
The Langfuse Prompt [Model Context Protocol](https://github.com/modelcontextprotocol) (MCP) Server enables seamless integration between Langfuse's [Prompt Management](/docs/prompt-management/get-started) and LLM Agent systems. This server acts as a bridge, making collaboratively managed prompts easily accessible to AI agents and applications.

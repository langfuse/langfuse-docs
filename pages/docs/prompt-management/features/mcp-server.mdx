...
See the [MCP Server setup guide](/docs/api-and-data-platform/features/mcp-server#get-authentication-header) for complete instructions on authentication and client configuration.

...
Connect your prompts to traces, experiments, and evaluations:
- See which prompt version was used for each trace
- Compare performance across prompt versions
- Run experiments to A/B test different prompt variations
- Track cost and quality metrics by prompt version

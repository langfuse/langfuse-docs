...
We assessed Langfuse's impact on prompt management efficiency by measuring retrieval and compilation time. The results from 1000 sequential requests are below:

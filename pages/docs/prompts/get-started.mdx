...
## Prompt Folders for Organization [#folders]
...
<Callout type="info">
  **Sync prompts to GitHub:** Check out our [GitHub Webhook Sync guide](/docs/prompts/github-webhook-sync) to learn how to automatically commit prompt changes to your GitHub repository.
</Callout>
...
- [n8n Node for Langfuse](/docs/prompts/n8n-node) - Available preinstalled on n8n Cloud, no installation needed

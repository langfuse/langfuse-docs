...
The n8n node for Langfuse is now available on n8n cloud (preinstalled) and can also be installed on self-hosted n8n instances via community nodes.

**n8n Cloud**: No installation needed - the node comes preinstalled.

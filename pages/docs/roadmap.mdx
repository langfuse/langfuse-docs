...
- Self-hosting: Langfuse v3.0 will add additional containers and database for improve scalability. Learn more in this [GitHub Discussion](https://github.com/orgs/langfuse/discussions/1902).

...
Langfuse is [open source](/docs/open-source) and we want to be fully transparent what the Langfuse team is working on and what's next. This roadmap is a living document and we'll update it as we make progress. Your feedback on this is highly appreciated.

...
- Datasets
  - Multi‑modal dataset support https://github.com/orgs/langfuse/discussions/6883
  - Run comparison view: filterable, sortable dataset runs with annotation support
  - Bulk add traces to datasets https://github.com/orgs/langfuse/discussions/7691
  - Dataset folders https://github.com/orgs/langfuse/discussions/3935

...
- Visualizations of agent executions, e.g. Graph ([#2669](https://github.com/orgs/langfuse/discussions/2669)); beta available for LangGraph
- Tracing Environments: Native support for separating different environments within a project ([#5005](https://github.com/orgs/langfuse/discussions/5005))
- Prompt Management

...
- Human annotation queue: A better UX for manually scoring LLM completions in the Langfuse UI along multiple dimensions
...
- Prompt management: comments on versions, tags via SDK and api
- Langfuse v3.0: async worker container, ingestion queues, OLAP database. Learn more in this [GitHub Discussion](https://github.com/orgs/langfuse/discussions/1902).
- Improve Tables, Dashboards and Single Trace UI
...
- Finish up SDK referencing in docstrings (Python done, TS to go)


## 🔮 Planned

- Datasets: make usable in CI (e.g GitHub Actions), run on Webhook
- Decorator-like experience for Langfuse TS SDK
- Improve Onboarding Experience
- internal: Add data hooks for growth loops
- users: Add Webhooks in product

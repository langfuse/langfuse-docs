...
| Source                                                 | examples                                                                                                                                                    |
| ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Human evaluation (manual)](/docs/scores/manually)     | Review traces/generations and add scores manually in the UI                                                                                                 |
...
| [Model-based evaluation frameworks](/docs/scores/eval) | OpenAI Evals, Whylabs Langkit, custom model outputs                                                                                                         |

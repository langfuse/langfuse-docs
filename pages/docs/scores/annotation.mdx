...
Annotation queues are a feature that allows you to manage and prioritize the annotation tasks assigned to your team members. This feature is particularly useful for large-scale projects that benefit of human-in-the-loop evaluation at some scale. Queues streamline this process by allowing for specifying which traces/observations you'd like to annotate on which dimensions. 

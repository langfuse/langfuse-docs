...
await langfuse.score({
  ...
  comment: "Factually correct", // optional
  id: "unique_id", // optional, can be used as an indempotency key to update the score subsequently
  configId: "12345-6565-3453654-43543", // optional, to ensure that the score follows a specific schema
...
langfuse.score(
    ...
    comment="Factually correct", # optional
    id="unique_id" # optional, can be used as an indempotency key to update the score subsequently
    config_id="93547-6565-3453654-43543" # optional, to ensure that the score follows a specific schema
...
await langfuse.score({
  ...
  comment: "Factually correct", // optional
  id: "unique_id", // optional, can be used as an indempotency key to update the score subsequently
  configId: "93547-6565-3453654-43543", // optional, to ensure that the score follows a specific schema

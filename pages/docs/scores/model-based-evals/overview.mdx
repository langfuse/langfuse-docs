...
- OpenAI Evals
- Langchain Evaluators ([Cookbook](/docs/scores/model-based-evals/langchain))
- RAGAS for RAG applications ([Cookbook](/docs/scores/model-based-evals/ragas))
- UpTrain for LLM evaluations ([Cookbook](/docs/scores/model-based-evals/uptrain))
- Whylabs Langkit

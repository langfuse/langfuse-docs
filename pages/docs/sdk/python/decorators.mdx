...
The decorator is fully interoperable with our main integrations: [OpenAI](/integrations/model-providers/openai-py), [Langchain](/integrations/frameworks/langchain), [LlamaIndex](/docs/integrations/llama-index). Thereby you can easily trace and evaluate functions that use (a combination of) these integrations.

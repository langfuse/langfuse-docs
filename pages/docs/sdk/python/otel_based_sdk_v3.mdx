...
- **Authentication Issues**:
  ...
  - Use `langfuse.auth_check()` after initialization to verify credentials. Do not use this in production as this methods waits for a response from the server.
- **No Traces Appearing**:

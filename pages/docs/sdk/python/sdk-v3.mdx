...
The SDK is currently in **beta**. We highly value your feedback! If you encounter any issues or have suggestions, please let us know on [GitHub](https://github.com/orgs/langfuse/discussions/6993).
...
10. **LlamaIndex Integration**:
    - There is no Langfuse-specific integration for LlamaIndex. Please use any third-party OTEL-based LlamaIndex instrumentations to get Langfuse traces for your LlamaIndex applications. See the [third-party integrations](#third-party-integrations) section for more information.
11. **No size limitations to events**:
    - **v2**: Events were limited to 1MB in size.
    - **v3**: There are no size limits enforced on the SDK-side for events.

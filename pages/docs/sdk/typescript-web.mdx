...
The Langfuse Web SDK can be used to report scores directly from the browser without needing to build an API route. It is commonly used to ingest scores into Langfuse which are based on implicit user interactions and feedback.

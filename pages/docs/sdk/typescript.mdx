...
| sessionId | string   | yes      | Used to group multiple traces into a [session](/docs/tracing/sessions) in Langfuse. Use your own session/thread identifier.                                                                               |
| userId    | string   | yes      | The id of the user that triggered the execution. Used to provide [user-level analytics](/docs/tracing/users).                                                                                             |

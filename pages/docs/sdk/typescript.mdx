...
| input               | object | yes      | The input to the generation - the prompt. Can be any JSON object.                                                                                                                                                                                                                                                                                               |
| output              | object | yes      | The output to the generation - the completion. Can be any JSON object.                                                                                                                                                                                                                                                                                          |
...
export const handler() {
  ...
  const span = trace.span({ name: "chat-interaction" });
  span.generation({ name: "chat-completion", model: "gpt-3.5-turbo", input, output });

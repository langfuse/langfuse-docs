...
- Trace security tools to debug and observe whether they work as expected
- Track and analyze security metrics such as risk scores
- Is fully async, meaning it does not interrupt program execution

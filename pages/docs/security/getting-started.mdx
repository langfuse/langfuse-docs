...
In this example we use the open source library LLM Guard. All examples easily translate to other libraries.
...
To read more about other security risks, including prompt injection, banned topics, or malicious URLs, please visit the LLM Guard [documentation](https://llm-guard.com/) or check out or Security [cookbook](/docs/security/example-python).

...
Langfuse supports rendering Multi-Modal traces, including both text and image formats. We are following OpenAI's format convention. 
...
For more details and examples, refer to our [OpenAI cookbook](https://langfuse.com/docs/integrations/openai/python/examples).
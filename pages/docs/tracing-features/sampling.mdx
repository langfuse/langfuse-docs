...
<Tabs items={["Python", "JS/TS", "OpenAI (Python)", "OpenAI (JS/TS)", "Langchain (Python)", "Langchain (JS/TS)", "Vercel AI SDK (JS/TS)", "LlamaIndex (instrumentor)", "LlamaIndex (callback)"]}>
<Tab>
...
See [Langchain Integration (JS/TS)](/docs/integrations/langchain/js/get-started) for more details.
...
When using the deprecated [LlamaIndex Callback Integration](/docs/integrations/llama-index/deprecated-llama-index-callback)

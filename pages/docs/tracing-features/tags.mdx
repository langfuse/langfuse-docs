...
**With OpenAI integration via metadata:**
...
response = openai.chat.completions.create(
    ...
    metadata={"langfuse_tags": ["production", "chat-bot"]}
)
```

**With Langchain integration via metadata:**
...
response = chain.invoke(
    ...
    config={
        "callbacks": [handler],
        "metadata": {"langfuse_tags": ["production", "humor-bot"]}
    }
)
```

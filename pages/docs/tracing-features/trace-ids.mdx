...
2. Use the [`@observe()` decorator](/docs/sdk/python/decorators-v2) for automatic trace management:
...
2. Using the [`@observe()` decorator](/docs/sdk/python/decorators-v2) for automatic trace management:

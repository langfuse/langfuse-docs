...
Follow the integration docs to send traces to Langfuse. You can use the [Langchain integration](/docs/langchain), the [Langfuse SDKs](/docs/sdk), or the [API](/docs/api).

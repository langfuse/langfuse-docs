...
2. Single-tenant managed cloud; deployment and maintenance managed by Langfuse team.
3. [Self-hosted](/docs/deployment/self-host) on your own infrastructure. Contact us if you are interested in additional support.

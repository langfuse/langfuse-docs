...
<CustomerQuote
  quote="Langfuse has been indispensable for us in leveraging LLMs. Its detailed tracing provides unrivaled clarity, streamlining our debug times and offering insights into both LLM and non-LLM actions. It's the must-have tool for anyone in the LLM space."
  name="Philipp Hövelmann"
  role="Founder"
  company="Cortea AI"
  image="/images/walloflove/PhilippHoevelmann.jpeg"
/>

<CustomerQuote
  quote="Langfuse is the easiest way to add observability to your AI stack. We use Langfuse ourselves, and have a native integration for our customers to push their spans to Langfuse as well."
  name="Nadeesha Cabral"
  role="SVP of Engineering"
  image="/images/walloflove/nadeesha.png"
/>

<CustomerQuote
  quote="One of my fav products! Long Live Langfuse, we use it everywhere in MindsDB"
  name="Jorge Torres"
  role="CEO"
  company="MindsDB"
  image="/images/walloflove/jorgetorres.jpeg"
/>
...
[Langfuse has been included twice in the Thoughtworks Tech Radar](https://www.thoughtworks.com/en-us/radar/platforms/langfuse)

...
| Resource                                                                    | Hobby              | Starter            | Pro/Team            |
| --------------------------------------------------------------------------- | ------------------ | ------------------ | ------------------- |
| **Tracing**. Batched `/ingestion` endpoint used by SDKs to ingest traces.   | 1,000&nbsp;req/min | 4,000&nbsp;req/min | 20,000&nbsp;req/min |
...
| **Metrics**. GET APIs used to fetch analytics data, e.g. daily metrics api. | 10&nbsp;req/day    | 20&nbsp;req/day    | 200&nbsp;req/day    |
| **API**. All other APIs.                                                    | 10&nbsp;req/min    | 100&nbsp;req/min   | 1,000&nbsp;req/min  |

...
_Numbers refresh automatically via [shields.io](https://shields.io)_
  ...
  <Tabs.Tab>
    <Frame fullWidth border>
      ![GitHub Star History of Langfuse and Phoenix](/images/blog/faq/phoenix-arize/github-star-history-langfuse-phoenix-arize.png)
    </Frame>
...
- **Prompt Management**: Provides robust [prompt management](/docs/prompt-management/get-started) solutions through client SDKs, ensuring minimal impact on application latency and uptime during prompt retrieval.
- **Integration Options**: Supports asynchronous logging and tracing SDKs with integrations for frameworks like [LangChain](/integrations/frameworks/langchain), [LlamaIndex](/integrations/frameworks/llamaindex), [OpenAI SDK](/integrations/model-providers/openai-py), and [others](/integrations).
...
| **Prompt Management** | ❌ No             | ✅ [Yes](/docs/prompt-management/get-started)            |

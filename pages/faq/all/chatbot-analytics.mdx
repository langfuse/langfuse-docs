---
title: Enhancing Chatbot Monitoring with Advanced Observability
tags: [product]
---
...
Large language models (LLMs) can generate responses that are unpredictable or misaligned with the intended purpose. Without proper evaluation, chatbots may exhibit:

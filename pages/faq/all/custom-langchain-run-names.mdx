...
Examples (from [Langchain docs](https://docs.smith.langchain.com/old/cookbook/tracing-examples/runnable-naming))
...
You can also pass a custom `name` argument to Langchain classes. This will override the default name of the class.

...
Langfuse Cloud [pricing](/pricing) is based on the number of ingested events per billing period.

`Billable Events = Traces + Observations + Scores` ([data model](/docs/tracing-data-model))

...
2. Update your integration/instrumentation to exclude these observations.
   ...
   - If you use the Python SDK (v3, opentelemetry-based), all opentelemetry spans are exported to Span by default. If some observations are not relevant, you can [filter out observations by instrumentation scope](/docs/sdk/python/sdk-v3#filtering-by-instrumentation-scope).

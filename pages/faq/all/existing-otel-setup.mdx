...
- If you filter out a parent span either by a rule in the span processor or if it originiated from a different TraceProvider, its children become "orphaned" and appear disconnected in the UI

...
**You can add observability or tracing to Ollama by using Langfuse with one of its many [integrations](/docs/integrations).** The easiest way to get started adding observability or tracing to Ollama is most likely to use the [Llama Index](/integrations/frameworks/llamaindex) or [Langchain integrations](/integrations/frameworks/langchain) with Langfuse.

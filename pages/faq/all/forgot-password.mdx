...
You will need to send a confirmation email to password-reset@langfuse.com requesting a password reset.

**The process:**

1. Confirm via email to password-reset@langfuse.com that you want to reset your password.

...
We run Langfuse in two data regions. In the [European Union](cloud.langfuse.com) and the [USA](https://us.cloud.langfuse.com). 
...
Find out more about [Langfuse Cloud Data Regions](/faq/cloud-data-regions).

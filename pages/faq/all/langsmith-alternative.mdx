...
LangSmith can be self-hosted but it requires [a paid Enterprise License](https://www.langchain.com/pricing-langsmith) to do so. It is a closed source project.

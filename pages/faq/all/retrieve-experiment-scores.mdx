...
<Callout type="info">
  **Terminology Note**: "Experiment" and "dataset run" are used interchangeably
  throughout Langfuse. We are moving toward deprecating the term "dataset run"
  in favor of "experiment", but both terms currently refer to the same concept.
</Callout>
...
<Callout type="warning">
  **Current Workaround**: The method below is a workaround for retrieving
  experiment-item-level scores. We recommend: 1. Using the [Experiment Runner
  SDK](/changelog/2025-09-17-experiment-runner-sdk) which provides direct access
  to all scores in context 2. We may add a dedicated API route for experiment
  scores/metrics in the near future
</Callout>

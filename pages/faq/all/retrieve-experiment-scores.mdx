...
See the [Scores Data Model](/docs/evaluation/experiments/data-model#scores) for details on score properties.
...
- [Scores Data Model](/docs/evaluation/experiments/data-model#scores)

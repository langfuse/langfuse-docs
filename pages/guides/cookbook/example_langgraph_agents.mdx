...
for s in graph.stream(
    ...
    print(s)
```
{'chatbot': {'messages': [AIMessage(content='Langfuse is a platform designed to help developers and businesses monitor, debug, and improve their AI applications, particularly those that use large language models (LLMs). It provides tools for tracking and analyzing the performance of AI models, allowing users to gain insights into how their models are functioning in real-world scenarios. Langfuse offers features such as logging, tracing, and visualization of AI interactions, which can be crucial for optimizing model performance and ensuring reliability. By using Langfuse, developers can better understand user interactions, identify issues, and make data-driven decisions to enhance their AI systems.', additional_kwargs={'refusal': None}, response_metadata={'token_usage': {'completion_tokens': 118, 'prompt_tokens': 13, 'total_tokens': 131, 'completion_tokens_details': {'accepted_prediction_tokens': 0, 'audio_tokens': 0, 'reasoning_tokens': 0, 'rejected_prediction_tokens': 0}, 'prompt_tokens_details': {'audio_tokens': 0, 'cached_tokens': 0}}, 'model_name': 'gpt-4o-2024-08-06', 'system_fingerprint': 'fp_a288987b44', 'id': 'chatcmpl-BrNh0c4CskLilvdMca48ZMEFN0qqx', 'service_tier': 'default', 'finish_reason': 'stop', 'logprobs': None}, id='run--2b39937b-07d1-4367-824b-99544347fed3-0', usage_metadata={'input_tokens': 13, 'output_tokens': 118, 'total_tokens': 131, 'input_token_details': {'audio': 0, 'cache_read': 0}, 'output_token_details': {'audio': 0, 'reasoning': 0}})]}}

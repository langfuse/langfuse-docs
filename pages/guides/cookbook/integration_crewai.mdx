...
```python
%pip install langfuse crewai openlit
```
...
Now, we initialize the [OpenLit OpenTelemetry instrumentation SDK](https://docs.openlit.io/latest/integrations/crewai) to automatically capture CrewAI operations and export OpenTelemetry (OTel) spans to Langfuse.
...
[Example Trace in Langfuse](https://cloud.langfuse.com/project/cloramnkj0002jz088vzn1ja4/traces/a082747f3146d0083179421fdb8ad2b5?timestamp=2025-06-06T13%3A23%3A42.208Z&display=details)
</Steps>
...
def your_application(country):
    with langfuse.start_as_current_span(name="crewai-trace") as span:
        ...
        geography_expert = Agent(
            ...
            backstory='An expert geography with a keen eye for geography.',
        )

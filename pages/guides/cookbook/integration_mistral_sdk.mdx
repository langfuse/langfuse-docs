...
<Callout type="info" emoji="ℹ️">
  ...
  [LiteLLM](https://langfuse.com/integrations/gateways/litellm), and [other
  frameworks](https://langfuse.com/integrations). If you use one of them, any
  use of Mistral models is instrumented right away.
</Callout>

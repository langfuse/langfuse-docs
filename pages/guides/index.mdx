...
<TutorialCards>
  <TutorialCard
    ...
    description="Upgrade your evaluators running on traces to run on observations for improved performance and reliability."
    href="/blog/llm-as-a-judge-migration"
    icon={<TrendingUp />}
  />
</TutorialCards>

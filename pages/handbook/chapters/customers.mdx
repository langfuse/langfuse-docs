...
- Create a really good LLM application that is core to company strategy
...
- Technical ability to integrate Langfuse themselves
- Ability to assess different solutions themselves to make a good decision
- Engineer(s) that can make buying decisions
- Is in startup, tech scale-up

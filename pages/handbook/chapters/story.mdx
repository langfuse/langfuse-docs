...
This realization led us to finally focus on building open-source tooling for LLM application developers (see [_Why do we exist?_](/handbook/chapters/mission)) as it seemed to be a much bigger problem and solving it would have an outsized impact by helping more teams to build better LLM applications.
...
### Feb 2024: Marlies and Hassieb joined

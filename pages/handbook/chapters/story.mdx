...
This realization led us to finally focus on building open-source tooling for LLM application developers (see [_why do we exist?_](/handbook/chapters/mission)) as it seemed to be the much bigger problem and solving it would have an outsized impact by helping more teams to build better LLM applications.

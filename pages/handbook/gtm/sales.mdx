...
Sales at Langfuse is one team with Product and Customer Success. Sales owns the decision to onboard; CS owns long-term value; Product/Eng owns roadmap. Everyone shares the customer outcome.
...
- Our product & our [public roadmap](http://langfuse.com/roadmap)
...
- We don’t have a self-hosted offering
- We would love for companies to use Langfuse. We want to build community & a funnel for Cloud Leads down the road. For this we commit to:
  ...
  - Provide support through public forums
...
- Make Security Reviews as self-servable as possible
  - Publicly available Security Center, SOC2, ISO27001, PenTest, DPA, Terms

...
- We care about our community and maintain best-effort/no-guarantee community suport via public/indexable channels (currently: [GitHub Discussions](/gh-support))

## Channels

We maintain multiple channels for support depending on the customer segment, overview here: [langfuse.com/support](/support)

## How to do support at Langfuse?

<Callout type="info">
  We use [Plain](https://plain.com) to manage support across all channels.
  Please read [how to use
  Plain](/handbook/working-at-langfuse/how-we-work/using-plain) for more details
  and best practices as using Plain correctly will make you much more effective
  at Support.
</Callout>
...
2. **😷 Clinical and clear**  
   ...
   - _Example: "Ah, I see what you mean, that's not ideal\! Sorry. I'll dig in to that now and let you know what I find by the end of tomorrow."_

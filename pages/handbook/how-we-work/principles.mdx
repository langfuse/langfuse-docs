...
We operate in two hubs: San Francisco and Berlin.
...
In Europe, we hire remotely, with Berlin as our collaboration hub where also many members of the team are based. After onboarding (a few weeks on-site), the expectation is one week per month in the Berlin office for everyone in Europe. Travel and accommodation are paid.

We do this for one reason: some work is simply better in person, like creative exploration, fast iteration, and resolving complex questions with fewer meetings and less process. The goal isn't "being in the office"; it's building momentum together.

During Berlin weeks, we batch the work that benefits most from being face to face (planning, workshops, pairing, reviews, and team time). Outside of those weeks, we're remote-first.

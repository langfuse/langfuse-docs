...
Docs are maintained by Product Engineering and GTM teams together; the [owner](/handbook/working-at-langfuse/how-we-work/ownership) of a product feature/area is responsible to keep docs in order.
...
1. No hard rules here, it's up to you to decide if changes were major or you think a 2nd pair of eyes makes sense. (We are happy to take a look in any case!)
2. Suggestion: if you added a headline (h2, h3) showing in the "on this page," it might still be worth a review
...
2. Assign [Felix Krauth](mailto:felix@langfuse.com) or [Jannik Maierhoefer](mailto:jannik@langfuse.com) as reviewer on the docs change PR - they commit to same-day reviews. If it's too late in the day, then the next morning.
...
**Why review?** If your code/feature is world-class but nobody understands why they need the feature or lacks the instructions to get started, your code creates less value.

### Workflow

_Info: We suggest having less sync between feature release & changelog posts rather than not having a review! If the changelog posts are not on point at first look, we leave adoption on the table._
...
1. People who are using Langfuse should get new value by starting to use the new feature

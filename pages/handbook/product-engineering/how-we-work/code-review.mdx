...
- Author is respobsible for the quality of the Pull Request. If something goes wrong, he has to fix it.
- Author has to go through the comments from the reviewer but may decide to not accept a suggestion.


## Responsibility of the reviewer
- PR reviews need to have a turnaround of < 24h as it is important for us to unblock each other. If you get a PR to review during the morngine, please provide feedback same day.
...
## Clickhouse reviews
- If you work on a more involved Clickhouse query, please get a Clickhoue DRI to review the PR. Ideally ask the DRI pre implementation on guidance.

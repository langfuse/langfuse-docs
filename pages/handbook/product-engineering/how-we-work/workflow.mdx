...
We are building a complex product with many feature requirements and performance challenges. We want to achieve this with a small team of great engineers. We belive in "think before build" to make sure we do not need to build things multiple times and acvoid some tech debt on the way. As everyone is responsible for their features, everyone has to make technical and product trade offs.

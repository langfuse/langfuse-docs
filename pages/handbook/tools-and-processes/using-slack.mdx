...
- When creating an `ext-*` channel (customers):
  ...
  - Do not invite additional internal team members except for Clemens who wants to be a member of all external channels. Everyone else can help out in this channel via the Plain integration, the App automatically joins all `ext-*` channels.

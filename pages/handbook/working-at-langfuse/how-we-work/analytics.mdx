...
- A maintainable path from raw product data → dbt-modeled **marts** in BigQuery → **Metabase** dashboards. Underlying systems change, the core business metrics need to be maintainable/testable.
- Keep logic in **dbt**, keep **Metabase** simple (no ad-hoc SQL on raw tables).
...
- Clone the analytics repo; use Cursor/your IDE for dbt development.

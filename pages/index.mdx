...
<TabsList>
  ...
  <TabsTrigger value="chain" disabled>LLM Chain</TabsTrigger>
  <TabsTrigger value="agent" disabled>LLM Agent</TabsTrigger>
  <TabsTrigger value="single-generation" disabled>Single LLM generation</TabsTrigger>
...
_This is a simplified example. Visit the docs for further details. For a production example, see [`route.ts`](https://github.com/langfuse/ai-chatbot/blob/main/app/api/chat/route.ts) of the [example chat app](https://chat.langfuse.com) (NextJS, streaming, edge)._

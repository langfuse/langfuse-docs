...
Filter executions by dimensions like user attributes or scores to find clusters of underperforming outputs
...
Model-based comparison of traces with automated suggestions (coming soon)

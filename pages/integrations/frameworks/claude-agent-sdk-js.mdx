...
Since the Claude Agent SDK is ESM-only, you must use `manuallyInstrument()` instead of relying on auto-instrumentation.
...
import * as ClaudeAgentSDK from "npm:@anthropic-ai/claude-agent-sdk";

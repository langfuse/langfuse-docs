...
> **What is Koog?** [Koog](https://docs.koog.ai/) Koog is a Kotlin-based framework designed to build and run AI agents entirely in idiomatic Kotlin. It lets you create agents that can interact with tools, handle complex workflows, and communicate with users. For background on Koog’s OpenTelemetry support, see the [OpenTelemetry support](https://docs.koog.ai/opentelemetry-support/).
...
For more details on Langfuse OTLP tracing, see the [Langfuse OpenTelemetry Docs](/docs/opentelemetry/get-started#opentelemetry-endpoint).

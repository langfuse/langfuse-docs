...
> **What is Koog?** [Koog](https://docs.koog.ai/) Koog is a Kotlin-based framework designed to build and run AI agents entirely in idiomatic Kotlin. It lets you create agents that can interact with tools, handle complex workflows, and communicate with users.
...
Koog also captures span attributes required by Langfuse to show [Agent Graphs](/docs/observability/features/agent-graphs). 
...
[Langfuse OpenTelemetry Docs](/docs/opentelemetry/get-started#opentelemetry-endpoint)
</Steps>

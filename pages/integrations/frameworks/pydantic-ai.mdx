...
- If you run PydanticAI agents across multiple services or workflow engines (e.g., Temporal, Inngest), you can use custom trace IDs to group all operations into a single trace. See [Trace IDs & Distributed Tracing](/docs/observability/features/trace-ids-and-distributed-tracing).

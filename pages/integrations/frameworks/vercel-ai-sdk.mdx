...
<Callout type="info">
  _**Note:** While this example uses `@ai-sdk/openai`, you can use any AI
  provider supported by the Vercel AI SDK (Anthropic, Google, Mistral, etc.).
  The integration works the same way._
</Callout>

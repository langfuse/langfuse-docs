...
![LiteLLM Proxy Trace](/images/cookbook/integration_litellm/litellm-proxy-trace.png)
</Frame>
...
You can find detailled information on how to use the LiteLLM Proxy in the [LiteLLM docs](https://docs.litellm.ai/docs/observability/langfuse_otel_integration).

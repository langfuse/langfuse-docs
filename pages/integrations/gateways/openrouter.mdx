...
## 1. OpenRouter Broadcast Tracing with Langfuse (No-Code)
...
<Frame className="my-10" fullWidth>
  ![OpenRouter settings showing the Langfuse Broadcast configuration](/images/integrations/openrouter-broadcast-langfuse-config.png)
</Frame>
...
For more information about setting up your Langfuse API keys or available options, see the [Langfuse getting started guide](/docs/observability/get-started.md).

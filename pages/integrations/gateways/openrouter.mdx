...
2. Enable [Usage Accounting](https://openrouter.ai/docs/use-cases/usage-accounting) in OpenRouter as this leads to cost being returned by OpenRouter for each call

...
async function analyzeSentiment(summary: string, trace: any) {
  ...
  return await client.chat.completions.create({
    ...
    messages: [
      ...
      {
        role: "user",
        content: `Analyze the sentiment of the following summary:\n${summary}`,
      },
    ],
  });
}
...
// Example usage
const textToAnalyze =
  "OpenAI's GPT-4 model has significantly advanced the field of AI, setting new standards for language generation.";

...
> **What is Baseten?** [Baseten](https://www.baseten.co/) is an inference platform that enables developers to deploy and scale machine learning models in production. It provides fast, reliable model inference with support for popular open-source models through an OpenAI-compatible API.
...
os.environ["LANGFUSE_PUBLIC_KEY"] = "pk-lf-e2080f6d-1ccd-46a0-b8b2-28db9001017b" 
os.environ["LANGFUSE_SECRET_KEY"] = "sk-lf-ac4abf0d-8573-4f1c-9384-85c5a06339e6" 
os.environ["LANGFUSE_BASE_URL"] = "https://cloud.langfuse.com" # 🇪🇺 EU region
# os.environ["LANGFUSE_BASE_URL"] = "https://us.cloud.langfuse.com" # 🇺🇸 US region

# Get your Baseten API key from https://app.baseten.co/settings/api_keys
os.environ["BASETEN_API_KEY"] = "peoczWHq.YMyLqdRqKtPCLcPWV5SiSM0JSeB0797z"

```

## Step 3: Langfuse OpenAI drop-in Replacement

In this step we use the native [OpenAI drop-in replacement](https://langfuse.com/docs/integrations/openai-sdk/python) by importing `from langfuse.openai import openai`.

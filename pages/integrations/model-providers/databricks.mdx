...
seoTitle: Databricks and Langfuse Overview
...
<Cards>
  <Card
    ...
    href="/guides/cookbook/integration_databricks.mdx"
    icon={<FileCode />}
  />
</Cards>

## Using Databricks Models for Playground and Evaluations in Langfuse
...
<Frame className="my-10" fullWidth border>
  ...
  Databricks](/images/docs/databricks/add-databricsk-serving-endpoint.png)
</Frame>

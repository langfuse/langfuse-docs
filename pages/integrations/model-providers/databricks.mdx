...
- **Experiment in the Playground:** The interactive Playground lets you test your language models in real-time. You can send custom prompts, review detailed responses, and add prompts to your [Prompt Library](/docs/prompt-management/get-started).
...
- Add prompts to your [Prompt Library](/docs/prompt-management/get-started).

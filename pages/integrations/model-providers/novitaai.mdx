...
logo: /images/integrations/novita_icon.svg
---
...
<Callout type="info" emoji="ℹ️">
  **Note:** The OpenAI drop-in replacement is fully compatible with the
  [Low-Level Langfuse Python
  SDKs](https://langfuse.com/docs/sdk/python/low-level-sdk) and [`@observe()`
  decorator](https://langfuse.com/docs/sdk/python/decorators) to trace all parts
  of your application.
</Callout>

...
with langfuse.start_as_current_observation(name="calculator-request") as span:
    span.update_trace(
...
with langfuse.start_as_current_observation(name="capital-poem-generator") as span:

...
![Enable assistant logs in Langdock](/images/docs/langdock_1_enable_assistant_logs.png)
...
![Enable tracing for assistant in Langdock](/images/docs/langdock_2_enable_tracing_for_assistant.png)

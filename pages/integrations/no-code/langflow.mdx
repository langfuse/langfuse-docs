...
export LANGFUSE_BASE_URL="https://cloud.langfuse.com"  # 🇪🇺 for EU data region
# export LANGFUSE_BASE_URL="https://cloud.langfuse.com" # 🇺🇸 for US data region
# export LANGFUSE_BASE_URL="http://localhost:3000" # 🏠 for self-hosters
...
```
LANGFUSE_SECRET_KEY=secret_key LANGFUSE_PUBLIC_KEY=public_key LANGFUSE_BASE_URL="http://localhost:3000" langflow
```

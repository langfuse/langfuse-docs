...
1. **Create an Okta Application**:
   ...
   - Fill in the application settings. Use your self-hosted doman or one of the Langfuse Cloud domains.
     - **App name**: `Langfuse`
...
2. **Setup Langfuse (Cloud)**:
   - Please reach out to the Langfuse support team <Link href="mailto:support@langfuse.com" className="underline">support@langfuse.com</Link> to configure Okta SSO.
...
4. **Add Default User Permissions** (Optional):
    ...
    - You can set it for all users of the application to provide a default. Set it too "NONE", "VIEWER", "MEMBER", or "ADMIN".
5. **Assign Users**:

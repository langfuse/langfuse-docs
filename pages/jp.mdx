...
- **フレームワークのサポート**：[LangChain](/integrations/frameworks/langchain)、[BytePlus](/integrations/model-providers/byteplus)、[LlamaIndex](/integrations/frameworks/llamaindex)、[AWS Bedrock など](/integrations/model-providers/amazon-bedrock) の一般的な LLM フレームワークと統合。
...
<div style={{ display: "flex", alignItems: "center" }}>
  <span>
    <strong>最新情報の入手：</strong>{" "}
    [GitHubで](https://github.com/langfuse/langfuse) Langfuse
    をスター登録すると、新しいリリースの通知を即座に受け取ることができます。
  </span>
...
- **サポートオプションの概要：** すべてのサポート方法については[サポートページ](/support)をご覧ください。

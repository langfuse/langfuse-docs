...
- **추적**: 외부 API 또는 도구 호출, 컨텍스트, 프롬프트 등을 포함하여 제품의 [전체 컨텍스트를](/docs/observability/overview) 캡처하세요.
- **실시간 지표**: 응답 시간, 오류율, 처리량과 같은 주요 성과 [지표를](/docs/metrics/overview) 모니터링하세요.
- **피드백**: [사용자 피드백을](/docs/evaluation/features/evaluation-methods/user-feedback) 수집하여 애플리케이션의 성능과 사용자 경험을 개선하세요.

### **분석**

- **평가**: [LLM-as-a-judge](/docs/evaluation/features/evaluation-methods/llm-as-a-judge) 평가 또는 [인간 주석](/docs/evaluation/features/evaluation-methods/annotation) 워크플로를 설정하여 다양한 모델, 프롬프트 및 구성의 성능을 비교하세요.
- **테스트**: 다양한 버전의 앱(A/B)으로 실험하여 [테스트](/docs/evaluation/features/datasets) 및 [신속한 관리를](/docs/prompt-management/get-started) 통해 가장 효과적인 솔루션을 결정하세요.
- **사용자 행동**: [사용자가](/docs/evaluation/features/evaluation-methods/user-feedback) AI 애플리케이션과 상호 작용하는 방식을 이해합니다.
...
데이터 수집, 성능 모니터링, 귀중한 인사이트 확보를 시작하세요. Langfuse는 애플리케이션 동작을 [트레이스](/docs/observability/overview) 형태로 보여줍니다. Langfuse [대시보드는](/docs/metrics/overview) 모델 비용, 평가 점수 및 사용자 피드백에 대한 개요를 제공합니다.

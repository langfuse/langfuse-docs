...
> We are often asked about the resources we can recommend. If you have any suggestions, please [raise a PR](https://github.com/langfuse/langfuse-docs/tree/main/pages/library.mdx).

...
2. **Community Collaboration**: The open source community moves quickly and accelerates [integrations](/integrations) with LangChain, LiteLLM, OpenTelemetry, and the next library you'll build tomorrow. Join our community on [GitHub Discussions](/ideas) to shape the [roadmap](/docs/roadmap).
...
5. **Extensible**: All data is accessible via the public [API](/docs/api-and-data-platform/features/public-api) which is fully tested. You can wrap/extend Langfuse or build your own workflows and AI platform around it.

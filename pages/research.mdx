...
**How to start:** [Sign up to Langfuse Cloud](https://cloud.langfuse.com) or [deploy via Docker/Kubernetes](/self-hosting)
...
- **US $499 monthly credit** towards any Cloud plan

...
AWS Bedrock is fully HIPAA, SOC2 and ISO 27001compliant, see [here](https://aws.amazon.com/bedrock/security-compliance/) for more details.

## Contact

For questions about AI features security: compliance@langfuse.com

...
Langfuse supports Role-based Access Control (RBAC). Please refer to the dedicated [RBAC documentation](/docs/administration/rbac) for a detailed explanation of roles, permissions, and how to manage user access within organizations and projects.

...
- **US data region:** `https://us.cloud.langfuse.com`
  - Location: Oregon (AWS `us-west-2`)
- **EU data region:** `https://cloud.langfuse.com`
...
- **Latency for Prompt Management:** If using Langfuse [Prompt Management](/docs/prompts), select the region closer to your application servers for lower latency when fetching prompts.

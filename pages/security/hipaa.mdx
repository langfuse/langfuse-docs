...
1. You need a fresh Langfuse Cloud account. _(Data migration from self-hosted or Cloud not yet supported, we will add docs)_
...
## Download Langfuse BAA as a PDF

- Download [Langfuse BAA](https://static.langfuse.com/legal/langfuse_baa_04-29-2025.pdf)

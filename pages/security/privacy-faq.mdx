...
[Data retention](/docs/administration/data-retention) can be defined via project‑level policies: ≥ 3 days up to unlimited. Data is purged nightly.

> **How can we delete data?**

Customers can delete single traces, batches, projects, organisations, or user accounts via the UI or the public API. See [data deletion documentation](/docs/administration/data-deletion) for more details.

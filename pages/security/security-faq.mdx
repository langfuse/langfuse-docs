...
TLS 1.2+ protects traffic; all stored data uses AES‑256 encryption, with optional BYOK/HSM for dedicated tenants. See [encryption documentation](/security/encryption) and [self-hosted encryption](/self-hosting/encryption) for more details.
...
> **How often are third‑party tests performed, and are results shareable?**

Independent penetration tests occur annually, plus continuous vulnerability scans.
...
> **Where is the service hosted and how is the perimeter protected?**
...
> **Which obligations stay with the customer?**

Endpoint security, webhook endpoint hardening and IAM hygiene on your side remain your responsibility. See [security overview](/docs/security/overview) for more details.
...
The CTO leads security efforts at Langfuse and reviews risk quarterly and drives continuous improvement. See [SOC 2 compliance](/security/soc2) for more details.

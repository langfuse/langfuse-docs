...
TLS 1.2+ protects traffic; all stored data uses AES‑256 encryption. See [encryption documentation](/security/encryption) and [self-hosted encryption](/self-hosting/encryption) for more details.

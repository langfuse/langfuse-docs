...
> Ensuring users can only access data subject to their authorisation and cannot read, copy, modify or remove Personal Data without permission.
...
> Ability to verify whether and by whom Personal Data has been entered, modified or removed.

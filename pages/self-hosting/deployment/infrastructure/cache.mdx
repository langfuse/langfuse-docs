...
Sentinel mode and cluster mode are mutually exclusive. You cannot enable both simultaneously.
...
For production deployments, we recommend using at least 3 Sentinel instances to ensure quorum and avoid split-brain scenarios.
...
```bash
REDIS_SENTINEL_ENABLED=true
REDIS_SENTINEL_NODES=sentinel1.example.com:26379,sentinel2.example.com:26379,sentinel3.example.com:26379
REDIS_SENTINEL_MASTER_NAME=mymaster
REDIS_AUTH=your-redis-password
REDIS_TLS_ENABLED=true
```
...
- Configure at least 3 Sentinel instances for production use

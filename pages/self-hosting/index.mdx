...
- Langfuse Cloud ([EU](https://cloud.langfuse.com) / [US](https://us.cloud.langfuse.com)): A fully managed version of Langfuse that is hosted and maintained by the Langfuse team.
...
- Cloud-specific deployment guides
  - [AWS Terraform Template (Github)](https://github.com/langfuse/langfuse-terraform-aws)
  - [Azure Terraform Template (Github)](https://github.com/langfuse/langfuse-terraform-azure)
  - [GCP Terraform Template (Github)](https://github.com/langfuse/langfuse-terraform-gcp)
  - You can provide feedback on these in the following threads: [AWS](https://github.com/orgs/langfuse/discussions/4645), [Google Cloud](https://github.com/orgs/langfuse/discussions/4646), [Azure](https://github.com/orgs/langfuse/discussions/4647).

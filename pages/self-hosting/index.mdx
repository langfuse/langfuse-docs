...
- [AWS (Terraform)](/self-hosting/aws): Run Langfuse on AWS using Terraform.
- [Azure (Terraform)](/self-hosting/azure): Run Langfuse on Azure using Terraform.
- [GCP (Terraform)](/self-hosting/gcp): Run Langfuse on GCP using Terraform.
- [Railway](/self-hosting/railway): Run Langfuse on Railway.

    ...
    <storage_configuration>
        <disks>
            <s3>
                ...
                <endpoint
        >https://s3.eu-central-1.amazonaws.com/example-bucket-name/data/</endpoint>
    ...
    <storage_configuration>
        <disks>
            <blob_storage_disk>
                ...
                <metadata_type>local</metadata_type>
                <storage_account_url
        >http://azurite:10000/devstoreaccount1</storage_account_url>
                <container_name>langfuse</container_name>
                <account_name>devstoreaccount1</account_name>
                <account_key
        >Eby8vdM02xNOcqFlqUwJPLlmEtlCDXJ1OUzFT50uSRZ6IFsuFq2UVErCz4I6tq/K1SZFPTOtr/KBHBeksoGMGw==</account_key>
            </blob_storage_disk>
        </disks>
        <policies>
            <blob_storage_disk>

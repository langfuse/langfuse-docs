...
Each additional write socker comes with a small memory overhead, so we recommend to increase the value gradually and observe the behaviour of your service.

---
title: "Self-Hosted SSO & Authentication"
...
# Self-Hosted SSO & Authentication
...
- The `AUTH_AUTHENTIK_ISSUER` must be in the format `https://<domain>/application/o/<slug>` without a trailing slash.

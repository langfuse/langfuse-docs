...
Watch the following video for a quick walkthrough of the migration:
...
Architecture diagram (from [architecture overview](/self-hosting#architecture-overview)):
...
- Langfuse JavaScript SDK v2 was [released](https://github.com/langfuse/langfuse-js/releases/tag/v2.0.0) on Dec 18, 2024.

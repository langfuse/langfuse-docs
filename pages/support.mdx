...
> Langfuse is open source and we prefer open, searchable support to provide a basic level of support to everyone. For non‑sensitive questions, please use **[GitHub Discussions](https://github.com/orgs/langfuse/discussions/categories/support)**. If you’re on a paid plan, additional support is available as described below.

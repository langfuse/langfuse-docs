---
title: "Langfuse Demo (10 minute walkthrough)"
description: "View a quick tour of all Langfuse features: Open Source LLM Observability, Evaluation, Prompt Management, and more."
---
...
- Explore the [interactive demo project](/demo) shown in the video
...
Want to get started? Create a [free account](https://cloud.langfuse.com) (Langfuse Cloud) or [self-host](/self-hosting) Langfuse.

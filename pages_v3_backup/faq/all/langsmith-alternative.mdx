...
- LangSmith is developed by the LangChain team and integrates very well with the LangChain framework. While Langfuse also maintains [Langchain integrations](/integrations/frameworks/langchain), you may be better of choosing LangSmith if you plan to exclusively develop using the Langchain and Langgraph frameworks. Based on a recent [report](https://blog.langchain.dev/langchain-state-of-ai-2024/) by the LangChain team, **out of all LangSmith users, 84.3% use `langchain` frameworks and 84.7% use Python.**
- Langfuse maintains a [large number of integrations](/integrations) into many frameworks and libraries.
...
While Langfuse [integrates](/integrations/frameworks/langchain) with the open source Langchain framework, the two organizations are separate and bear not relation. Langfuse and LangSmith operate in the same space and both try to help developers improve and iterate on their LLM applications.

...
2. and the Langfuse OpenAI SDK wrapper ([Python](/integrations/model-providers/openai-py), [JS/TS](/integrations/model-providers/openai-js)) instruments the LLM calls.
